...
Implement this class to control the selection change when selecting a Preset
in the [PresetSelector](Presets.PresetSelector.html).

Consult the DefaultPresetSelectorReceiver class for an example of
