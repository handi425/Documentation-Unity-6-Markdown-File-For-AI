...
A control that allows the user to pick a choice from a list of options. For
more information, refer to [UXML element DropdownField](../Manual/UIE-uxml-
element-DropdownField.html).

### Constructors

[DropdownField](UIElements.DropdownField-ctor.html)|  Construct an empty
DropdownField.  
---|---  
