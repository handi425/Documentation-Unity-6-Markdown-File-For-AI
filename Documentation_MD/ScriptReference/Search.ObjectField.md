...
[singleLineHeight](Search.ObjectField-singleLineHeight.html)| Default line
height used to render the object field control.  
---|---  
  
### Properties

[objectType](Search.ObjectField-objectType.html)| Type of the object to be
selected.  
---|---  
[searchContext](Search.ObjectField-searchContext.html)| Search query context
used to populate the object picker.  
[searchViewFlags](Search.ObjectField-searchViewFlags.html)| Search flags used
to open the search picker window.  
  
### Constructors

[ObjectField](Search.ObjectField-ctor.html)| Construct an advanced search
field UITK control.  
---|---  
  
### Public Methods

[SetValueWithoutNotify](Search.ObjectField.SetValueWithoutNotify.html)| Set
the object field selected objects.  
---|---  
  
### Static Methods

[DoObjectField](Search.ObjectField.DoObjectField.html)| Draw an IMGUI advanced
object field.  
---|---  
