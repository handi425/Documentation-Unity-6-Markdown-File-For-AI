...
#  [Resolver](Rendering.VirtualTexturing.Resolver.html).Process
...
public void Process([Rendering.CommandBuffer](Rendering.CommandBuffer.html)
cmd, [Rendering.RenderTargetIdentifier](Rendering.RenderTargetIdentifier.html)
rt, int x, int width, int y, int height, int mip, int slice);
