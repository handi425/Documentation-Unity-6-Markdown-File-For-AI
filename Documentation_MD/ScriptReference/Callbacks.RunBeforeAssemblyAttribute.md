...
[assemblyName](Callbacks.RunBeforeAssemblyAttribute-assemblyName.html)| The
name of the assembly that should be called after this callback.  
---|---  
  
### Constructors

[RunBeforeAssemblyAttribute](Callbacks.RunBeforeAssemblyAttribute-ctor.html)|
Add this attribute to a callback method to indicate that this callback must be
run before any callbacks that are part of the specified assembly.  
---|---  
