...
#
[RadeonRaysProbePostProcessor](LightTransport.PostProcessing.RadeonRaysProbePostProcessor.html).DeringSphericalHarmonicsL2
...
public bool
DeringSphericalHarmonicsL2([LightTransport.IDeviceContext](LightTransport.IDeviceContext.html)
...
probeCount | Number of [SphericalHarmonicsL2](Rendering.SphericalHarmonicsL2.html) probes to de-ring.  
...
end of the probe. This method can remove ringing on probes, but might reduce
overall contrast.
