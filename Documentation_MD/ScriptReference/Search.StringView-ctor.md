...
Constructs a [StringView](Search.StringView.html) over an entire string.
...
Constructs a [StringView](Search.StringView.html) from a string, starting at
index **startIndex**.
...
Constructs a [StringView](Search.StringView.html) from a string, starting at
index **startIndex** and ending at, but not including, index **endIndex**.
