...
#  [PlayableExtensions](Playables.PlayableExtensions.html).IsDelayed
...
**Obsolete** IsDelayed is obsolete; use a custom ScriptPlayable to implement
this feature.
...
Returns whether or not the [Playable](Playables.Playable.html) has a delay.
