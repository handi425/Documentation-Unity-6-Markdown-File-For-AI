...
#  [Sampler](Profiling.Sampler.html).GetNames
...
Use **GetNames** to get a number of available Samplers and fill the _names_
list parameter with their names.  
  
**Note:** At the moment all built-in counters are available only in the Editor
and Development Players. **GetNames** in non-Development Players returns
