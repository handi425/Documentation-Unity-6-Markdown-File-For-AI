...
Inherits
from:[EditorTools.EditorToolContext](EditorTools.EditorToolContext.html)
...
[GameObjectToolContext](EditorTools.GameObjectToolContext.html) is active,
manipulation tools affect the transform property of GameObjects in the
[SceneView](SceneView.html) [Selection](Selection.html).
