...
#
[EditorConnection](Networking.PlayerConnection.EditorConnection.html).TrySend
...
**bool** Returns true when the Editor sends data successfully, and false when
there is no space in the socket ring buffer or sending fails.
