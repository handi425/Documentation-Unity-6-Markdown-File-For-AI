...
#  [TrailRenderer](TrailRenderer.html).generateLightingData
...
Configures a trail to generate Normals and Tangents. With this data, Scene
lighting can affect the trail via Normal Maps and the Unity Standard Shader,
or your own custom-built Shaders.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            tr.material = new [Material](Material.html)([Shader.Find](Shader.Find.html)("Standard"));
