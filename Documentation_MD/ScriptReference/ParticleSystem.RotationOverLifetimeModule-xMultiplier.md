...
#
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html).xMultiplier
...
you only want to change the overall rotation multiplier.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationOverLifetime.xMultiplier = ([Mathf.PI](Mathf.PI.html) * 2.0f);
