...
#  [TextureFormat](TextureFormat.html).RGB9e5Float
...
channel. RGB9e5Float is implemented for Direct3D 11, Direct3D 12, OpenGL 3.0+,
Metal, and Vulkan. The format is used for Precomputed Enlighten Realtime
Global Illumination textures on supported platforms.  
