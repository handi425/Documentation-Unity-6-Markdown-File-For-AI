...
#  [Material](Material.html).GetMatrix
...
public [Matrix4x4](Matrix4x4.html) GetMatrix(string name);

## Declaration

public [Matrix4x4](Matrix4x4.html) GetMatrix(int nameID);
...
Additional resources: [SetMatrix](Material.SetMatrix.html),
