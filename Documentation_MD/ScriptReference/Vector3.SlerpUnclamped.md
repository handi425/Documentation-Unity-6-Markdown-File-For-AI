...
#  [Vector3](Vector3.html).SlerpUnclamped
...
public static [Vector3](Vector3.html) SlerpUnclamped([Vector3](Vector3.html)
a, [Vector3](Vector3.html) b, float t);
...
**Note:** This static method can slerp beyond the `a` and `b` vectors. This
means `t` can be less than zero or greater than one.  
