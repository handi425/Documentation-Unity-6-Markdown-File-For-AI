...
#
[PackedMemorySnapshot](Profiling.Memory.Experimental.PackedMemorySnapshot.html).Convert
...
Converts the specified old format MemoryProfiler.PackedMemorySnapshot object
to a new PackedMemorySnapshot format object and writes it to the location and
file name specified the the write path.
