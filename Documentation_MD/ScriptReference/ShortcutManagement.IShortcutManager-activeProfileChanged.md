...
#
[IShortcutManager](ShortcutManagement.IShortcutManager.html).activeProfileChanged
...
changes. It is not raised when the shortcut overrides of the active profile
are changed, e.g. via
