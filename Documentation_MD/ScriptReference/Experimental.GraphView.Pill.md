...
The Pill class includes methods for creating and managing a VisualElement that
resembles a capsule. The Pill class includes text, an icon, and two optional
child VisualElements: one to the left of the pill, and one to the right of the
pill.

### Properties

[highlighted](Experimental.GraphView.Pill-highlighted.html)| Returns whether
the pill is highlighted.  
---|---  
[icon](Experimental.GraphView.Pill-icon.html)| The icon of the pill.  
[left](Experimental.GraphView.Pill-left.html)| The VisualElement to the left
of the pill.  
[right](Experimental.GraphView.Pill-right.html)| The VisualElement to the
right of the pill.  
[text](Experimental.GraphView.Pill-text.html)| The text of the pill.  
  
### Constructors

[Pill](Experimental.GraphView.Pill-ctor.html)| Constructs a pill with its
optional left and right child VisualElements.  
---|---  
