...
[defaultValueAsString](UIElements.UxmlEnumAttributeDescription_1-defaultValueAsString.html)|
The default value for the attribute, as a string.  
---|---  
  
### Constructors

[UxmlEnumAttributeDescription_1](UIElements.UxmlEnumAttributeDescription_1-ctor.html)|
Constructor.  
---|---  
  
### Public Methods

[GetValueFromBag](UIElements.UxmlEnumAttributeDescription_1.GetValueFromBag.html)|
Retrieves the value of this attribute from the attribute bag. Returns the
value if found; otherwise, it returns defaultValue.  
---|---  
[TryGetValueFromBag](UIElements.UxmlEnumAttributeDescription_1.TryGetValueFromBag.html)|
