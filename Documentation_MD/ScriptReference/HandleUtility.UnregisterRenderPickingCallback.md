...
#  [HandleUtility](HandleUtility.html).UnregisterRenderPickingCallback
...
public static bool
UnregisterRenderPickingCallback([HandleUtility.RenderPickingCallback](HandleUtility.RenderPickingCallback.html)
...
**bool** True if the unregistration succeeds. False if the callback is not
registered.
