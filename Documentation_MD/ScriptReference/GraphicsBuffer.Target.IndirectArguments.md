...
#  [GraphicsBuffer.Target](GraphicsBuffer.Target.html).IndirectArguments
...
Indirect arguments buffers are used for
...
or [Graphics.RenderMeshIndirect](Graphics.RenderMeshIndirect.html).  
  
The buffer size must be a minimum of 12 bytes. The underlying DirectX 11
unordered access view format will be R32_UINT, and shader resource view format
will be R32 typeless.  
