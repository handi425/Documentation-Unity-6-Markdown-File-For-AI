...
public static [Color](Color.html) clear;
...
Completely transparent. RGBA is (0, 0, 0, 0).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        //Run your mouse over the [GameObject](GameObject.html) to change the [Renderer](Renderer.html)'s material color to clear
        void OnMouseOver()
        {
            m_Renderer.material.color = [Color.clear](Color-clear.html);
        }  
