...
#
[NativeSliceUnsafeUtility](Unity.Collections.LowLevel.Unsafe.NativeSliceUnsafeUtility.html).GetAtomicSafetyHandle
...
GetAtomicSafetyHandle(NativeSlice<T> slice);
