...
#  [PlayerSettings](PlayerSettings.html).GetScriptingBackend
...
GetScriptingBackend([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget);
...
public static [ScriptingImplementation](ScriptingImplementation.html)
GetScriptingBackend([BuildTargetGroup](BuildTargetGroup.html) targetGroup);
