...
#  [PBXProject](iOS.Xcode.PBXProject.html).UpdateBuildProperty
...
Adds and removes values from a build property in all build configurations for
the specified target(s).
    ...
    public class Sample_UpdateBuildProperty  
    {
        [PostProcessBuild]
