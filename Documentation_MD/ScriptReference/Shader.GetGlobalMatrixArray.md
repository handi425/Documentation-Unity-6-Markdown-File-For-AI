...
#  [Shader](Shader.html).GetGlobalMatrixArray
...
Gets a global matrix array for all shaders previously set using
[SetGlobalMatrixArray](Shader.SetGlobalMatrixArray.html).
