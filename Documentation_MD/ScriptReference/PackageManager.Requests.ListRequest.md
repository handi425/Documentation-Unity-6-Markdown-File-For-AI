...
ListRequest instance when you call the
[Client.List](PackageManager.Client.List.html) method to list the package
dependencies of your project. Use this object to determine when the request is
