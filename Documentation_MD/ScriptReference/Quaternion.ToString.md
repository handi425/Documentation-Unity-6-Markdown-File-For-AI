...
#  [Quaternion](Quaternion.html).ToString
...
Defaults to five digits displayed (format="F5"). For more information, see
...
numeric-format-strings#FFormatString).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            [Quaternion](Quaternion.html) quaternion = new [Quaternion](Quaternion.html)(1.0f, 2.0f, 3.0f, 4.0f);
            [Debug.Log](Debug.Log.html)(quaternion.ToString()); // output displayed as: "(1.00000, 2.00000, 3.00000, 4.00000)"
        }
    }
