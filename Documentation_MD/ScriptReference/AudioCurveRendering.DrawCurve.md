...
#  [AudioCurveRendering](AudioCurveRendering.html).DrawCurve
...
public static void DrawCurve([Rect](Rect.html) r,
...
color of the curve is set by the curveColor argument.
