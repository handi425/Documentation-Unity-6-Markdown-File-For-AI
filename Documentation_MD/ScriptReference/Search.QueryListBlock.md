...
Inherits from:[Search.QueryBlock](Search.QueryBlock.html)
...
A query list block represents a special query block that will list a set of
value for a given filter.

In example, if your [SearchProvider](Search.SearchProvider.html) has a filter
named `color` for which the value can be yellow, red or pink. Then you'll use
the [QueryListBlockAttribute](Search.QueryListBlockAttribute.html) to have
this filter be displayed as a block that when clicked will show a fixed set of
values to be picked from.

### Properties

[category](Search.QueryListBlock-category.html)| Block category.  
---|---  
[icon](Search.QueryListBlock-icon.html)| Icon displayed in the query builder
block widget.  
[id](Search.QueryListBlock-id.html)| Block id.  
  
### Public Methods

[Apply](Search.QueryListBlock.Apply.html)| Apply proposition to the block.  
---|---  
[GetPropositions](Search.QueryListBlock.GetPropositions.html)| Returns
propositions when the list block is clicked.  
...
[context](Search.QueryBlock-context.html)| Search context that composed this
query block.  
[name](Search.QueryBlock-name.html)| Name of the block.  
[op](Search.QueryBlock-op.html)| Filter operator (i.e. :, =, <, >, etc.) of
the block if any.  
[source](Search.QueryBlock-source.html)| Query builder source that compose
this block.  
[value](Search.QueryBlock-value.html)| Value of the block.  
...
element.  
[ToString](Search.QueryBlock.ToString.html)| Returns the text filter of the
block.  
