...
Inherits from:[UIElements.PopupField_1](UIElements.PopupField_1.html)
...
A [TagField](UIElements.TagField.html) editor. For more information, refer to
[UXML element TagField](../Manual/UIE-uxml-element-TagField.html).

### Static Properties

[inputUssClassName](UIElements.TagField-inputUssClassName.html)|  USS class
name of input elements in elements of this type.  
---|---  
[labelUssClassName](UIElements.TagField-labelUssClassName.html)|  USS class
name of labels in elements of this type.  
[ussClassName](UIElements.TagField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[formatListItemCallback](UIElements.TagField-formatListItemCallback.html)|
Unsupported.  
---|---  
[formatSelectedValueCallback](UIElements.TagField-
formatSelectedValueCallback.html)|  Unsupported.  
  
### Constructors

[TagField](UIElements.TagField-ctor.html)|  Initializes and returns an
instance of TagField.  
---|---  
...
[inputUssClassName](UIElements.PopupField_1-inputUssClassName.html)|  USS
class name of input elements in elements of this type.  
[labelUssClassName](UIElements.PopupField_1-labelUssClassName.html)|  USS
class name of labels in elements of this type.  
[ussClassName](UIElements.PopupField_1-ussClassName.html)|  USS class name of
elements of this type.  
...
[formatListItemCallback](UIElements.PopupField_1-formatListItemCallback.html)|
Callback that provides a string representation used to populate the popup
menu.  
[formatSelectedValueCallback](UIElements.PopupField_1-formatSelectedValueCallback.html)|
Callback that provides a string representation used to display the selected
value.  
[index](UIElements.PopupField_1-index.html)|  The currently selected index in
the popup menu. Setting the index will update the value field and send a
property change notification.  
[value](UIElements.PopupField_1-value.html)|  The currently selected value in
the popup menu.  
