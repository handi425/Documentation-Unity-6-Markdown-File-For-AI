...
# QueryListBlockAttribute Constructor
...
public QueryListBlockAttribute(string category, string name, string id, string
op);

## Declaration

public QueryListBlockAttribute(string category, string name, string[] ids,
string op);
