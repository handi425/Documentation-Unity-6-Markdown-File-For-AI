...
[inputUssClassName](UIElements.IntegerField-inputUssClassName.html)|  USS
class name of input elements in elements of this type.  
---|---  
[labelUssClassName](UIElements.IntegerField-labelUssClassName.html)|  USS
class name of labels in elements of this type.  
[ussClassName](UIElements.IntegerField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Constructors

[IntegerField](UIElements.IntegerField-ctor.html)|  Constructor.  
---|---  
  
### Public Methods

[ApplyInputDeviceDelta](UIElements.IntegerField.ApplyInputDeviceDelta.html)|
Applies the values of a 3D delta and a speed from an input device.  
---|---  
  
### Protected Methods

[StringToValue](UIElements.IntegerField.StringToValue.html)|  Converts a
string to an integer.  
---|---  
[ValueToString](UIElements.IntegerField.ValueToString.html)|  Converts the
given integer to a string.  
