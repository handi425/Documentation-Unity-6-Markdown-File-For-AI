...
#  [SpeedTreeImporter](SpeedTreeImporter.html).bestWindQuality
...
public int bestWindQuality;

### Description

Returns the best-possible wind quality on this asset (configured in SpeedTree
modeler).
