...
#  [ParticleSystem.EmitParams](ParticleSystem.EmitParams.html).rotation
...
Note that the value is an Euler angle. Additional resources:
[ParticleSystem.Particle.rotation](ParticleSystem.Particle-rotation.html).
