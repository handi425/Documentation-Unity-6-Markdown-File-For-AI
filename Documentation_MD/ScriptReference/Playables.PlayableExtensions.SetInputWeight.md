...
#  [PlayableExtensions](Playables.PlayableExtensions.html).SetInputWeight
...
---|---  
input | The connected [Playable](Playables.Playable.html) to change.  
weight | The weight. Should be between 0 and 1.  
  
### Description

Changes the weight of the [Playable](Playables.Playable.html) connected to the
current [Playable](Playables.Playable.html).
