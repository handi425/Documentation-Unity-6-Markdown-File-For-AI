...
#  [BlendTree](Animations.BlendTree.html).AddChild
...
public void AddChild([Motion](Motion.html) motion);

## Declaration

public void AddChild([Motion](Motion.html) motion, [Vector2](Vector2.html)
position);

## Declaration

public void AddChild([Motion](Motion.html) motion, float threshold);
