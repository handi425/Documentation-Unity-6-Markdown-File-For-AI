...
#
[GraphicsStateCollection](Experimental.Rendering.GraphicsStateCollection.html).LoadFromFile
...
**bool** Returns true if the collection was successfully loaded, false
otherwise.
...
The file extension of GraphicsStateCollection is *.graphicsstate.
    ...
    public class LoadFromFileExample : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            graphicsStateCollection.LoadFromFile(filePath);
        }
    }
