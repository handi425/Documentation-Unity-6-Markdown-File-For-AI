...
[IMGUIEvent](UIElements.IMGUIEvent-ctor.html)|  Constructor. Use GetPooled()
to get an event from a pool of reusable events.  
---|---  
  
### Protected Methods

[Init](UIElements.IMGUIEvent.Init.html)|  Resets the event members to their
initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.IMGUIEvent.GetPooled.html)|  Gets an event from the
