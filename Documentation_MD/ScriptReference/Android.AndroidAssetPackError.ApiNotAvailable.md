...
#  [AndroidAssetPackError](Android.AndroidAssetPackError.html).ApiNotAvailable
...
One possible cause of this is that the PlayCore version you added to the
project is too old. Additional resources:
