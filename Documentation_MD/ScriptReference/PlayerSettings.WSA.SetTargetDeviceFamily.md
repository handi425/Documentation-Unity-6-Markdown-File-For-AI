...
#  [PlayerSettings.WSA](PlayerSettings.WSA.html).SetTargetDeviceFamily
...
public static void
SetTargetDeviceFamily([PlayerSettings.WSATargetFamily](PlayerSettings.WSATargetFamily.html)
family, bool value);

### Parameters

family |  [Device Family type](PlayerSettings.WSATargetFamily.html) to change.  
---|---  
value | True to target the Device Family in the UWP build or false to remove it.  
  
### Description

Adds or removes the specified [UWP device
family](PlayerSettings.WSATargetFamily.html) from the list of device families
