...
#
[EditorGraphicsSettings](Rendering.EditorGraphicsSettings.html).GetSupportedRenderPipelineGraphicsSettingsTypesForPipeline
...
renderPipelineAssetType | A valid [RenderPipelineAsset](Rendering.RenderPipelineAsset.html) type.  
---|---  
  
### Returns

**IEnumerable <Type>** The available
