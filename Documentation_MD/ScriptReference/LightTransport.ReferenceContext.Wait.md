...
#  [ReferenceContext](LightTransport.ReferenceContext.html).Wait
...
the [IDeviceContext.Wait](LightTransport.IDeviceContext.Wait.html) method will
return immediately because the context doesn't use a queue.
