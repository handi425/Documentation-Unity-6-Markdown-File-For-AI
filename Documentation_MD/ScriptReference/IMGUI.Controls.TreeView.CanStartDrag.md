...
#  [TreeView](IMGUI.Controls.TreeView.html).CanStartDrag
...
protected bool
CanStartDrag([IMGUI.Controls.TreeView.CanStartDragArgs](IMGUI.Controls.TreeView.CanStartDragArgs.html)
args);

### Description

This function is called whenever a TreeViewItem is clicked and dragged. It
returns false by default.

Override this function so it returns true to enable drag and drop behavior for
TreeViewItems.  
