...
Asynchronous load request for an [AssetBundle](AssetBundle.html).

Additional resources:
[AssetBundle.LoadFromFileAsync](AssetBundle.LoadFromFileAsync.html),
[AssetBundle.LoadFromMemoryAsync](AssetBundle.LoadFromMemoryAsync.html),
[AssetBundle.LoadFromStreamAsync](AssetBundle.LoadFromStreamAsync.html),
[AsyncOperation](AsyncOperation.html).

### Properties

[assetBundle](AssetBundleCreateRequest-assetBundle.html)| Asset object being
loaded (Read Only).  
---|---  
