...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddBuildConfig
...
build configurations is the same. The created configurations are initially
empty. Care must be taken to fill them with reasonable defaults. The function
throws an exception if a build configuration with the given name already
exists.
    ...
    public class Sample_AddBuildConfig  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID for the config and modify it
