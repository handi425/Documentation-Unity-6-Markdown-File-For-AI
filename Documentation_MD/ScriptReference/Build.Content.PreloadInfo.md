...
[preloadObjects](Build.Content.PreloadInfo-preloadObjects.html)| List of
Objects for a serialized Scene that need to be preloaded.  
---|---  
  
### Constructors

[PreloadInfo](Build.Content.PreloadInfo-ctor.html)| Default constructor for an
empty PreloadInfo.  
---|---  
