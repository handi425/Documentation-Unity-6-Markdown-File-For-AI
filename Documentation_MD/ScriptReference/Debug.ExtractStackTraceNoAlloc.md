...
#  [Debug](Debug.html).ExtractStackTraceNoAlloc
...
public static int ExtractStackTraceNoAlloc(byte* buffer, int bufferMax, string
projectFolder);
...
of UTF-8 bytes, without allocating GC memory. Returns the number of bytes
