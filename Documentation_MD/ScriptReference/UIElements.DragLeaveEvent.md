...
element or one of its descendants. The DragLeaveEvent does not trickle down
and does not bubble up.

### Constructors

[DragLeaveEvent](UIElements.DragLeaveEvent-ctor.html)|  Constructor. Avoid
...
[Init](UIElements.DragLeaveEvent.Init.html)|  Resets the event members to
