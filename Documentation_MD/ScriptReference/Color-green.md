...
public static [Color](Color.html) green;
...
Solid green. RGBA is (0, 1, 0, 1).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        //Run your mouse over the [GameObject](GameObject.html) to change the [Renderer](Renderer.html)'s material color to green
        void OnMouseOver()
        {
            m_Renderer.material.color = [Color.green](Color-green.html);
        }  
