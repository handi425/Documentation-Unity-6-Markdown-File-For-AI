...
#  [AnimationUtility](AnimationUtility.html).GetFloatValue
...
public static bool GetFloatValue([GameObject](GameObject.html) root,
[EditorCurveBinding](EditorCurveBinding.html) binding, out float data);
...
public static bool GetFloatValue([GameObject](GameObject.html) root, string
relativePath, Type type, string propertyName, out float data);

### Description

Samples a curve on the GameObject you pass in and retrieves the current float
value.
