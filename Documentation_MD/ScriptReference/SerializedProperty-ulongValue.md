...
#  [SerializedProperty](SerializedProperty.html).ulongValue
...
Suitable for accessing values when [numericType](SerializedProperty-
numericType.html) is
[SerializedPropertyNumericType.UInt64](SerializedPropertyNumericType.UInt64.html),
and also supports smaller unsigned types (uint, ushort and byte).  
  
Additional resources: [longValue](SerializedProperty-longValue.html),
