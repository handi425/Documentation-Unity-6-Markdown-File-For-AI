...
#  [Progress.Item](Progress.Item.html).RegisterPauseCallback
...
Registers a callback that is called when a user pauses a running progress
indicator's task.

Additional resources:
[Progress.RegisterPauseCallback](Progress.RegisterPauseCallback.html),
[Progress.Item.UnregisterPauseCallback](Progress.Item.UnregisterPauseCallback.html),
[Progress.Item.Pause](Progress.Item.Pause.html).
