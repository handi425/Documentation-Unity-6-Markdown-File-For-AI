...
#  [StaticEditorFlags](StaticEditorFlags.html).BatchingStatic
...
Combine the GameObject's Mesh with other eligible Meshes, to potentially
reduce runtime rendering costs.

For more information, see the documentation on [Static
Batching](../Manual/DrawCallBatching.html).  
  
Note that you can use
[StaticBatchingUtility.Combine](StaticBatchingUtility.Combine.html) to combine
Meshes that do not have this StaticEditorFlag enabled at runtime.
    ...
    public class StaticEditorFlagsExample
    {
        ...
        static void CreateGameObjectAndSetStaticEditorFlags()
        {
            ...
            var flags = [StaticEditorFlags.BatchingStatic](StaticEditorFlags.BatchingStatic.html);
