...
Configures the build script classpath for this project. For more information
about the element, see Gradle's documentation:
[buildscript](https://docs.gradle.org/current/userguide/plugins.html#sec:applying_plugins_buildscript)

### Properties

[Dependencies](Unity.Android.Gradle.Buildscript.Dependencies.html)| The C#
definition of the dependencies element in a gradle file.  
---|---  
[Repositories](Unity.Android.Gradle.Buildscript.Repositories.html)| The C#
definition of the repositories element in a gradle file.  
  
### Constructors

[Buildscript](Unity.Android.Gradle.Buildscript-ctor.html)| Element
constructor.  
---|---  
