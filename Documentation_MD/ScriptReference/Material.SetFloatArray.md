...
#  [Material](Material.html).SetFloatArray
...
Sets a float array property on the material. If a float array property with
...
Additional resources: [GetFloatArray](Material.GetFloatArray.html).
