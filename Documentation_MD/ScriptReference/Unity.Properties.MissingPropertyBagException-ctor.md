...
# MissingPropertyBagException Constructor
...
type | The type for which no property bag was found.  
---|---  
...
Initializes a new instance of the
[MissingPropertyBagException](Unity.Properties.MissingPropertyBagException.html)
class with a specified type and a reference to the inner exception that is the
