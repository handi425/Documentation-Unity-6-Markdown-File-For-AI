...
#
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html).separateAxes
...
When disabled, only the z-axis rotation curve is used.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationOverLifetime.x = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)([Mathf.PI](Mathf.PI.html) * 2.0f, curve);
