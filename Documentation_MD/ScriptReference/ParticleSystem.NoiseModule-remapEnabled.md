...
#  [ParticleSystem.NoiseModule](ParticleSystem.NoiseModule.html).remapEnabled
...
Enable remapping of the final noise values, allowing for noise values to be
translated into different values.
