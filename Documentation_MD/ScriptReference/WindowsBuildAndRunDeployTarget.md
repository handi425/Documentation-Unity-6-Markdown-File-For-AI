...
[LocalMachine](WindowsBuildAndRunDeployTarget.LocalMachine.html)| Runs the app
on the local Windows PC.  
---|---  
[DevicePortal](WindowsBuildAndRunDeployTarget.DevicePortal.html)| Runs the app
on a remote Windows device using Windows DevicePortal (WDP).  
