...
#  [BuildPipeline](BuildPipeline.html).isBuildingPlayer
...
It can be used to check the context inside script code that could be triggered
during a build, for example when [ExecuteAlways](ExecuteAlways.html) is being
used on a [MonoBehaviour](MonoBehaviour.html).  
