...
You can use `GraphicsAPIConstraintAttribute` to enable or disable [filter
attributes](ShaderKeywordFilter.FilterAttribute.html) based on the
[GraphicsDeviceType](Rendering.GraphicsDeviceType.html), so you can filter
shader keywords differently on different graphics APIs.  
...
[GraphicsAPIConstraintAttribute](ShaderKeywordFilter.GraphicsAPIConstraintAttribute-
