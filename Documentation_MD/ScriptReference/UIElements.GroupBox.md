...
This is an enclosing container for a group of IGroupBoxOption. All group
options within this container will interact together to allow a single
selection, using the DefaultGroupManager. Default options are
[RadioButton](UIElements.RadioButton.html), but users can provide other
implementations. If no IGroupBox is found in the hierarchy, the default
container will be the panel.

### Static Properties

[labelUssClassName](UIElements.GroupBox-labelUssClassName.html)|  USS class
name for Labels in GroupBox elements.  
---|---  
[ussClassName](UIElements.GroupBox-ussClassName.html)|  USS class name for
GroupBox elements.  
