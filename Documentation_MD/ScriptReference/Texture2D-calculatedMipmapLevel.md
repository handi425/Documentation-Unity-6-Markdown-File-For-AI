...
#  [Texture2D](Texture2D.html).calculatedMipmapLevel
...
[requestedMipmapLevel](Texture2D-requestedMipmapLevel.html) or
[minimumMipmapLevel](Texture2D-minimumMipmapLevel.html).

Additional resources: [desiredMipmapLevel](Texture2D-desiredMipmapLevel.html)
