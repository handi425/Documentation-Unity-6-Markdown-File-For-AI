...
#  [Mesh.MeshData](Mesh.MeshData.html).GetUVs
...
The destination array must have at least [vertexCount](Mesh.MeshData-
vertexCount.html) elements. The UV at each index corresponds to the vertex
with the same index. Texture coordinate data will be converted into
[Vector2](Vector2.html), [Vector3](Vector3.html) or [Vector4](Vector4.html)
format as needed. Additional resources: [Mesh.GetUVs](Mesh.GetUVs.html),
