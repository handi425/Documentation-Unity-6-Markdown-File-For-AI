...
#  [Tilemap](Tilemaps.Tilemap.html).GetTilesRangeCount
...
public int GetTilesRangeCount([Vector3Int](Vector3Int.html) startPosition,
[Vector3Int](Vector3Int.html) endPosition);
...
Retrieves the number of Tiles within the given range, inclusive of the Cells
at both the starting position and the ending positions. This method begins at
the given starting position and iterates through all available Z Positions,
then iterates through the X and Y positions until it reaches the ending
position.
...
the ending position.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            ...
            var count = tilemap.GetTilesRangeCount(new [Vector3Int](Vector3Int.html)(0, 0, 0), new [Vector3Int](Vector3Int.html)(5, 1, 0));  
      
            [Vector3Int](Vector3Int.html)[] positions = new [Vector3Int](Vector3Int.html)[count];
            [TileBase](Tilemaps.TileBase.html)[] tiles = new [TileBase](Tilemaps.TileBase.html)[count];
            count = tilemap.GetTilesRangeNonAlloc(new [Vector3Int](Vector3Int.html)(0, 0, 0), new [Vector3Int](Vector3Int.html)(5, 1, 0), positions, tiles);
...
In the example above, GetTilesRangeCount will return a count of sixteen: ten
