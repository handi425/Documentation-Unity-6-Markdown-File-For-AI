...
that are attached to the same GameObject as an enabled Camera component, just
after that Camera renders the scene. For a full description and code example,
see [MonoBehaviour.OnPostRender](MonoBehaviour.OnPostRender.html).  
