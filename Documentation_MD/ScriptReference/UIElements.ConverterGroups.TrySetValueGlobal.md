...
#  [ConverterGroups](UIElements.ConverterGroups.html).TrySetValueGlobal
...
public static bool TrySetValueGlobal(ref TContainer container, ref
...
Sets the value of a property at the given path to the given value, using the
global converters.
