...
[bones](SkinnedMeshRenderer-bones.html)| The bones used to skin the mesh.  
---|---  
[forceMatrixRecalculationPerRender](SkinnedMeshRenderer-
forceMatrixRecalculationPerRender.html)| Forces the Skinned Mesh to
recalculate its matricies when rendered  
[quality](SkinnedMeshRenderer-quality.html)| The maximum number of bones per
vertex that are taken into account during skinning.  
[sharedMesh](SkinnedMeshRenderer-sharedMesh.html)| The mesh used for skinning.  
[skinnedMotionVectors](SkinnedMeshRenderer-skinnedMotionVectors.html)|
Specifies whether skinned motion vectors should be used for this renderer.  
[updateWhenOffscreen](SkinnedMeshRenderer-updateWhenOffscreen.html)| If
enabled, the Skinned Mesh will be updated when offscreen. If disabled, this
also disables updating animations.  
[vertexBufferTarget](SkinnedMeshRenderer-vertexBufferTarget.html)| The
intended target usage of the skinned mesh GPU vertex buffer.  
  
### Public Methods

[BakeMesh](SkinnedMeshRenderer.BakeMesh.html)| Creates a snapshot of
SkinnedMeshRenderer and stores it in mesh.  
---|---  
[GetBlendShapeWeight](SkinnedMeshRenderer.GetBlendShapeWeight.html)| Returns
the weight of a BlendShape for this Renderer.  
[GetPreviousVertexBuffer](SkinnedMeshRenderer.GetPreviousVertexBuffer.html)|
Retrieves a GraphicsBuffer that provides direct access to the GPU vertex
buffer for this skinned mesh, for the previous frame.  
[GetVertexBuffer](SkinnedMeshRenderer.GetVertexBuffer.html)| Retrieves a
GraphicsBuffer that provides direct access to the GPU vertex buffer for this
skinned mesh, for the current frame.  
[SetBlendShapeWeight](SkinnedMeshRenderer.SetBlendShapeWeight.html)| Sets the
weight of a BlendShape for this Renderer.  
