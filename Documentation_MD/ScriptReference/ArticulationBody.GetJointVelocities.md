...
#  [ArticulationBody](ArticulationBody.html).GetJointVelocities
...
Reads back articulation body joint velocities of the entire hierarchy to the
supplied list of floats .

This returns joint velocities in the reduced coordinate space for the entire
...
[SetJointVelocities](ArticulationBody.SetJointVelocities.html).
