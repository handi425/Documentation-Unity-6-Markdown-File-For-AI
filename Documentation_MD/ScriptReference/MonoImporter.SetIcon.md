...
#  [MonoImporter](MonoImporter.html).SetIcon
...
public void SetIcon([Texture2D](Texture2D.html) icon);
...
MonoScripts can have an associated custom icon. This icon is used in the Scene
view, the Inspector, and the Project window.  
  
Additional resources: [MonoImporter.GetIcon](MonoImporter.GetIcon.html),
[PluginImporter.SetIcon](PluginImporter.SetIcon.html),
