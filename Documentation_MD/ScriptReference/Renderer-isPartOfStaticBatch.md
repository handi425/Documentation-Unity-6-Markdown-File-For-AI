...
#  [Renderer](Renderer.html).isPartOfStaticBatch
...
Indicates whether the renderer is part of a [static batch](../Manual/static-
batching.html) with other renderers.

Unity sets this flag after it generates the static batch that contains the
renderer. Be aware that Unity generates static batches at different times for
the Unity Player and Unity Editor:  
