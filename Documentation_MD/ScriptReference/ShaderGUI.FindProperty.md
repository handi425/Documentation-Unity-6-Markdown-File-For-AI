...
#  [ShaderGUI](ShaderGUI.html).FindProperty
...
protected static [MaterialProperty](MaterialProperty.html) FindProperty(string
propertyName, MaterialProperty[] properties);

## Declaration

protected static [MaterialProperty](MaterialProperty.html) FindProperty(string
propertyName, MaterialProperty[] properties, bool propertyIsMandatory);
