...
#  [PropertyBag](Unity.Properties.PropertyBag.html).GetPropertyBag
...
The returned [IPropertyBag](Unity.Properties.IPropertyBag.html) can be used to
get the strongly typed generic using the IPropertyBagAccept interface method.
