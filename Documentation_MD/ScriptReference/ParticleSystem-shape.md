...
#  [ParticleSystem](ParticleSystem.html).shape
...
public [ParticleSystem.ShapeModule](ParticleSystem.ShapeModule.html) shape;
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        public [Mesh](Mesh.html) myMesh;  
      
        void Start() {
            [ParticleSystem](ParticleSystem.html) ps = GetComponent<[ParticleSystem](ParticleSystem.html)>();
            var sh = ps.shape;
            sh.enabled = true;
            sh.shapeType = [ParticleSystemShapeType.Mesh](ParticleSystemShapeType.Mesh.html);
            sh.mesh = myMesh;
        }
    }
