...
If the settings change through the default inspector or through the Reset or
through SetValueAndNotify,
RenderPipelineEditorUtility.RecreateRenderPipelineMatchingSettings is called
onto the settings.
