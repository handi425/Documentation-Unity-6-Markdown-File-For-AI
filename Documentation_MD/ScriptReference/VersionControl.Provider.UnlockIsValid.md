...
#  [Provider](VersionControl.Provider.html).UnlockIsValid
...
public static bool
UnlockIsValid([VersionControl.AssetList](VersionControl.AssetList.html)
assets);

## Declaration

public static bool
UnlockIsValid([VersionControl.Asset](VersionControl.Asset.html) asset);
...
Returns true if unlocking the assets is a valid operation.
    ...
    {
        [[MenuItem](MenuItem.html)("Version Control/UnlockIsValid")]
        public static void ExampleUnlockIsValid()
        {
            ...
            [Debug.Log](Debug.Log.html)([Provider.UnlockIsValid](VersionControl.Provider.UnlockIsValid.html)(assets));
        }
    }
