...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetUnityFrameworkTargetGuid
...
Returns the GUID of the framework target. This target includes source code,
plugins, dependent frameworks, and source compile/link build options. You can
retrieve the other targets using
[GetUnityMainTargetGuid](iOS.Xcode.PBXProject.GetUnityMainTargetGuid.html) and
[TargetGuidByName](iOS.Xcode.PBXProject.TargetGuidByName.html).
