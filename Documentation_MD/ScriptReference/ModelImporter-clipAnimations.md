...
#  [ModelImporter](ModelImporter.html).clipAnimations
...
If you need to populate clipAnimations before the first import you can use an
[AssetPostprocessor](AssetPostprocessor.html) and override
[AssetPostprocessor.OnPreprocessAnimation](AssetPostprocessor.OnPreprocessAnimation.html).
    ...
    public class CreateAnimationClip : [AssetPostprocessor](AssetPostprocessor.html)
    {
