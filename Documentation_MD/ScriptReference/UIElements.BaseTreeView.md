...
Base class for a tree view, a vertically scrollable area that links to, and
displays, a list of items organized in a tree.
...
[BaseTreeView](UIElements.BaseTreeView-ctor.html)|  Creates a TreeView with
