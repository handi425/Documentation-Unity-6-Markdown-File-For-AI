...
#  [Shader](Shader.html).SetGlobalBuffer
...
public static void SetGlobalBuffer(string name,
[ComputeBuffer](ComputeBuffer.html) value);

## Declaration

public static void SetGlobalBuffer(int nameID,
[ComputeBuffer](ComputeBuffer.html) value);

## Declaration

public static void SetGlobalBuffer(string name,
[GraphicsBuffer](GraphicsBuffer.html) value);
...
Additional resources: [SetGlobalTexture](Shader.SetGlobalTexture.html),
[ComputeBuffer](ComputeBuffer.html) class,
[GraphicsBuffer](GraphicsBuffer.html) class, [ShaderLab
