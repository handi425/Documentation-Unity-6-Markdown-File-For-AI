...
#  [GameObjectRecorder](Animations.GameObjectRecorder.html).SaveToClip
...
public void SaveToClip([AnimationClip](AnimationClip.html) clip);

## Declaration

public void SaveToClip([AnimationClip](AnimationClip.html) clip, float fps);

## Declaration

public void SaveToClip([AnimationClip](AnimationClip.html) clip, float fps,
[Animations.CurveFilterOptions](Animations.CurveFilterOptions.html)
filterOptions);
