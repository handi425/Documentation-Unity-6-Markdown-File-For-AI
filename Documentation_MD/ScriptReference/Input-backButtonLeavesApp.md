...
#  [Input](Input.html).backButtonLeavesApp
...
responding to **Back** button. You can do this by calling
[Input.GetKey](Input.GetKey.html) and passing
[KeyCode.Escape](KeyCode.Escape.html).  
