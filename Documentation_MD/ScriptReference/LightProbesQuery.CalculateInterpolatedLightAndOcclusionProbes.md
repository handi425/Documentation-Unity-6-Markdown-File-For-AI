...
#
[LightProbesQuery](LightProbesQuery.html).CalculateInterpolatedLightAndOcclusionProbes
...
public void CalculateInterpolatedLightAndOcclusionProbes(NativeArray<Vector3>
positions, NativeArray<int> tetrahedronIndices,
NativeArray<SphericalHarmonicsL2> lightProbes, NativeArray<Vector4>
occlusionProbes);
