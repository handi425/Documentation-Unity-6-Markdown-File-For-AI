...
The Animation window will update when selecting Animation clips in the Project
window or game objects with Animation players (such as
[Animator](Animator.html) or [Animation](Animation.html)) in the Scene
hierarchy.

### Properties

[animationClip](AnimationWindow-animationClip.html)| The animation clip
selected in the Animation window.  
---|---  
[canPreview](AnimationWindow-canPreview.html)| True if Animation window can
enable preview mode. False otherwise. (Read Only)  
[canRecord](AnimationWindow-canRecord.html)| True if Animation window can
enable recording mode. False otherwise. (Read Only)  
[frame](AnimationWindow-frame.html)| The frame number at which the Animation
window playhead is located.  
[playing](AnimationWindow-playing.html)| This property toggles animation
playback in the Animation window.  
[previewing](AnimationWindow-previewing.html)| This property toggles
previewing in the Animation window.  
[recording](AnimationWindow-recording.html)| This property toggles recording
in the Animation window.  
[time](AnimationWindow-time.html)| The time value at which the Animation
window playhead is located.  
