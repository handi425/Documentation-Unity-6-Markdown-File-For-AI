...
efficient and has additional features. public string text;

### Description

Returns the contents of the fetched web page as a string (Read Only).

If the object has not finished downloading the data, it will return an empty
string. Use isDone or `yield` to see if the data is available.  
  
This function expects the web page contents in UTF-8 or ASCII character set.
The returned string might be not correct for other characters or binary data.
