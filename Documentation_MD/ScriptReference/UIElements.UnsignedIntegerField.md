...
Makes a text field for entering an unsigned integer. For more information,
refer to [UXML element UnsignedIntegerField](../Manual/UIE-uxml-element-
UnsignedIntegerField.html).

### Static Properties

[inputUssClassName](UIElements.UnsignedIntegerField-inputUssClassName.html)|
USS class name of input elements in elements of this type.  
---|---  
[labelUssClassName](UIElements.UnsignedIntegerField-labelUssClassName.html)|
USS class name of labels in elements of this type.  
[ussClassName](UIElements.UnsignedIntegerField-ussClassName.html)|  USS class
name of elements of this type.  
  
### Constructors

[UnsignedIntegerField](UIElements.UnsignedIntegerField-ctor.html)|
Constructor.  
---|---  
  
### Public Methods

[ApplyInputDeviceDelta](UIElements.UnsignedIntegerField.ApplyInputDeviceDelta.html)|
Applies the values of a 3D delta and a speed from an input device.  
---|---  
  
### Protected Methods

[StringToValue](UIElements.UnsignedIntegerField.StringToValue.html)|  Converts
a string to an unsigned integer.  
---|---  
[ValueToString](UIElements.UnsignedIntegerField.ValueToString.html)|  Converts
the given unsigned integer to a string.  
