...
#
[VersionControlUtils](VersionControl.VersionControlUtils.html).IsPathVersioned
...
For example, files in your Assets folder are usually tracked, while files in
your Library folder are not.
