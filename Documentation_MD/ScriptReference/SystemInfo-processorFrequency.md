...
#  [SystemInfo](SystemInfo.html).processorFrequency
...
This function returns the nominal CPU frequency in MHz, or zero if unknown.
...
On some platforms it's not possible to query the CPU frequency. Currently such
platforms are iOS and WebGL.  
  
Additional resources: [SystemInfo.processorCount](SystemInfo-
processorCount.html), [SystemInfo.processorType](SystemInfo-
processorType.html).
