...
[Dragger](Experimental.GraphView.Dragger-ctor.html)| Dragger constructor.  
---|---  
...
---|---  
[OnMouseDown](Experimental.GraphView.Dragger.OnMouseDown.html)| Called on
mouse down event.  
[OnMouseMove](Experimental.GraphView.Dragger.OnMouseMove.html)| Called on
mouse move event.  
[OnMouseUp](Experimental.GraphView.Dragger.OnMouseUp.html)| Called on mouse up
event.  
[RegisterCallbacksOnTarget](Experimental.GraphView.Dragger.RegisterCallbacksOnTarget.html)|
Called to register click event callbacks on the target element.  
[UnregisterCallbacksFromTarget](Experimental.GraphView.Dragger.UnregisterCallbacksFromTarget.html)|
