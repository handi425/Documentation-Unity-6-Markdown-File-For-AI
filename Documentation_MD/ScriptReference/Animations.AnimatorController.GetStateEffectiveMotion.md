...
#
[AnimatorController](Animations.AnimatorController.html).GetStateEffectiveMotion
...
public [Motion](Motion.html)
GetStateEffectiveMotion([Animations.AnimatorState](Animations.AnimatorState.html)
state);
