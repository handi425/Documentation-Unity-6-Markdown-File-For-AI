...
[PathPermission
element](https://developer.android.com/guide/topics/manifest/path-permission-
element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.PathPermission.Attributes.html)|
The attributes container for the <path-permission> element.  
---|---  
  
### Constructors

[PathPermission](Unity.Android.Gradle.Manifest.PathPermission-ctor.html)|
Element constructor.  
---|---  
