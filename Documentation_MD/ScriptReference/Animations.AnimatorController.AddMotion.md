...
#  [AnimatorController](Animations.AnimatorController.html).AddMotion
...
AddMotion([Motion](Motion.html) motion);

## Declaration

public [Animations.AnimatorState](Animations.AnimatorState.html)
AddMotion([Motion](Motion.html) motion, int layerIndex);
...
to which it is added. This function pushes an Undo operation.
