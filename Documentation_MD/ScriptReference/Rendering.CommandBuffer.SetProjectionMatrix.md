...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetProjectionMatrix
...
public void SetProjectionMatrix([Matrix4x4](Matrix4x4.html) proj);
...
The projection matrix is the matrix that transforms from view space into
homogeneous clip space.  
  
When you want to set both the view and projection matrices, it's more
efficient to use
[SetViewProjectionMatrices](Rendering.CommandBuffer.SetViewProjectionMatrices.html)
because it sets both in one CommandBuffer command.  
