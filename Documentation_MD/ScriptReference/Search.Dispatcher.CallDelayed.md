...
#  [Dispatcher](Search.Dispatcher.html).CallDelayed
...
CallDelayed([EditorApplication.CallbackFunction](EditorApplication.CallbackFunction.html)
callback, double seconds);
...
**Action** Returns an off handler that can be used to unregister the callback
before it gets executed in the main thread later.
