...
[defaultValueAsString](UIElements.UxmlStringAttributeDescription-
defaultValueAsString.html)|  The default value for the attribute, as a string.  
---|---  
  
### Constructors

[UxmlStringAttributeDescription](UIElements.UxmlStringAttributeDescription-
ctor.html)|  Constructor.  
---|---  
  
### Public Methods

[GetValueFromBag](UIElements.UxmlStringAttributeDescription.GetValueFromBag.html)|
Retrieves the value of this attribute from the attribute bag. Returns the
value if found; otherwise, it returns defaultValue.  
---|---  
[TryGetValueFromBag](UIElements.UxmlStringAttributeDescription.TryGetValueFromBag.html)|
