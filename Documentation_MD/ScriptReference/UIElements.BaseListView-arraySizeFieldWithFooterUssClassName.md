...
#
[BaseListView](UIElements.BaseListView.html).arraySizeFieldWithFooterUssClassName
...
The USS class name for the size field of the ListView when the footer is
enabled.
