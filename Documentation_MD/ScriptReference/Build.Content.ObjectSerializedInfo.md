...
[header](Build.Content.ObjectSerializedInfo-header.html)| Serialized object
header information.  
---|---  
[rawData](Build.Content.ObjectSerializedInfo-rawData.html)| Raw byte data of
the object if it was serialized seperately from the header.  
[serializedObject](Build.Content.ObjectSerializedInfo-serializedObject.html)|
