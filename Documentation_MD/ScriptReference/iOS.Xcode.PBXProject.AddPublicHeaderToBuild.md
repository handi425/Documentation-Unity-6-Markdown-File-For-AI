...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddPublicHeaderToBuild
...
In projects containing multiple native targets, you can configure a file to
build in all, some, or, none of the targets. The file reference is added to
appropriate build section.
    ...
    public class Sample_AddPublicHeaderToBuild  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the target you want to add the Headers Build Phase to
            string mainTargetGuid = pbxProject.GetUnityMainTargetGuid();  
      
            // Add Headers Build Phase
            pbxProject.AddHeadersBuildPhase(mainTargetGuid);  
      
            // Add the header file to the project and add it to Public Headers Build Phase
            string headerGuid = pbxProject.AddFile("exampleHeader.h", "Headers/exampleHeader.h", [PBXSourceTree.Source](iOS.Xcode.PBXSourceTree.Source.html));
            pbxProject.AddPublicHeaderToBuild(mainTargetGuid, headerGuid);  
