...
Returns square root of `f`.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        // [Vector3.Distance](Vector3.Distance.html) and several other standard functions.
        float HypotenuseLength(float sideALength, float sideBLength)
        {
            return [Mathf.Sqrt](Mathf.Sqrt.html)(sideALength * sideALength + sideBLength * sideBLength);
        }
    }
