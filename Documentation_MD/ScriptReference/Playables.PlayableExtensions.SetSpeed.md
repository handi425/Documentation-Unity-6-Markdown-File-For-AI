...
#  [PlayableExtensions](Playables.PlayableExtensions.html).SetSpeed
...
This affects the speed at which the local time is incremented when the
[Playable](Playables.Playable.html) is playing.
