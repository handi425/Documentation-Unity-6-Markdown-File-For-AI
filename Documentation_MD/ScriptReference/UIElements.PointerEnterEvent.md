...
This event is sent when a pointer enters a VisualElement or one of its
descendants. The event does not trickle down and does not bubble up.

### Constructors

[PointerEnterEvent](UIElements.PointerEnterEvent-ctor.html)|  Constructor.
...
[Init](UIElements.PointerEnterEvent.Init.html)|  Resets the event members to
