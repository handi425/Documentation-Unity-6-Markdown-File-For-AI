...
#  [TrailRenderer](TrailRenderer.html).numCornerVertices
...
Set this to a value greater than 0, to get rounded corners between each
segment of the trail.

The value controls how many vertices are added to each joint, where a higher
