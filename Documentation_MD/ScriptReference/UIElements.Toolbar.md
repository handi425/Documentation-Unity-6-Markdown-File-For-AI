...
A toolbar for tool windows. For more information, refer to [UXML element
Toolbar](../Manual/UIE-uxml-element-Toolbar.html).

### Static Properties

[ussClassName](UIElements.Toolbar-ussClassName.html)|  USS class name of
elements of this type.  
---|---  
  
### Constructors

[Toolbar](UIElements.Toolbar-ctor.html)|  Constructor.  
---|---  
