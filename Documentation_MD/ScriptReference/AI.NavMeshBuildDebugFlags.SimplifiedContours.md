...
#  [NavMeshBuildDebugFlags](AI.NavMeshBuildDebugFlags.html).SimplifiedContours
...
vertices and straighter edges compared to
[RawContours](AI.NavMeshBuildDebugFlags.RawContours.html).
