...
This channel is also commonly called "UV6". It maps to the shader semantic
`TEXCOORD6`. When you call
[Mesh.HasVertexAttribute](Mesh.HasVertexAttribute.html), this channel
corresponds to
[VertexAttribute.TexCoord6](Rendering.VertexAttribute.TexCoord6.html).  
