...
#  [Editor](Editor.html).GetInfoString
...
You will also have to implement [HasPreviewGUI](Editor.HasPreviewGUI.html) and
[OnPreviewGUI](Editor.OnPreviewGUI.html) in addition to this method. The
default implementation just returns an empty string, which disables the
feature.  
