...
Inherits from:[UIElements.Toggle](UIElements.Toggle.html)
...
A toggle for the toolbar. For more information, refer to [UXML element
ToolbarToggle](../Manual/UIE-uxml-element-ToolbarToggle.html).
...
[ToolbarToggle](UIElements.ToolbarToggle-ctor.html)|  Constructor.  
---|---  
