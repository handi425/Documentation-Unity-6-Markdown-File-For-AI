...
#  [Shader](Shader.html).FindPropertyIndex
...
[GetPropertyType](Shader.GetPropertyType.html) and
[GetPropertyFlags](Shader.GetPropertyFlags.html) to get more detailed property
information. If Unity cannot find a property with the given name, the function
returns -1.
