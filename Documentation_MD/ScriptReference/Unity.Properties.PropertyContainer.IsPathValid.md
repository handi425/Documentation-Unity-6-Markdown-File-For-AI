...
#  [PropertyContainer](Unity.Properties.PropertyContainer.html).IsPathValid
...
Returns `true` if a property exists at the specified
...
public static bool IsPathValid(TContainer container, ref
