...
Represents a string element in plist document.

### Properties

[value](iOS.Xcode.PlistElementString-value.html)| The value stored in the
string element.  
---|---  
  
### Constructors

[PlistElementString](iOS.Xcode.PlistElementString-ctor.html)| Creates new
string element.  
---|---  
