...
Inherits
from:[UIElements.ImmediateModeElement](UIElements.ImmediateModeElement.html)
...
[GridBackground](Experimental.GraphView.GridBackground-ctor.html)|
...
[cullingEnabled](UIElements.ImmediateModeElement-cullingEnabled.html)|  When
this property is set to true, the Element does not repaint itself when it is
...
[ImmediateRepaint](UIElements.ImmediateModeElement.ImmediateRepaint.html)|
