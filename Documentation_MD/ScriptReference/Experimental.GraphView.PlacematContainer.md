...
Inherits
from:[Experimental.GraphView.GraphView.Layer](Experimental.GraphView.GraphView.Layer.html)
...
[PlacematsLayer](Experimental.GraphView.PlacematContainer.PlacematsLayer.html)|
The layer index for placing a PlacematContainer in a GraphView.  
---|---  
  
### Properties

[Placemats](Experimental.GraphView.PlacematContainer.Placemats.html)| The
enumeration of the placemats in this PlacematContainer.  
---|---  
  
### Constructors

[PlacematContainer](Experimental.GraphView.PlacematContainer-ctor.html)|
Constructor.  
---|---  
  
### Public Methods

[CreatePlacemat](Experimental.GraphView.PlacematContainer.CreatePlacemat.html)|
Creates and initializes a new placemat in this PlacematContainer.  
---|---  
[GetPortCenterOverride](Experimental.GraphView.PlacematContainer.GetPortCenterOverride.html)|
Gets another location for a specific port and checks if the port has an
overridden position.  
[GetTopZOrder](Experimental.GraphView.PlacematContainer.GetTopZOrder.html)|
Retrieves the ZOrder value greater than the top-most placemat. For example, if
the top-most placemat has a ZOrder value of 10, this method returns 11.  
[HideCollapsedEdges](Experimental.GraphView.PlacematContainer.HideCollapsedEdges.html)|
Hides the edges that are hidden because of collapsed placemats.  
[RemoveAllPlacemats](Experimental.GraphView.PlacematContainer.RemoveAllPlacemats.html)|
Removes the placemats in this PlacematContainer.  
  
### Protected Methods

[UpdateElementsOrder](Experimental.GraphView.PlacematContainer.UpdateElementsOrder.html)|
