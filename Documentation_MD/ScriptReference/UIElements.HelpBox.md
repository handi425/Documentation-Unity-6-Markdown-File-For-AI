...
[UXML element HelpBox](../Manual/UIE-uxml-element-HelpBox.html).

    
    
     public class HelpBoxExample : [EditorWindow](EditorWindow.html)
     {
         [[MenuItem](MenuItem.html)("Example/[Help](Help.html) [Box](UIElements.Box.html)")]
         static void ShowWindow()
         {
             HelpBoxExample window = (HelpBoxExample)[EditorWindow.GetWindow](EditorWindow.GetWindow.html)(typeof(HelpBoxExample));
             window.Show();
         }  
      
         void OnEnable()
         {
             rootVisualElement.Add(new [HelpBox](UIElements.HelpBox.html)("This is a help box", [HelpBoxMessageType.Info](UIElements.HelpBoxMessageType.Info.html)));
         }
     }
...
[iconErrorUssClassName](UIElements.HelpBox-iconErrorUssClassName.html)|  The
USS class name for the HelpBoxMessageType.Error state in Elements of this
type.  
---|---  
[iconInfoUssClassName](UIElements.HelpBox-iconInfoUssClassName.html)|  The USS
class name for the HelpBoxMessageType.Info state in Elements of this type.  
[iconUssClassName](UIElements.HelpBox-iconUssClassName.html)|  The USS class
name for images in Elements of this type.  
[iconwarningUssClassName](UIElements.HelpBox-iconwarningUssClassName.html)|
The USS class name for the HelpBoxMessageType.Warning state in Elements of
this type.  
[labelUssClassName](UIElements.HelpBox-labelUssClassName.html)|  The USS class
name for labels in Elements of this type.  
[ussClassName](UIElements.HelpBox-ussClassName.html)|  The USS class name for
Elements of this type.  
  
### Properties

[messageType](UIElements.HelpBox-messageType.html)|  The type of message.  
---|---  
[text](UIElements.HelpBox-text.html)|  The message text.  
  
### Constructors

[HelpBox](UIElements.HelpBox-ctor.html)|  Creates a new HelpBox.  
---|---  
