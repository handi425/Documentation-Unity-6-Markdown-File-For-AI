...
#  [SearchProvider](Search.SearchProvider.html).fetchPropositions
...
public
Func<SearchContext,SearchPropositionOptions,IEnumerable<SearchProposition>>
fetchPropositions;

### Description

Handler used to enumerate search propositions when the user is using TAB to
