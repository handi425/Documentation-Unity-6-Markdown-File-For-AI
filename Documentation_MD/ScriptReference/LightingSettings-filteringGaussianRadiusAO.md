...
#  [LightingSettings](LightingSettings.html).filteringGaussianRadiusAO
...
public float filteringGaussianRadiusAO;
...
The default value is 1. The value range is 0.0 to 5.0. A higher value
increases the strength of the blur, which reduces the amount of noise from
direct light in the lightmap.  
