...
**Note:** This method derives from TerrainWizard. Additional resources:
[TerrainWizard](TerrainWizard.html), DetailMeshWizard

### Public Methods

[OnEnable](TerrainDetailTextureWizard.OnEnable.html)| Unity calls this method
automatically when the detail mesh wizard is enabled.  
---|---  
[ResetDefaults](TerrainDetailTextureWizard.ResetDefaults.html)| Initializes
the texture detail wizard's defaults.  
