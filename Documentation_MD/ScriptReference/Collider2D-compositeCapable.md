...
#  [Collider2D](Collider2D.html).compositeCapable
...
Indicates if this [Collider2D](Collider2D.html) is capable of being composited
by the [CompositeCollider2D](CompositeCollider2D.html).
