...
#  [PlistElement](iOS.Xcode.PlistElement.html).AsDate
...
The method is equivalent to `((PlistElementDate) el).value`. Throws exception
if the element is not [PlistElementDate](iOS.Xcode.PlistElementDate.html).
    ...
    public class PlistElementAsDateExample
    {
        [PostProcessBuild]
        public static void AsDateExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
            if (buildTarget == [BuildTarget.iOS](BuildTarget.iOS.html)) 
            {
                ...
                // Retrieve an Info.plist element and convert it to "DateTime" using the helper AsDate method
