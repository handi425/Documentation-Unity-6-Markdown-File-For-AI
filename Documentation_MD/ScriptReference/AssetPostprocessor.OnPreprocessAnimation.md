...
#  [AssetPostprocessor](AssetPostprocessor.html).OnPreprocessAnimation()
...
Add this function to a subclass to get a notification just before animation
from a model (.fbx, .mb file etc.) is imported.
