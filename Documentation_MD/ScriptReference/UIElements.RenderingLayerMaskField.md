...
Drawer for [RenderingLayerMask](RenderingLayerMask.html).

### Static Properties

[inputUssClassName](UIElements.RenderingLayerMaskField-
inputUssClassName.html)| USS class name of input elements in elements of this
type.  
---|---  
[labelUssClassName](UIElements.RenderingLayerMaskField-
labelUssClassName.html)| USS class name of labels in elements of this type.  
[ussClassName](UIElements.RenderingLayerMaskField-ussClassName.html)| USS
class name of elements of this type.  
  
### Properties

[value](UIElements.RenderingLayerMaskField-value.html)| Access a rendering
layer mask value as an unsigned integer value.  
---|---  
  
### Constructors

[RenderingLayerMaskField](UIElements.RenderingLayerMaskField-ctor.html)|
