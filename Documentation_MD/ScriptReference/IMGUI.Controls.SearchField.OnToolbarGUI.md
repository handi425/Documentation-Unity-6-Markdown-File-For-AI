...
#  [SearchField](IMGUI.Controls.SearchField.html).OnToolbarGUI
...
This function displays the search field with the toolbar UI style and uses the
...
public string OnToolbarGUI([Rect](Rect.html) rect, string text);
...
This function displays the search field with a toolbar style in the given
Rect.
