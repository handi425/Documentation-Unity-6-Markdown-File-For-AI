...
#  [RenderQueue](Rendering.RenderQueue.html).Transparent
...
Anything alpha-blended (i.e. shaders that don’t write to depth buffer) should
go here (glass, particle effects).  
