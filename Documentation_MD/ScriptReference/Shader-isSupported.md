...
#  [Shader](Shader.html).isSupported
...
Returns true if the shader itself or any fallbacks setup in the shader are
supported. Most often you use this when implementing special effects.
...
Additional resources: [Material](Material.html) class, [ShaderLab
