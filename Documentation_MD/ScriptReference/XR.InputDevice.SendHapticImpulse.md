...
#  [InputDevice](XR.InputDevice.html).SendHapticImpulse
...
**Note:** Not all devices support all parameters (OpenVR currently only
supports amplitude). To determine whether impulse haptics are supported, call
the TryGetHapticCapabilities method and inspect the supportsImpulse property.
