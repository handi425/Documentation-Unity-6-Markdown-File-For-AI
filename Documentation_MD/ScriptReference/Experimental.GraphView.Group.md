...
Inherits
from:[Experimental.GraphView.Scope](Experimental.GraphView.Scope.html)
...
Implements
interfaces:[ICollectibleElement](Experimental.GraphView.ICollectibleElement.html)
...
[title](Experimental.GraphView.Group-title.html)| Title of the group.  
---|---  
  
### Constructors

[Group](Experimental.GraphView.Group-ctor.html)| Group constructor.  
---|---  
  
### Public Methods

[AcceptsElement](Experimental.GraphView.Group.AcceptsElement.html)| Whether an
element can be added to this group.  
---|---  
[CollectElements](Experimental.GraphView.Group.CollectElements.html)|
Retrieves a set of graph elements that match a specified condition. The
matching graph elements are selected from this group.  
[FocusTitleTextField](Experimental.GraphView.Group.FocusTitleTextField.html)|
Focuses the title text field of this group, so that it's editable from the UI.  
  
### Protected Methods

[OnElementsAdded](Experimental.GraphView.Group.OnElementsAdded.html)| Called
when elements are added to this group.  
---|---  
[OnElementsRemoved](Experimental.GraphView.Group.OnElementsRemoved.html)|
Called when elements are removed from this group.  
[OnGroupRenamed](Experimental.GraphView.Group.OnGroupRenamed.html)| Called
when this group is renamed.  
...
title.  
[autoUpdateGeometry](Experimental.GraphView.Scope-autoUpdateGeometry.html)|
Enables or disables the automatic resizing and positioning of the Scope.  
[containedElements](Experimental.GraphView.Scope-containedElements.html)| The
list of GraphElements contained by the Scope.  
[containedElementsRect](Experimental.GraphView.Scope-
containedElementsRect.html)| The rect containing the GraphElements encompassed
by the Scope. The rect is expressed in local coordinates.  
[headerContainer](Experimental.GraphView.Scope-headerContainer.html)| Returns
the header container for the Scope. Use this header container to customizer
...
GraphElement.  
[AddElement](Experimental.GraphView.Scope.AddElement.html)| Adds a
GraphElement to the Scope.  
[AddElements](Experimental.GraphView.Scope.AddElements.html)| Adds
GraphElements to the Scope.  
[ContainsElement](Experimental.GraphView.Scope.ContainsElement.html)|
Determines if the Scope contains the specified GraphElement.  
[GetPosition](Experimental.GraphView.Scope.GetPosition.html)| Returns the
geometry of the Scope.  
[HitTest](Experimental.GraphView.Scope.HitTest.html)| Determines whether the
specified point is within the selectable area of the Scope.  
[Overlaps](Experimental.GraphView.Scope.Overlaps.html)| Determines whether the
specified rect overlaps the Scope.  
[RemoveElement](Experimental.GraphView.Scope.RemoveElement.html)| Removes an
element from the Scope.  
[RemoveElements](Experimental.GraphView.Scope.RemoveElements.html)| Removes
elements from the Scope.  
[RemoveElementsWithoutNotification](Experimental.GraphView.Scope.RemoveElementsWithoutNotification.html)|
Removes elements from the Scope but do not send a notification.  
[SetPosition](Experimental.GraphView.Scope.SetPosition.html)| Sets the
geometry of the Scope.  
[UpdateGeometryFromContent](Experimental.GraphView.Scope.UpdateGeometryFromContent.html)|
...
[ScheduleUpdateGeometryFromContent](Experimental.GraphView.Scope.ScheduleUpdateGeometryFromContent.html)|
Schedules the update of the size and position of the Scope based on its
contents.  
[SetScopePositionOnly](Experimental.GraphView.Scope.SetScopePositionOnly.html)|
