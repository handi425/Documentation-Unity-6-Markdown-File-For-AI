...
#  [PlayableExtensions](Playables.PlayableExtensions.html).IsDone
...
If the duration of the playable is set, when the time of the playable reaches
its duration during playback this flag will be set to true.
