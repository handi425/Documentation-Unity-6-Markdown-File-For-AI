...
#  [EditorApplication](EditorApplication.html).projectChanged
...
Actions that trigger this event include creating, renaming, or reparenting
assets, as well as moving or renaming folders in the project. Note that the
event is not raised immediately in response to these actions, but rather
...
[EditorWindow.OnProjectChange](EditorWindow.OnProjectChange.html).
