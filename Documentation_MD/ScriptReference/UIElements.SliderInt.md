...
[UXML element SliderInt](../Manual/UIE-uxml-element-sliderInt.html).

### Static Properties

[inputUssClassName](UIElements.SliderInt-inputUssClassName.html)|  USS class
name of input elements in elements of this type.  
---|---  
[labelUssClassName](UIElements.SliderInt-labelUssClassName.html)|  USS class
name of labels in elements of this type.  
[ussClassName](UIElements.SliderInt-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[pageSize](UIElements.SliderInt-pageSize.html)|  The value to add or remove to
the SliderInt.value when it is clicked.  
---|---  
