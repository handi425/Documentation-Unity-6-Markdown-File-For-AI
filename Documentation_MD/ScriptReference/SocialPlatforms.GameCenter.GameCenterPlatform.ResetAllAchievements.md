...
#
[GameCenterPlatform](SocialPlatforms.GameCenter.GameCenterPlatform.html).ResetAllAchievements
...
Only affects the currently running game. Code example:
    ...
    public class Reset : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            GameCenterPlatform.ResetAllAchievements((resetResult) => {
                [Debug.Log](Debug.Log.html)((resetResult) ? "Reset done." : "Reset failed.");
            });
        }
    }
