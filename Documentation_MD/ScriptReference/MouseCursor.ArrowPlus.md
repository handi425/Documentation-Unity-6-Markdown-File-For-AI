...
#  [MouseCursor](MouseCursor.html).ArrowPlus
...
Arrow with the plus symbol next to it.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.ArrowPlus](MouseCursor.ArrowPlus.html));
        }
    }
