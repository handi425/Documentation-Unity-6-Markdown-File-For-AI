...
#
[CrashReportingSettings](CrashReporting.CrashReportingSettings.html).logBufferSize
...
The Performance Reporting service will keep a buffer of up to the last X log
