...
#  [ParticleSystem](ParticleSystem.html).noise
...
public [ParticleSystem.NoiseModule](ParticleSystem.NoiseModule.html) noise;
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            no.enabled = true;
            no.strength = 1.0f;
            no.quality = [ParticleSystemNoiseQuality.High](ParticleSystemNoiseQuality.High.html);
        }
    }
