...
#  [MonoBehaviour](MonoBehaviour.html).OnMouseDrag()
...
OnMouseDrag is called when the user has clicked on a [Collider](Collider.html)
...
OnMouseDrag is called every frame while the mouse is down.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnMouseDrag()
        {
            rend.material.color -= [Color.white](Color-white.html) * [Time.deltaTime](Time-deltaTime.html);
        }
    }
...
OnMouseDrag can be a co-routine, simply use the yield statement in the
