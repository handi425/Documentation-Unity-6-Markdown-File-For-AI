...
public GraphicsAPIConstraintAttribute(bool negate, params GraphicsDeviceType[]
graphicsDeviceTypes);
...
Unity enables filter attributes if the current build target matches any of the
`graphicsDeviceTypes`.
