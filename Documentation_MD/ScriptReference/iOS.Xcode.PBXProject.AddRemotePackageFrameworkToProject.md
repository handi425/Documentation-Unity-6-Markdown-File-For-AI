...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageFrameworkToProject
...
public void AddRemotePackageFrameworkToProject(string targetGuid, string name,
string packageGuid, bool weak);

### Parameters

targetGuid | The GUID of the target, such asthe one returned by [TargetGuidByName](iOS.Xcode.PBXProject.TargetGuidByName.html).  
---|---  
...
Adds a remote package framework dependency for the specified target.
    ...
    public class Sample_AddRemotePackageFrameworkToProject  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            string packageGuid = pbxProject.AddRemotePackageReferenceAtVersionUpToNextMinor("https://github.com/apple/swift-system.git", "1.1.0");  
      
            // Add the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) to the Xcode project
