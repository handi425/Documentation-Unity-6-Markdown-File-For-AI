...
#
[SetPropertyBagBase<T0,T1>](Unity.Properties.SetPropertyBagBase_2.html).TryGetProperty
...
public bool TryGetProperty(ref TSet container, object key, out IProperty<TSet>
property);
