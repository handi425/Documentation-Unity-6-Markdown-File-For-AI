...
#
[TypeFlagsExtensions](Profiling.Memory.Experimental.TypeFlagsExtensions.html).IsValueType
...
**bool** Returns true if the type associated with this TypeFlags is a value
type (as opposed to a reference type).
