...
Scene dependency information generated from the
ContentBuildInterface.PrepareScene API.
...
[globalUsage](Build.Content.SceneDependencyInfo-globalUsage.html)| Lighting
information used by the Scene.  
---|---  
[includedTypes](Build.Content.SceneDependencyInfo-includedTypes.html)| Types
that are used by scene objects.  
[referencedObjects](Build.Content.SceneDependencyInfo-referencedObjects.html)|
List of objects referenced by the Scene.  
[scene](Build.Content.SceneDependencyInfo-scene.html)| Scene's original asset
path.  
