...
#  [Physics2D](Physics2D.html).GetRayIntersectionAll
...
public static RaycastHit2D[] GetRayIntersectionAll([Ray](Ray.html) ray, float
distance = Mathf.Infinity, int layerMask = DefaultRaycastLayers);
