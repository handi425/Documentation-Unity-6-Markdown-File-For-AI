...
#
[ParticleSystem.LightsModule](ParticleSystem.LightsModule.html).sizeAffectsRange
...
This is useful for shrinking light influence at the same time as particles
disappear, to avoid popping.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 40, 100, 30), "Size");  
      
            hSliderValueSize = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(95, 45, 100, 30), hSliderValueSize, 0.0f, 1.0f);
            sizeAffectsRange = [GUI.Toggle](GUI.Toggle.html)(new [Rect](Rect.html)(25, 85, 200, 30), sizeAffectsRange, "[Particle](ParticleSystem.Particle.html) Size Affects [Light](Light.html) Range");
        }
    }
