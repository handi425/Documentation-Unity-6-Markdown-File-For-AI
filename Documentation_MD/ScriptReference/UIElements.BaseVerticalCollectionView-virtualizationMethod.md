...
#
[BaseVerticalCollectionView](UIElements.BaseVerticalCollectionView.html).virtualizationMethod
...
public
[UIElements.CollectionVirtualizationMethod](UIElements.CollectionVirtualizationMethod.html)
virtualizationMethod;

### Description

The virtualization method to use for this collection when a scroll bar is
visible. Takes a value from the
