...
#  [SkinnedMeshRenderer](SkinnedMeshRenderer.html).SetBlendShapeWeight
...
index | The index of the BlendShape to modify. Index must be smaller than the [Mesh.blendShapeCount](Mesh-blendShapeCount.html) of the Mesh attached to this Renderer.  
---|---  
...
[GetBlendShapeWeight](SkinnedMeshRenderer.GetBlendShapeWeight.html).
