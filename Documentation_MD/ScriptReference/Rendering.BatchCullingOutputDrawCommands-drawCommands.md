...
#
[BatchCullingOutputDrawCommands](Rendering.BatchCullingOutputDrawCommands.html).drawCommands
...
This can contain as many commands as necessary, and each command can render
multiple instances. The culling callback must allocate the memory for this
using
