...
#  [BaseTreeView](UIElements.BaseTreeView.html).SetRootItems
...
Root items can include their children directly. This will force the use of a
DefaultTreeViewController_1.
