...
#  [PBXProject](iOS.Xcode.PBXProject.html).ReadFromStream
...
Current contents of the project are discarded.
    ...
    public class Sample_ReadFromStream  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Initialize [PBXProject](iOS.Xcode.PBXProject.html) by reading project info from stream
            ...
            // Apply changes to the pbxproj file using WriteToStream
