...
#
[ParticleSystem.MainModule](ParticleSystem.MainModule.html).startRotationYMultiplier
...
The initial rotation multiplier of particles around the y-axis when the
