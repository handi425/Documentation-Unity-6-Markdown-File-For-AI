...
[changedObject](UIElements.SerializedObjectChangeEvent-changedObject.html)|
The SerializedObject whose value changed.  
---|---  
  
### Constructors

[SerializedObjectChangeEvent](UIElements.SerializedObjectChangeEvent-
ctor.html)|  Constructor. Use GetPooled instead.  
---|---  
  
### Protected Methods

[Init](UIElements.SerializedObjectChangeEvent.Init.html)|  Sets the event to
its initial state.  
---|---  
  
### Static Methods

[GetPooled](UIElements.SerializedObjectChangeEvent.GetPooled.html)|  Gets an
