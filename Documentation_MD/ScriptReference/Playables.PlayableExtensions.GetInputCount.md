...
#  [PlayableExtensions](Playables.PlayableExtensions.html).GetInputCount
...
The input count includes slots that aren't connected to anything. This is
equivalent to, but much faster than calling GetInputs().Length.
