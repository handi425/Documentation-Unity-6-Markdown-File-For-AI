...
[linkID](UIElements.Experimental.PointerDownLinkTagEvent-linkID.html)|
LinkTag corresponding linkID.  
---|---  
[linkText](UIElements.Experimental.PointerDownLinkTagEvent-linkText.html)|
LinkTag corresponding text.  
  
### Constructors

[PointerDownLinkTagEvent](UIElements.Experimental.PointerDownLinkTagEvent-
ctor.html)|  Constructor. Avoid creating new event instances. Instead, use
GetPooled() to get an instance from a pool of reusable event instances.  
---|---  
  
### Protected Methods

[Init](UIElements.Experimental.PointerDownLinkTagEvent.Init.html)|  Resets the
event members to their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.Experimental.PointerDownLinkTagEvent.GetPooled.html)|
