...
#  [XRDisplaySubsystem](XR.XRDisplaySubsystem.html).TryGetMotionToPhoton
...
**bool** Returns true if the motion-to-photon value is available. Returns
false otherwise.
...
The motion-to-photon represents latency. This latency is the difference
between the last predicted tracking information and the moment that the scan-
line of the target frame lights up on the display. You can use this to
determine application latency.  
