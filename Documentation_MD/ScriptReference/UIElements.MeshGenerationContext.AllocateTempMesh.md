...
#
[MeshGenerationContext](UIElements.MeshGenerationContext.html).AllocateTempMesh
...
public void AllocateTempMesh(int vertexCount, int indexCount, out
NativeSlice<Vertex> vertices, out NativeSlice<ushort> indices);
...
You can only call this method during the mesh generation phase of the panel
and shouldn't use it beyond.
