...
A vertical or horizontal scrollbar. For more information, refer to [UXML
element Scroller](../Manual/UIE-uxml-element-scroller.html).

### Static Properties

[highButtonUssClassName](UIElements.Scroller-highButtonUssClassName.html)|
USS class name of high buttons in elements of this type.  
---|---  
[horizontalVariantUssClassName](UIElements.Scroller-
horizontalVariantUssClassName.html)|  USS class name of elements of this type,
when they are displayed horizontally.  
[lowButtonUssClassName](UIElements.Scroller-lowButtonUssClassName.html)|  USS
class name of low buttons in elements of this type.  
[sliderUssClassName](UIElements.Scroller-sliderUssClassName.html)|  USS class
name of slider elements in elements of this type.  
[ussClassName](UIElements.Scroller-ussClassName.html)|  USS class name of
elements of this type.  
[verticalVariantUssClassName](UIElements.Scroller-
verticalVariantUssClassName.html)|  USS class name of elements of this type,
when they are displayed vertically.  
  
### Properties

[direction](UIElements.Scroller-direction.html)|  Direction of this scrollbar.  
---|---  
[highButton](UIElements.Scroller-highButton.html)|  Top or right scroll
button.  
[highValue](UIElements.Scroller-highValue.html)|  Maximum value.  
[lowButton](UIElements.Scroller-lowButton.html)|  Bottom or left scroll
button.  
[lowValue](UIElements.Scroller-lowValue.html)|  Minimum value.  
[slider](UIElements.Scroller-slider.html)|  The slider used by this scroller.  
[value](UIElements.Scroller-value.html)|  Value that defines the slider
position. It lies between lowValue and highValue.  
  
### Constructors

[Scroller](UIElements.Scroller-ctor.html)|  Constructor.  
---|---  
  
### Public Methods

[Adjust](UIElements.Scroller.Adjust.html)|  Updates the slider element size as
a ratio of total range. A value greater than or equal to 1 will disable the
Scroller.  
---|---  
[ScrollPageDown](UIElements.Scroller.ScrollPageDown.html)|  Will change the
value according to the current slider pageSize.  
[ScrollPageUp](UIElements.Scroller.ScrollPageUp.html)|  Will change the value
according to the current slider pageSize.  
  
### Events

[valueChanged](UIElements.Scroller-valueChanged.html)|  Event sent when the
