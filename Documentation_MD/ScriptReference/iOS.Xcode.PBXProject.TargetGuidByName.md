...
#  [PBXProject](iOS.Xcode.PBXProject.html).TargetGuidByName
...
**Note** : To retrieve a GUID for a Unity generated target, use
...
[GetUnityFrameworkTargetGuid](iOS.Xcode.PBXProject.GetUnityFrameworkTargetGuid.html)
    ...
    public class Sample_TargetGuidByName  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get GUID for the UnityFramework using it's name 
