...
Styled visual element to match the IMGUI Box Style. For more information,
refer to [UXML element Box](../Manual/UIE-uxml-element-box.html).

### Static Properties

[ussClassName](UIElements.Box-ussClassName.html)|  USS class name of elements
of this type.  
---|---  
