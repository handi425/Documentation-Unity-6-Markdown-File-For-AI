...
Use this base class for a GraphView tool window that recognizes a GraphView
tool. Examples of GraphView tool windows include MiniMap and Blackboard
windows. This base class also allows for creating tool windows from the "Add
Tab" menu.

### Properties

[graphViews](Experimental.GraphView.GraphViewEditorWindow-graphViews.html)|
The enumeration of the GraphViews that belong to an editor window. In most
cases, there is only one GraphView.  
---|---  
  
### Public Methods

[GetExtraPaneTypes](Experimental.GraphView.GraphViewEditorWindow.GetExtraPaneTypes.html)|
Gets the extra panes associated with the editor window.  
---|---  
  
### Static Methods

[ShowGraphViewWindowWithTools](Experimental.GraphView.GraphViewEditorWindow.ShowGraphViewWindowWithTools.html)|
Helper method that instantiates a GraphViewWindow of a specified type, an
attached Blackboard, and an attached MiniMap.  
---|---  
