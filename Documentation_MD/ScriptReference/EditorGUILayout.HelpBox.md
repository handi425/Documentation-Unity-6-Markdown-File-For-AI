...
#  [EditorGUILayout](EditorGUILayout.html).HelpBox
...
public static void HelpBox(string message, [MessageType](MessageType.html)
type);

## Declaration

public static void HelpBox([GUIContent](GUIContent.html) content, bool wide);
