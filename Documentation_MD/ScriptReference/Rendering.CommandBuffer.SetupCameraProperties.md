...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetupCameraProperties
...
public void SetupCameraProperties([Camera](Camera.html) camera);
...
variables. This command is essentially the same to
