...
#  [GraphView](Experimental.GraphView.GraphView.html).CollectElements
...
public static void CollectElements(IEnumerable<GraphElement> elements,
HashSet<GraphElement> collectedElementSet, Func<GraphElement,bool>
conditionFunc);
