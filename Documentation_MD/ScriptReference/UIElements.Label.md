...
Provides an Element displaying text. For more information, refer to [UXML
element Label](../Manual/UIE-uxml-element-Label.html).

### Static Properties

[ussClassName](UIElements.Label-ussClassName.html)|  USS class name of
