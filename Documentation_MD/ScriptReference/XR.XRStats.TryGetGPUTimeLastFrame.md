...
#  [XRStats](XR.XRStats.html).TryGetGPUTimeLastFrame
...
On SDKs that support it, this method allows access to more accurate timing
information from the SDK itself. This information can take into account GPU
time spent in SDK-specific layers.  
