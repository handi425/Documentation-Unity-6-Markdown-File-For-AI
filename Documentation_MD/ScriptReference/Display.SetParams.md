...
#  [Display](Display.html).SetParams
...
To change the size and position of primary display you must also activate it
by calling `Display.displays[0].Activate(0, 0, 0)`.
