...
Additional resources: [CircleCollider2D](CircleCollider2D.html),
[PolygonCollider2D](PolygonCollider2D.html),
[EdgeCollider2D](EdgeCollider2D.html).

### Properties

[autoTiling](BoxCollider2D-autoTiling.html)| Determines whether the
BoxCollider2D's shape is automatically updated based on a SpriteRenderer's
tiling properties.  
---|---  
[edgeRadius](BoxCollider2D-edgeRadius.html)| Controls the radius of all edges
created by the collider.  
[size](BoxCollider2D-size.html)| The width and height of the rectangle.  
