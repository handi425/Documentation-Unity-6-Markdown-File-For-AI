...
#
[ParticleSystem.TrailModule](ParticleSystem.TrailModule.html).widthOverTrail
...
Additional resources: [MinMaxCurve](ParticleSystem.MinMaxCurve.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        private [AnimationCurve](AnimationCurve.html) curve = new [AnimationCurve](AnimationCurve.html)();
        ...
        void [Update](PlayerLoop.Update.html)()
        {
            var trails = ps.trails;
            if (widthOverTrail)
                trails.widthOverTrail = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(1.0f, curve);
            else
        ...
        void OnGUI()
        {
            widthOverTrail = [GUI.Toggle](GUI.Toggle.html)(new [Rect](Rect.html)(25, 25, 200, 30), widthOverTrail, "Width over Trail");
        }
    }
