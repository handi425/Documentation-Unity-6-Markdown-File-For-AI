...
#  [Physics](Physics.html).CheckSphere
...
public static bool CheckSphere([Vector3](Vector3.html) position, float radius,
...
`position` and `radius` in world coordinates.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void WarningNoise()
        {
            ...
            if ([Physics.CheckSphere](Physics.CheckSphere.html)(transform.position, sphereRadius))
            {
                audioSource.Play();
            }
        }
