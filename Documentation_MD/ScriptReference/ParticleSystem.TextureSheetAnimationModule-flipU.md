...
#
[ParticleSystem.TextureSheetAnimationModule](ParticleSystem.TextureSheetAnimationModule.html).flipU
...
**Obsolete** flipU property is deprecated. Use ParticleSystemRenderer.flip.x
instead. public float flipU;

### Description

Flip the U coordinate on particles, causing them to appear mirrored
horizontally.
