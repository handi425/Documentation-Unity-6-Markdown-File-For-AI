...
#  [Recorder](Profiling.Recorder.html).enabled
...
When enabled Recorder collects data regardless of Profiler being enabled or
not.  
  
**Note:**  
Set to _false_ to make measurements available immediately for synchronous
testing scenarious.
