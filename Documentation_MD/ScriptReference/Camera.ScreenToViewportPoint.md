...
#  [Camera](Camera.html).ScreenToViewportPoint
...
public [Vector3](Vector3.html) ScreenToViewportPoint([Vector3](Vector3.html)
position);
...
from the camera.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        {
            transform.position = Camera.main.ScreenToViewportPoint([Input.mousePosition](Input-mousePosition.html));
        }
    }
