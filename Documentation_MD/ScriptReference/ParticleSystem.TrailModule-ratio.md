...
#  [ParticleSystem.TrailModule](ParticleSystem.TrailModule.html).ratio
...
Use a value between 0 and 1, where 0 doesn't add trails to any particles, and
1 adds trails to every particle.
