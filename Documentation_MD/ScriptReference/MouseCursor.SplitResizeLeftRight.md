...
#  [MouseCursor](MouseCursor.html).SplitResizeLeftRight
...
Left-Right resize arrows for window splitters.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.SplitResizeLeftRight](MouseCursor.SplitResizeLeftRight.html));
        }
    }
