...
#  [Projector](Projector.html).fieldOfView
...
[aspectRatio](Projector-aspectRatio.html). Field of view is ignored when
projector is orthographic (see [orthographic](Projector-orthographic.html)).
