...
#  [PBXProject](iOS.Xcode.PBXProject.html).RemoveFrameworkFromProject
...
`System/Library/Frameworks` folder in the SDK source tree.
    ...
    public class Sample_RemoveFrameworkFromProject  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Remove a framework from UnityFramework target
            pbxProject.RemoveFrameworkFromProject(unityFrameworkTargetGuid, "CoreMedia.framework");  
