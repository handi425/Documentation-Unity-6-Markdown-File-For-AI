...
#  [HDROutputSettings](HDROutputSettings.html).graphicsFormat
...
The [GraphicsFormat](Experimental.Rendering.GraphicsFormat.html) of the
...
for the display to check that HDR is available. Additional resources:
