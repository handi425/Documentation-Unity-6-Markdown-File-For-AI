...
[linkID](UIElements.Experimental.PointerOverLinkTagEvent-linkID.html)|
LinkTag corresponding linkID.  
---|---  
[linkText](UIElements.Experimental.PointerOverLinkTagEvent-linkText.html)|
LinkTag corresponding text.  
  
### Constructors

[PointerOverLinkTagEvent](UIElements.Experimental.PointerOverLinkTagEvent-
ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.Experimental.PointerOverLinkTagEvent.Init.html)|  Resets the
event members to their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.Experimental.PointerOverLinkTagEvent.GetPooled.html)|
