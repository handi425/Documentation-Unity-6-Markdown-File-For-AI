...
#  [Tile](WSA.Tile.html).DeleteSecondary
...
public static void DeleteSecondary(string tileId, [Vector2](Vector2.html)
pos);

## Declaration

public static void DeleteSecondary(string tileId, [Rect](Rect.html) area);
