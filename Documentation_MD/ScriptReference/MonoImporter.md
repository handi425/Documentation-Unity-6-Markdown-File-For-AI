...
[GetDefaultReference](MonoImporter.GetDefaultReference.html)| Gets the default
value for a reference field in the imported MonoScript.  
---|---  
[GetIcon](MonoImporter.GetIcon.html)| Gets the icon to associate with the
imported MonoScript.  
[GetScript](MonoImporter.GetScript.html)| Gets the imported MonoScript. If the
imported C# file contains multiple classes, the first is returned.  
[SetDefaultReferences](MonoImporter.SetDefaultReferences.html)| Sets default
references for this MonoScript.  
[SetIcon](MonoImporter.SetIcon.html)| Sets a custom icon to associate with the
imported MonoScript.  
  
### Static Methods

[GetAllRuntimeMonoScripts](MonoImporter.GetAllRuntimeMonoScripts.html)| Gets
an array of scripts that will be available at runtime.  
---|---  
[GetExecutionOrder](MonoImporter.GetExecutionOrder.html)| Gets the execution
order for a MonoScript.  
[SetExecutionOrder](MonoImporter.SetExecutionOrder.html)| Sets the execution
order for a MonoScript. This method forces Unity to reimport the MonoImporter
