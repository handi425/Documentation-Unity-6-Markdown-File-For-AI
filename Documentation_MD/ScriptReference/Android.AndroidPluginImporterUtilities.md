...
[GetAndroidCPU](Android.AndroidPluginImporterUtilities.GetAndroidCPU.html)|
Gets the Android CPU architecture that the plugin supports.  
---|---  
[GetAndroidSharedLibraryType](Android.AndroidPluginImporterUtilities.GetAndroidSharedLibraryType.html)|
Gets the type of content that the shared library contains.  
[SetAndroidCPU](Android.AndroidPluginImporterUtilities.SetAndroidCPU.html)|
Sets the Android CPU architecture that the plugin supports.  
[SetAndroidSharedLibraryType](Android.AndroidPluginImporterUtilities.SetAndroidSharedLibraryType.html)|
