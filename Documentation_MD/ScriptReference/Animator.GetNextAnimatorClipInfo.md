...
#  [Animator](Animator.html).GetNextAnimatorClipInfo
...
[AnimatorClipInfo](AnimatorClipInfo.html) in the next state.

### Description

Returns an array of all the [AnimatorClipInfo](AnimatorClipInfo.html) in the
next state of the given layer.

* * *

## Declaration

public void GetNextAnimatorClipInfo(int layerIndex, List<AnimatorClipInfo>
clips);
...
[AnimatorClipInfo](AnimatorClipInfo.html) in the next state of the given
layer.
