...
#  [TextureImporterSettings](TextureImporterSettings.html).rgbm
...
**Obsolete** RGBM is no longer a user's choice but has become an
implementation detail hidden to the user. public
[TextureImporterRGBMMode](TextureImporterRGBMMode.html) rgbm;
...
Additional resources: [TextureImporterRGBMMode](TextureImporterRGBMMode.html).
