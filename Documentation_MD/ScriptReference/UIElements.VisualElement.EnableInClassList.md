...
#  [VisualElement](UIElements.VisualElement.html).EnableInClassList
...
If enable is true, EnableInClassList adds the class name to the class list. If
enable is false, EnableInClassList removes the class name from the class list.
