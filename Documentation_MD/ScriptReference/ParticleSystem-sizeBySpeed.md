...
#  [ParticleSystem](ParticleSystem.html).sizeBySpeed
...
public
[ParticleSystem.SizeBySpeedModule](ParticleSystem.SizeBySpeedModule.html)
sizeBySpeed;
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            ss.enabled = true;
            ss.range = new [Vector2](Vector2.html)(0.0f, 2.0f);  
      
            [AnimationCurve](AnimationCurve.html) curve = new [AnimationCurve](AnimationCurve.html)();
            curve.AddKey(0.0f, 0.1f);
            curve.AddKey(0.75f, 1.0f);
            ss.size = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(10.0f, curve);
        }
    }
