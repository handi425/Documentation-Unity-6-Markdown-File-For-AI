...
#  [ReflectionProbe](ReflectionProbe.html).backgroundColor
...
Only used if [clearFlags](ReflectionProbe-clearFlags.html) are set to
...
set up). Additional resources: [Camera.clearFlags](Camera-clearFlags.html).
