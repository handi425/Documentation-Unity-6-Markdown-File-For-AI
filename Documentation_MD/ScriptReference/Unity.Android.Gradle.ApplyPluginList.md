...
plugins](https://docs.gradle.org/current/userguide/plugins.html#sec:old_plugin_applicationy)

### Constructors

[ApplyPluginList](Unity.Android.Gradle.ApplyPluginList-ctor.html)| Element
constructor.  
---|---  
  
### Public Methods

[AddPluginByName](Unity.Android.Gradle.ApplyPluginList.AddPluginByName.html)|
Adds an apply plugin: '{name}' element to the block.  
---|---  
[AddPluginRaw](Unity.Android.Gradle.ApplyPluginList.AddPluginRaw.html)| Adds
an apply plugin: {value} element to the block.  
