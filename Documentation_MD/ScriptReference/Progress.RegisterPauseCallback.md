...
#  [Progress](Progress.html).RegisterPauseCallback
...
Registers a callback that is called when the user requests to pause or resume
a running progress indicator's task.

Additional resources: [Progress.Pause](Progress.Pause.html),
