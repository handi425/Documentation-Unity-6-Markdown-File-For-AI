...
#
[RadeonRaysProbeIntegrator](LightTransport.RadeonRaysProbeIntegrator.html).Prepare
...
The preparation can take a significant time if the world is large or OpenCL
kernels haven't been written to cache yet.
