...
[ToolName](Experimental.GraphView.GraphViewBlackboardWindow.ToolName.html)|
The tool window name.  
---|---  
  
### Constructors

[GraphViewBlackboardWindow](Experimental.GraphView.GraphViewBlackboardWindow-
ctor.html)| Constructor.  
---|---  
  
### Protected Methods

[IsGraphViewSupported](Experimental.GraphView.GraphViewBlackboardWindow.IsGraphViewSupported.html)|
Verifies whether the GraphView tool window supports a specific GraphView.  
---|---  
[OnGraphViewChanged](Experimental.GraphView.GraphViewBlackboardWindow.OnGraphViewChanged.html)|
Callback invoked when the GraphView has changed.  
[OnGraphViewChanging](Experimental.GraphView.GraphViewBlackboardWindow.OnGraphViewChanging.html)|
