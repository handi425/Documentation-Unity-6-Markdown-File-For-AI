...
#  [PlistElementDict](iOS.Xcode.PlistElementDict.html).CreateDict
...
public [iOS.Xcode.PlistElementDict](iOS.Xcode.PlistElementDict.html)
CreateDict(string key);
...
Convenience method to set a property to a new dictionary element.
    ...
    public class PlistCreateDictExample
    {
        [PostProcessBuild]
        public static void CreateDictExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
