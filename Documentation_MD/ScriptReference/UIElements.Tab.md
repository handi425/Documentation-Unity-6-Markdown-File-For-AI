...
A Tab has a header that can respond to pointer and mouse events. The header
can hold an icon, a label, or both. The Tab content container can hold
anything inside of it giving more flexibility to customize its layout.  
  
For more information, refer to [UXML element Tab](../Manual/UIE-uxml-element-
tab.html).

### Static Properties

[closeableUssClassName](UIElements.Tab-closeableUssClassName.html)|  The USS
class name for a closeable tab.  
---|---  
[closeButtonUssClassName](UIElements.Tab-closeButtonUssClassName.html)|  The
USS class name for close button in closable tabs.  
[contentUssClassName](UIElements.Tab-contentUssClassName.html)|  USS class
name of container element of this type.  
[draggingUssClassName](UIElements.Tab-draggingUssClassName.html)|  USS class
name for the dragging state of this type.  
[reorderableItemHandleBarUssClassName](UIElements.Tab-
reorderableItemHandleBarUssClassName.html)|  USS class name for drag handlebar
in reorderable tabs.  
[reorderableItemHandleUssClassName](UIElements.Tab-
reorderableItemHandleUssClassName.html)|  USS class name for drag handle in
reorderable tabs.  
[reorderableUssClassName](UIElements.Tab-reorderableUssClassName.html)|  USS
class name for reorderable tab elements.  
[tabHeaderEmptyImageUssClassName](UIElements.Tab-
tabHeaderEmptyImageUssClassName.html)|  USS class name for the icon inside the
header when the value is null.  
[tabHeaderEmptyLabeUssClassName](UIElements.Tab-
tabHeaderEmptyLabeUssClassName.html)|  USS class name for the label of the
header when the value is empty or null.  
[tabHeaderImageUssClassName](UIElements.Tab-tabHeaderImageUssClassName.html)|
USS class name for the icon inside the header.  
[tabHeaderLabelUssClassName](UIElements.Tab-tabHeaderLabelUssClassName.html)|
USS class name for the label of the header.  
[tabHeaderStandaloneImageUssClassName](UIElements.Tab-
tabHeaderStandaloneImageUssClassName.html)|  USS class name for the icon
inside the header when the label is empty or null.  
[tabHeaderUnderlineUssClassName](UIElements.Tab-
tabHeaderUnderlineUssClassName.html)|  USS class name for the active state
underline of the header.  
[tabHeaderUssClassName](UIElements.Tab-tabHeaderUssClassName.html)|  USS class
name for the header of this type.  
[ussClassName](UIElements.Tab-ussClassName.html)|  USS class name of elements
of this type.  
  
### Properties

[closeable](UIElements.Tab-closeable.html)|  A property that adds the ability
to close tabs.  
---|---  
[contentContainer](UIElements.Tab-contentContainer.html)|  The container for
the content of the Tab.  
[iconImage](UIElements.Tab-iconImage.html)|  Sets the icon for the Tab's
header.  
[label](UIElements.Tab-label.html)|  Sets the label of the Tab's header.  
[tabHeader](UIElements.Tab-tabHeader.html)|  Returns the Tab's header.  
  
### Constructors

[Tab](UIElements.Tab-ctor.html)|  Constructs a Tab.  
---|---  
  
### Events

[closed](UIElements.Tab-closed.html)|  This event is called when a tab has
been closed.  
---|---  
[closing](UIElements.Tab-closing.html)|  This event is called before a tab is
closed. Return true if the tab can be closed.  
[selected](UIElements.Tab-selected.html)|  This event is called when a tab has
been selected.  
