...
position = Vector3.zero, [Quaternion](Quaternion.html) rotation =
Quaternion.identity, [Vector3](Vector3.html) scale = Vector3.one);

## Declaration

public static void DrawMesh([Mesh](Mesh.html) mesh, int submeshIndex,
...
Additional resources: [DrawWireMesh](Gizmos.DrawWireMesh.html).
