...
A control that allows single selection out of a logical group of
[RadioButton](UIElements.RadioButton.html) elements. Selecting one will
deselect the others. For more information, refer to [UXML element
RadioButtonGroup](../Manual/UIE-uxml-element-RadioButtonGroup.html).

### Static Properties

[containerUssClassName](UIElements.RadioButtonGroup-
containerUssClassName.html)|  USS class name of container element of this
type.  
---|---  
[ussClassName](UIElements.RadioButtonGroup-ussClassName.html)|  USS class name
for RadioButtonGroup elements.  
  
### Properties

[choices](UIElements.RadioButtonGroup-choices.html)|  The list of available
choices in the group.  
---|---  
  
### Constructors

[RadioButtonGroup](UIElements.RadioButtonGroup-ctor.html)|  Initializes and
returns an instance of RadioButtonGroup.  
---|---  
