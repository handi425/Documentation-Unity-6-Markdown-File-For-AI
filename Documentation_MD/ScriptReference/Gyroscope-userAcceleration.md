...
#  [Gyroscope](Gyroscope.html).userAcceleration
...
public [Vector3](Vector3.html) userAcceleration;

### Description

Returns the acceleration that the user is giving to the device.

The significance of this value is that the effect of gravity (which is also
detected by the accelerometer) has been removed to leave just the acceleration
