...
#  [SceneVisibilityManager](SceneVisibilityManager.html).EnablePicking
...
public void EnablePicking([GameObject](GameObject.html) gameObject, bool
includeDescendants);
...
Enables picking on a GameObject, or an array of GameObjects, and its
descendants.
...
public void EnablePicking([SceneManagement.Scene](SceneManagement.Scene.html)
scene);
