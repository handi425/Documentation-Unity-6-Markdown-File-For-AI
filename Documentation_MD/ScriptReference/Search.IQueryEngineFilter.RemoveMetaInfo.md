...
#  [IQueryEngineFilter](Search.IQueryEngineFilter.html).RemoveMetaInfo
...
You can use this function to remove additional information that is no longer
needed.
