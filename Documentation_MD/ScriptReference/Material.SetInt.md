...
This method is deprecated. Use [SetFloat](Material.SetFloat.html) or
[SetInteger](Material.SetInteger.html) instead.
...
Script](../Manual/MaterialsAccessingViaScript.html). This function is just an
alias to [SetFloat](Material.SetFloat.html) that casts the passed value to a
float.
