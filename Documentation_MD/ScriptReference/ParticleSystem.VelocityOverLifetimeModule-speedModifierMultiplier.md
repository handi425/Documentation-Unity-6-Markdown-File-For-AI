...
#
[ParticleSystem.VelocityOverLifetimeModule](ParticleSystem.VelocityOverLifetimeModule.html).speedModifierMultiplier
...
A multiplier for
[ParticleSystem.VelocityOverLifetimeModule.speedModifier](ParticleSystem.VelocityOverLifetimeModule-
speedModifier.html).
...
you only want to change the overall speed multiplier.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 40, 100, 30), "Speed");  
      
            hSliderValueSpeed = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(55, 45, 100, 30), hSliderValueSpeed, -50.0f, 50.0f);
        }
    }
