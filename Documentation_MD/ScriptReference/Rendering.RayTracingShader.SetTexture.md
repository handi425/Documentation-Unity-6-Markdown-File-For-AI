...
#  [RayTracingShader](Rendering.RayTracingShader.html).SetTexture
...
public void SetTexture(string name, [Texture](Texture.html) texture);

## Declaration

public void SetTexture(int nameID, [Texture](Texture.html) texture);
...
[Shader.SetGlobalTexture](Shader.SetGlobalTexture.html) method instead.
