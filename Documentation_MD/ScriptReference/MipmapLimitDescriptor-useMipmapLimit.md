...
#  [MipmapLimitDescriptor](MipmapLimitDescriptor.html).useMipmapLimit
...
If you set this to `true`, the texture uses one of the following:
  ...
  * The mipmap limit of [MipmapLimitDescriptor.groupName](MipmapLimitDescriptor-groupName.html).
