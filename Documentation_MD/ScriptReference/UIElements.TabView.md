...
Creates a tab view that groups a one or more [Tab](UIElements.Tab.html)
elements.

A tab view provides additional functionality to the Tab. It allows a group of
tabs to interact between each other by hiding the inactive tabs and displaying
the active one. Additionally, it adds the ability to re-order the group of
tabs.  
  
For reorderable tabs, it is important to keep the view-data-key unique for the
TabView and Tab elements inside of it. The view-data-key helps store the state
of the tabs such as the order and state. By having an empty view-data-key,
which is the default value, the state of the tabs will not persist when
reloading the document.  
  
For more information, refer to [UXML element TabView](../Manual/UIE-uxml-
element-TabView.html).

### Static Properties

[contentContainerUssClassName](UIElements.TabView-
contentContainerUssClassName.html)|  USS class name for the content container
of this type.  
---|---  
[headerContainerClassName](UIElements.TabView-headerContainerClassName.html)|
USS class name for the header container of this type.  
[reorderableUssClassName](UIElements.TabView-reorderableUssClassName.html)|
The USS class name for reorderable tab view.  
[ussClassName](UIElements.TabView-ussClassName.html)|  USS class name of
elements of this type.  
[verticalUssClassName](UIElements.TabView-verticalUssClassName.html)|  The USS
class name for vertical tab view.  
  
### Properties

[activeTab](UIElements.TabView-activeTab.html)|  Property that holds the
current active tab.  
---|---  
[contentContainer](UIElements.TabView-contentContainer.html)|  The container
for the content of the TabView.  
[reorderable](UIElements.TabView-reorderable.html)|  A property that adds
dragging support to tabs.  
[selectedTabIndex](UIElements.TabView-selectedTabIndex.html)|  A property that
returns the index of current active tab inside a list of available tabs.  
  
### Constructors

[TabView](UIElements.TabView-ctor.html)|  Constructs a TabView.  
---|---  
  
### Events

[activeTabChanged](UIElements.TabView-activeTabChanged.html)|  Called when the
active tab is reassigned.  
---|---  
