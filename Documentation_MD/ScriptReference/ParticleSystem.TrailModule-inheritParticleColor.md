...
#
[ParticleSystem.TrailModule](ParticleSystem.TrailModule.html).inheritParticleColor
...
When enabled, this applies any Trail module color overrides on top of the
particle color.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            inheritParticleColor = [GUI.Toggle](GUI.Toggle.html)(new [Rect](Rect.html)(25, 25, 200, 30), inheritParticleColor, "Inherit [Particle](ParticleSystem.Particle.html) [Color](Color.html)");
        }
    }
