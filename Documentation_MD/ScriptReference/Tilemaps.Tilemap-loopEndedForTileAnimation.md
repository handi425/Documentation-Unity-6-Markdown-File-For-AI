...
#  [Tilemap](Tilemaps.Tilemap.html).loopEndedForTileAnimation
...
This returns the list of positions on the Tilemap which have ended their loop
for their Tile Animation.
