...
#  [NavMeshObstacle](AI.NavMeshObstacle.html).size
...
The size will be scaled by the transform's scale.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            [NavMeshObstacle](AI.NavMeshObstacle.html) obstacle = GetComponent<[NavMeshObstacle](AI.NavMeshObstacle.html)>();
            [Mesh](Mesh.html) mesh = GetComponent<[MeshFilter](MeshFilter.html)>().mesh;
            obstacle.shape = [NavMeshObstacleShape.Box](AI.NavMeshObstacleShape.Box.html);
