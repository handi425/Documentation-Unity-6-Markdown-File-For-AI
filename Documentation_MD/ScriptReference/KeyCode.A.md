    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void [Update](PlayerLoop.Update.html)()
        {
            ...
            if ([Input.GetKeyDown](Input.GetKeyDown.html)([KeyCode.A](KeyCode.A.html)))
                [Debug.Log](Debug.Log.html)("A key was pressed.");  
      
            //Detect when the A arrow key has been released
            if ([Input.GetKeyUp](Input.GetKeyUp.html)([KeyCode.A](KeyCode.A.html)))
                [Debug.Log](Debug.Log.html)("A key was released.");
        }
    }
