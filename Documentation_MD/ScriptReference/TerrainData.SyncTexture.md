...
#  [TerrainData](TerrainData.html).SyncTexture
...
and [DirtyTextureRegion](TerrainData.DirtyTextureRegion.html), which makes CPU
data of the Terrain textures up to date.
