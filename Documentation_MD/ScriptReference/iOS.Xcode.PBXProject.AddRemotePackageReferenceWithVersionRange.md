...
#
[PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageReferenceWithVersionRange
...
public string AddRemotePackageReferenceWithVersionRange(string url, string
minVersion, string maxVersion);
...
range.
    ...
    public class Sample_AddRemotePackageReferenceWithVersionRange  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) using the URL, minimum and maximum allowed versions
            string packageGuid = pbxProject.AddRemotePackageReferenceWithVersionRange("https://github.com/apple/swift-system.git", "1.2.0", "1.3.0");  
