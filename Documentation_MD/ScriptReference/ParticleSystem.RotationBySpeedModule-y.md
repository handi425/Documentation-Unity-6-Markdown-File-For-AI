...
#
[ParticleSystem.RotationBySpeedModule](ParticleSystem.RotationBySpeedModule.html).y
...
Additional resources: [MinMaxCurve](ParticleSystem.MinMaxCurve.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationBySpeed.y = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(1.0f, curve);
