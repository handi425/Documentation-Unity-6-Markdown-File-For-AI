...
[CreateSearchTree](Experimental.GraphView.ISearchWindowProvider.CreateSearchTree.html)|
Generates data to populate the search window.  
---|---  
[OnSelectEntry](Experimental.GraphView.ISearchWindowProvider.OnSelectEntry.html)|
