...
[DragExitedEvent](UIElements.DragExitedEvent-ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.DragExitedEvent.Init.html)|  Resets the event members to
their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.DragExitedEvent.GetPooled.html)|  Gets an event from
