...
#  [ArticulationBody](ArticulationBody.html).solverVelocityIterations
...
velocity after an articulation body bounce. You can try to increase this value
if you are experiencing issues with jointed articulation bodies moving too
much after collisions. Overrides
[Physics.defaultSolverVelocityIterations](Physics-
defaultSolverVelocityIterations.html). Must be positive.  
  
Additional resources: [ArticulationBody.solverIterations](ArticulationBody-
