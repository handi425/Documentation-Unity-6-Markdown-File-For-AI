...
#  [QualitySettings](QualitySettings.html).IsPlatformIncluded
...
[Editor Only] Returns if the given platform is included by the Quality Level.
        ...
        public bool IsPlatformIcluded([BuildTarget](BuildTarget.html) platform, int index)
        {
            ...
            return [QualitySettings.IsPlatformIncluded](QualitySettings.IsPlatformIncluded.html)(namedBuildTarget.TargetName, index);
        }
