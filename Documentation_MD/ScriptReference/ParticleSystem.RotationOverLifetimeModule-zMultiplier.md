...
#
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html).zMultiplier
...
you only want to change the overall rotation multiplier.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationOverLifetime.zMultiplier = ([Mathf.PI](Mathf.PI.html) * 2.0f);  
