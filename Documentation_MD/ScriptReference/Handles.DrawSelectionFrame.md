...
#  [Handles](Handles.html).DrawSelectionFrame
...
public static void DrawSelectionFrame(int controlID, [Vector3](Vector3.html)
...
eventType | The type of event for the handle to act on. You can only use this function with [EventType.Repaint](EventType.Repaint.html).  
