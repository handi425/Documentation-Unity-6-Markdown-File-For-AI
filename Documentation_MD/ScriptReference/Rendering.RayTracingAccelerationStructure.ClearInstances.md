...
#
[RayTracingAccelerationStructure](Rendering.RayTracingAccelerationStructure.html).ClearInstances
...
Note that in order to reflect this action on the GPU, building the
acceleration structure has to be triggered by calling
