...
[Camera](MotionVectorGenerationMode.Camera.html)| Use only camera movement to
track motion.  
---|---  
[Object](MotionVectorGenerationMode.Object.html)| Use a specific pass (if
required) to track motion.  
[ForceNoMotion](MotionVectorGenerationMode.ForceNoMotion.html)| Do not track
motion. Motion vectors will be 0.  
