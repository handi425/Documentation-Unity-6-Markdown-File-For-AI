...
[alignment](Experimental.GraphView.IconBadge-alignment.html)| Relative
alignment between the badge and its target. The alignment will influence icon
and tip position.  
---|---  
[badgeText](Experimental.GraphView.IconBadge-badgeText.html)| Text displayed
next to the badge on mouse hover.  
[distance](Experimental.GraphView.IconBadge-distance.html)| Distance between
the badge and its target element.  
[target](Experimental.GraphView.IconBadge-target.html)| Target element to
which this badge is attached.  
[visualStyle](Experimental.GraphView.IconBadge-visualStyle.html)| The visual
style for the badge. Built-in values are "error" and "comment".  
  
### Constructors

[IconBadge](Experimental.GraphView.IconBadge-ctor.html)| Creates a basic
comment badge.  
---|---  
  
### Public Methods

[AttachTo](Experimental.GraphView.IconBadge.AttachTo.html)| Attaches this
badge to another element.  
---|---  
[Detach](Experimental.GraphView.IconBadge.Detach.html)| Detaches this badge
from its target.  
  
### Static Methods

[CreateComment](Experimental.GraphView.IconBadge.CreateComment.html)| Creates
an IconBadge with the "comment" visual style.  
---|---  
[CreateError](Experimental.GraphView.IconBadge.CreateError.html)| Creates an
IconBadge with the "error" visual style.  
