...
#  [RectUtils](Experimental.GraphView.RectUtils.html).Inflate
...
public static [Rect](Rect.html) Inflate([Rect](Rect.html) a, float left, float
...
Creates and returns an enlarged copy of the specified rectangle. The copy is
enlarged by the specified amounts.
