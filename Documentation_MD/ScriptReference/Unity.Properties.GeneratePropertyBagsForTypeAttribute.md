...
If you need to generate property bags for types implementing a specific
interface use
...
[Type](Unity.Properties.GeneratePropertyBagsForTypeAttribute.Type.html)|  The
type to generate a property bag for.  
---|---  
  
### Constructors

[GeneratePropertyBagsForTypeAttribute](Unity.Properties.GeneratePropertyBagsForTypeAttribute-
ctor.html)|  Initializes a new instance of the
GeneratePropertyBagsForTypeAttribute attribute.  
---|---  
