...
#  [TreeView](IMGUI.Controls.TreeView.html).SetupDepthsFromParentsAndChildren
...
SetupDepthsFromParentsAndChildren([IMGUI.Controls.TreeViewItem](IMGUI.Controls.TreeViewItem.html)
root);
...
This method can be used to intitialize the TreeViewItems depth values after
setting up the children properties of the TreeViewItems.  
