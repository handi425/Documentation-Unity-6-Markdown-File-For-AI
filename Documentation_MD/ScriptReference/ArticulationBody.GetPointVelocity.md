...
#  [ArticulationBody](ArticulationBody.html).GetPointVelocity
...
public [Vector3](Vector3.html) GetPointVelocity([Vector3](Vector3.html)
worldPoint);

### Description

Gets the velocity of the articulation body at the specified `worldPoint` in
global space.

GetPointVelocity takes the angularVelocity of the articulation body into
