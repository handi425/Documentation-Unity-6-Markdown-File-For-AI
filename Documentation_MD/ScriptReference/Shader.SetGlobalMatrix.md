...
#  [Shader](Shader.html).SetGlobalMatrix
...
public static void SetGlobalMatrix(string name, [Matrix4x4](Matrix4x4.html)
value);

## Declaration

public static void SetGlobalMatrix(int nameID, [Matrix4x4](Matrix4x4.html)
value);
