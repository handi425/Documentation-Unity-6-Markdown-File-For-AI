...
#  [QualitySettings](QualitySettings.html).GetTextureMipmapLimitSettings
...
public static [TextureMipmapLimitSettings](TextureMipmapLimitSettings.html)
GetTextureMipmapLimitSettings(string groupName);
...
**TextureMipmapLimitSettings** Structure containing the settings for the
indicated `groupName`.
