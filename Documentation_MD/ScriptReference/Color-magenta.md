...
public static [Color](Color.html) magenta;
...
Magenta. RGBA is (1, 0, 1, 1).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        //Run your mouse over the [GameObject](GameObject.html) to change the [Renderer](Renderer.html)'s material color to magenta
        void OnMouseOver()
        {
            m_Renderer.material.color = [Color.magenta](Color-magenta.html);
        }  
