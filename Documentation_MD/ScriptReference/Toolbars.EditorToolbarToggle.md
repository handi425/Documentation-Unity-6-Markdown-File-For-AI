...
Inherits from:[UIElements.ToolbarToggle](UIElements.ToolbarToggle.html)
...
[ussClassName](Toolbars.EditorToolbarToggle-ussClassName.html)| USS Class Name
used to style the EditorToolbarToggle.  
---|---  
  
### Properties

[icon](Toolbars.EditorToolbarToggle-icon.html)| The icon associated with the
toggle.  
---|---  
[offIcon](Toolbars.EditorToolbarToggle-offIcon.html)| The icon associated with
the toggle when the value is false.  
[onIcon](Toolbars.EditorToolbarToggle-onIcon.html)| The icon associated with
the toggle when the value is true.  
[text](Toolbars.EditorToolbarToggle-text.html)| The text associated with the
toggle.  
[textIcon](Toolbars.EditorToolbarToggle-textIcon.html)| The text icon
associated with the toggle.  
  
### Constructors

[EditorToolbarToggle](Toolbars.EditorToolbarToggle-ctor.html)| Constructor.  
---|---  
  
### Public Methods

[SetValueWithoutNotify](Toolbars.EditorToolbarToggle.SetValueWithoutNotify.html)|
...
[checkmarkUssClassName](UIElements.Toggle-checkmarkUssClassName.html)|  USS
class name of Images in Toggle elements.  
[inputUssClassName](UIElements.Toggle-inputUssClassName.html)|  USS class name
of input elements in Toggle elements.  
[labelUssClassName](UIElements.Toggle-labelUssClassName.html)|  USS class name
for Labels in Toggle elements.  
[mixedValuesUssClassName](UIElements.Toggle-mixedValuesUssClassName.html)|
USS class name of Toggle elements that have mixed values  
[noTextVariantUssClassName](UIElements.Toggle-noTextVariantUssClassName.html)|
USS class name of Toggle elements that have no text.  
[textUssClassName](UIElements.Toggle-textUssClassName.html)|  USS class name
of Text elements in Toggle elements.  
[ussClassName](UIElements.Toggle-ussClassName.html)|  USS class name for
Toggle elements.  
[ussClassName](UIElements.ToolbarToggle-ussClassName.html)|  USS class name of
