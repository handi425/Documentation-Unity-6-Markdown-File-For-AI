...
Renders SpriteShapes defined through the
SpriteShapeUtility.GenerateSpriteShape API.

### Properties

[color](U2D.SpriteShapeRenderer-color.html)| Rendering color for the
SpriteShape.  
---|---  
[maskInteraction](U2D.SpriteShapeRenderer-maskInteraction.html)| Specifies how
the SpriteShape interacts with the masks.  
  
### Public Methods

[GetBounds](U2D.SpriteShapeRenderer.GetBounds.html)| Get Bounds data as
NativeArray. The array count of this NativeArray will always be 1.  
---|---  
[GetChannels](U2D.SpriteShapeRenderer.GetChannels.html)| Get/Set an array of
mesh data of SpriteShapeRenderer.  
[GetSegments](U2D.SpriteShapeRenderer.GetSegments.html)| Get/Set an array of
segments of SpriteShapeRenderer.  
[GetSplineMeshCount](U2D.SpriteShapeRenderer.GetSplineMeshCount.html)| Gets
the number of submeshes.  
[Prepare](U2D.SpriteShapeRenderer.Prepare.html)| Prepare and generate the
SpriteShape geometry that will be fed to SpriteShape generator for rendering.  
[SetLocalAABB](U2D.SpriteShapeRenderer.SetLocalAABB.html)| Provides methods
for setting the bounding volume of the Sprite Shape geometry.  
