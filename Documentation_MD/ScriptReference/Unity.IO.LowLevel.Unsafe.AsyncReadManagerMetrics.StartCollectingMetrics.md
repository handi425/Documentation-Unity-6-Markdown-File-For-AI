...
#
[AsyncReadManagerMetrics](Unity.IO.LowLevel.Unsafe.AsyncReadManagerMetrics.html).StartCollectingMetrics
...
the command-line argument "-enable-file-read-metrics". Additional resources::
