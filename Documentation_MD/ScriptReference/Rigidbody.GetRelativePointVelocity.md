...
#  [Rigidbody](Rigidbody.html).GetRelativePointVelocity
...
account when calculating the velocity.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        // This method assumes that the wheel is a child of the [Rigidbody](Rigidbody.html), or that the wheel translates relative to the [Rigidbody](Rigidbody.html). 
