...
#  [SceneView](SceneView.html).LookAtDirect
...
public void LookAtDirect([Vector3](Vector3.html) point,
...
[LookAt](SceneView.LookAt.html) without animating the scene movement.
