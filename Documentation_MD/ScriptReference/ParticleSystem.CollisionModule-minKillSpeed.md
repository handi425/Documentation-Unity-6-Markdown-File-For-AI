...
#
[ParticleSystem.CollisionModule](ParticleSystem.CollisionModule.html).minKillSpeed
...
collision.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            hSliderValue = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(25, 40, 100, 30), hSliderValue, 0.0F, 10.0F);
        }
    }
