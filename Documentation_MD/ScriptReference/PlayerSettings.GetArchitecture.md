...
#  [PlayerSettings](PlayerSettings.html).GetArchitecture
...
public static int
GetArchitecture([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget);
...
**int** An integer value associated with the architecture of the build target.
...
public static int GetArchitecture([BuildTargetGroup](BuildTargetGroup.html)
targetGroup);
