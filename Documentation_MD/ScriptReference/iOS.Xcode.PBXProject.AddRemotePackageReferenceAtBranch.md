...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageReferenceAtBranch
...
Adds a reference to the remote package at the given branch.
    ...
    public class Sample_AddRemotePackageReferenceAtBranch  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) using the URL and branch
            string packageGuid = pbxProject.AddRemotePackageReferenceAtBranch("https://github.com/apple/swift-system.git", "main");  
