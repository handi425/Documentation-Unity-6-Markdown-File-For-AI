...
public
EditorToolbarButton([Unity.Android.Gradle.Manifest.Action](Unity.Android.Gradle.Manifest.Action.html)
clickEvent);

## Declaration

public EditorToolbarButton(string text,
[Unity.Android.Gradle.Manifest.Action](Unity.Android.Gradle.Manifest.Action.html)
clickEvent);

## Declaration

public EditorToolbarButton([Texture2D](Texture2D.html) icon,
[Unity.Android.Gradle.Manifest.Action](Unity.Android.Gradle.Manifest.Action.html)
clickEvent);

## Declaration

public EditorToolbarButton(string text, [Texture2D](Texture2D.html) icon,
[Unity.Android.Gradle.Manifest.Action](Unity.Android.Gradle.Manifest.Action.html)
clickEvent);
