...
#
[HierarchyViewModel](Unity.Hierarchy.HierarchyViewModel.html).UpdateIncrementalTimed
...
**bool** `true` if additional invocations are needed to complete the update,
`false` otherwise.
