...
#  [AudioLowPassFilter](AudioLowPassFilter.html).cutoffFrequency
...
Note that setting this value will reset any custom cutoff curve set for this
AudioLowPassFilter.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        {
            GetComponent<[AudioLowPassFilter](AudioLowPassFilter.html)>().cutoffFrequency = ([Mathf.Sin](Mathf.Sin.html)([Time.time](Time-time.html)) * 11010 + 11000);
        }
    }
