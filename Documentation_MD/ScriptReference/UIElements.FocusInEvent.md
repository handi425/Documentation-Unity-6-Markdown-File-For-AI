...
Event sent immediately before an element gains focus. This event trickles down
and bubbles up.

### Constructors

[FocusInEvent](UIElements.FocusInEvent-ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.FocusInEvent.Init.html)|  Resets the event members to their
initial values.  
---|---  
