...
#
[AnimationLayerMixerPlayable](Animations.AnimationLayerMixerPlayable.html).SetLayerAdditive
...
By default, layers are not additive and override the animation from previous
layers.
