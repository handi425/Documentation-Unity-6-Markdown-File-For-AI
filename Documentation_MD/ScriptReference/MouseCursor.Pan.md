...
#  [MouseCursor](MouseCursor.html).Pan
...
Cursor with a dragging hand for pan.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.Pan](MouseCursor.Pan.html));
        }
    }
