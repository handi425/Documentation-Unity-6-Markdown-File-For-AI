...
#
[AndroidProjectFilesModifierContext](Android.AndroidProjectFilesModifierContext.html).AddDirectoryAsGuidToCopy
...
If any files in the directory copy have the same destination as a file that
has already been added, Unity throws an exception.
