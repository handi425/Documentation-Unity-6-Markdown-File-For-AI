...
#  [PlayerSettings.Android](PlayerSettings.Android.html).optimizedFramePacing
...
public static bool optimizedFramePacing;
...
variance in framerate, creating a smoother gameplay.
    ...
    public class FramePacingExample : [MonoBehaviour](MonoBehaviour.html)
    {
        [[MenuItem](MenuItem.html)("Build/[Android](PlayerSettings.Android.html) Frame Pacing Example")]
        public static void FramePacing()
        {
            ...
            [PlayerSettings.Android.optimizedFramePacing](PlayerSettings.Android-optimizedFramePacing.html) = true;  
