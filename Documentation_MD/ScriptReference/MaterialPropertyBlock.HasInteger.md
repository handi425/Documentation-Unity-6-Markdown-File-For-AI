...
#  [MaterialPropertyBlock](MaterialPropertyBlock.html).HasInteger
...
Checks if [MaterialPropertyBlock](MaterialPropertyBlock.html) has the Integer
property with the given name or name ID. To set the property, use
[SetInteger](MaterialPropertyBlock.SetInteger.html).
