...
#  [Provider](VersionControl.Provider.html).ResolveIsValid
...
public static bool
ResolveIsValid([VersionControl.AssetList](VersionControl.AssetList.html)
assets);
...
Tests if any of the assets in the list have the conflicted state and can be
resolved.
...
Returns true if one or more assets in the list are resolvable.
    ...
    {
        [[MenuItem](MenuItem.html)("Version Control/ResolveIsValid")]
        public static void ExampleResolveIsValid()
        {
            ...
            bool valid = [Provider.ResolveIsValid](VersionControl.Provider.ResolveIsValid.html)(assets);
            [Debug.Log](Debug.Log.html)("Can the file be resolved?" + valid);
        }
    }
