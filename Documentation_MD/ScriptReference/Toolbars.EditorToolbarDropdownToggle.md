...
A control that is both a toggle and a dropdown used with
[EditorToolbarElementAttribute](Toolbars.EditorToolbarElementAttribute.html).

### Properties

[dropdownClickable](Toolbars.EditorToolbarDropdownToggle-
dropdownClickable.html)|  Clickable object for this dropdown.  
---|---  
[icon](Toolbars.EditorToolbarDropdownToggle-icon.html)| The text associated
with the element.  
[text](Toolbars.EditorToolbarDropdownToggle-text.html)| The icon associated
with the element.  
  
### Constructors

[EditorToolbarDropdownToggle](Toolbars.EditorToolbarDropdownToggle-ctor.html)|
Constructor.  
---|---  
  
### Public Methods

[SetValueWithoutNotify](Toolbars.EditorToolbarDropdownToggle.SetValueWithoutNotify.html)|
Allow to set a value without being notified of the change, if any.  
---|---  
[ShowDropDown](Toolbars.EditorToolbarDropdownToggle.ShowDropDown.html)| Allow
to set the visibility of the drop down button.  
  
### Events

[dropdownClicked](Toolbars.EditorToolbarDropdownToggle-dropdownClicked.html)|
