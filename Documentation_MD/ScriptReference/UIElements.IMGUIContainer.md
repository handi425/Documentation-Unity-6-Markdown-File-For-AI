...
Element that draws IMGUI content. For more information, refer to [UXML element
IMGUIContainer](../Manual/UIE-uxml-element-IMGUIContainer.html).

### Static Properties

[ussClassName](UIElements.IMGUIContainer-ussClassName.html)|  USS class name
of elements of this type.  
---|---  
  
### Properties

[contextType](UIElements.IMGUIContainer-contextType.html)|  ContextType of
this IMGUIContainer. Currently only supports ContextType.Editor.  
---|---  
[cullingEnabled](UIElements.IMGUIContainer-cullingEnabled.html)|  When this
property is set to true, onGUIHandler is not called when the Element is
outside the viewport.  
[onGUIHandler](UIElements.IMGUIContainer-onGUIHandler.html)|  The function
that's called to render and handle IMGUI events.  
  
### Constructors

[IMGUIContainer](UIElements.IMGUIContainer-ctor.html)|  Constructor.  
---|---  
  
### Public Methods

[Dispose](UIElements.IMGUIContainer.Dispose.html)|  Releases the native memory
that this IMGUIContainer instance uses.  
---|---  
[MarkDirtyLayout](UIElements.IMGUIContainer.MarkDirtyLayout.html)|  Marks
layout as dirty to trigger a redraw.  
