...
#  [Cubemap](Cubemap.html).SmoothEdges
...
Helps to compensate lack of linear interpolation across the edges of cubemap
in GPU.  
  
Usually you will want to call this method for the cubemap which is going to be
