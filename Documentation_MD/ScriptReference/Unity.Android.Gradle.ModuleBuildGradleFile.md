...
For more information about the file, see Android's documentation: [The module-
level build file](https://developer.android.com/studio/build#module-level)

### Properties

[Android](Unity.Android.Gradle.ModuleBuildGradleFile.Android.html)| The C#
definition of the android element in a gradle file.  
---|---  
[ApplyPluginList](Unity.Android.Gradle.ModuleBuildGradleFile.ApplyPluginList.html)|
An element that holds a list of plugins to be applied in a gradle file.  
[Dependencies](Unity.Android.Gradle.ModuleBuildGradleFile.Dependencies.html)|
The C# definition of the dependencies element in a gradle file.  
[Repositories](Unity.Android.Gradle.ModuleBuildGradleFile.Repositories.html)|
The C# definition of the repositories element in a gradle file.  
  
### Constructors

[ModuleBuildGradleFile](Unity.Android.Gradle.ModuleBuildGradleFile-ctor.html)|
File constructor.  
---|---  
