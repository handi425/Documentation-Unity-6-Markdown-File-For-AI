...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetBuildPropertyForAnyConfig
...
public string GetBuildPropertyForAnyConfig(IEnumerable<string> targetGuids,
string name);
...
---|---  
targetGuids | The GUID of the targets, such as the one returned by [TargetGuidByName](iOS.Xcode.PBXProject.TargetGuidByName.html).  
...
Values for names `LIBRARY_SEARCH_PATHS` and `FRAMEWORK_SEARCH_PATHS` are
quoted if they contain spaces.
    ...
    public class Sample_GetBuildPropertyForAnyConfig  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get `Minimum [iOS](PlayerSettings.iOS.html) version` property for any configuration in main target
            string minVersion = pbxProject.GetBuildPropertyForAnyConfig(mainTargetGuid, "IPHONEOS_DEPLOYMENT_TARGET");
            [Debug.Log](Debug.Log.html)("minVersion: " + minVersion);
        }
    }
