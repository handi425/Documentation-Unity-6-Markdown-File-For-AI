...
#  [PaintContext](TerrainTools.PaintContext.html).GatherHoles
...
This function collects the Terrain holes data from all Terrain tiles in the
Paint Context, and saves the information in `sourceRenderTexture`.  
