...
#  [PBXProject](iOS.Xcode.PBXProject.html).ProjectGuid
...
The project GUID identifies a project-wide native target which is used to set
project-wide properties. This GUID can be passed to any functions that accepts
