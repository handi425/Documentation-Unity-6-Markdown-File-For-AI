...
#
[ParticleSystem.NoiseModule](ParticleSystem.NoiseModule.html).scrollSpeedMultiplier
...
you only want to change the overall scroll speed multiplier. Additional
resources:
[ParticleSystem.NoiseModule.scrollSpeed](ParticleSystem.NoiseModule-
scrollSpeed.html).
