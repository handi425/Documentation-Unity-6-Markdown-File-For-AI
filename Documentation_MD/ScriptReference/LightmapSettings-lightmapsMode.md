...
#  [LightmapSettings](LightmapSettings.html).lightmapsMode
...
public static [LightmapsMode](LightmapsMode.html) lightmapsMode;
...
You can continue reading [here](../Manual/LightmappingDirectional.html) if you
want to know what the different lightmap modes do.
