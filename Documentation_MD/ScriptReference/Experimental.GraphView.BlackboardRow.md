...
A BlackboardRow contains a VisualElement and its associated property view,
that is visible when the row expands. The VisualElement is usually a
BlackboardField.

### Properties

[expanded](Experimental.GraphView.BlackboardRow-expanded.html)| Indicates
whether the BlackboardRow is expanded.  
---|---  
  
### Constructors

[BlackboardRow](Experimental.GraphView.BlackboardRow-ctor.html)| Constructs a
BlackboardRow from a VisualElement and its associated property view. The
VisualElement is usually a BlackboardField.  
---|---  
