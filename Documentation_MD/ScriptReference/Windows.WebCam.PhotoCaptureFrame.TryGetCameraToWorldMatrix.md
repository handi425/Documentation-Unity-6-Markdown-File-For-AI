...
#
[PhotoCaptureFrame](Windows.WebCam.PhotoCaptureFrame.html).TryGetCameraToWorldMatrix
...
public bool TryGetCameraToWorldMatrix(out [Matrix4x4](Matrix4x4.html)
cameraToWorldMatrix);
...
If location data is unavailable then the camera to world matrix will be set to
the identity matrix.
