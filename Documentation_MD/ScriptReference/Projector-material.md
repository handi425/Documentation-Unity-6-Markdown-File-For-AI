...
#  [Projector](Projector.html).material
...
Note that unlike [Renderer.material](Renderer-material.html), this returns a
shared material reference and not a unique duplicate.  
  
Projector does nothing if it has no material set up. The [Standard Assets
](https://assetstore.unity.com/packages/essentials/asset-packs/standard-
assets-32351) package contains an example of Projector's material in _Blob-
Shadow_ folder.  
