...
#  [Rigidbody2D.SlideResults](Rigidbody2D.SlideResults.html).iterationsUsed
...
Returns the number of iterations used when performing a
[Rigidbody2D.Slide](Rigidbody2D.Slide.html).

This will never exceed the
