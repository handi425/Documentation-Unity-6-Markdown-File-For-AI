...
#
[ParticleSystem.TriggerModule](ParticleSystem.TriggerModule.html).SetCollider
...
public void SetCollider(int index, [Component](Component.html) collider);
...
If the index is greater than the number of Colliders currently assigned to the
Particle System, Unity adds empty entries to ensure the list is large enough.
