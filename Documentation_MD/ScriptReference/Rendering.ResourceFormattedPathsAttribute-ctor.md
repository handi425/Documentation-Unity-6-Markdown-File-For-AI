...
public ResourceFormattedPathsAttribute(string pathFormat, int rangeMin, int
rangeMax, [Rendering.SearchType](Rendering.SearchType.html) location);
...
Creates a new ResourceFormattedPathsAttribute for an array's elements using
