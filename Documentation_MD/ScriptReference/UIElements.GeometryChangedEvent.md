...
dimension of an element changes.

This event does not trickle down or bubble up. It cannot be cancelled.

### Properties

[newRect](UIElements.GeometryChangedEvent-newRect.html)|  Gets the elements's
new dimensions.  
---|---  
[oldRect](UIElements.GeometryChangedEvent-oldRect.html)|  Gets the element's
old dimensions.  
  
### Constructors

[GeometryChangedEvent](UIElements.GeometryChangedEvent-ctor.html)|
Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.GeometryChangedEvent.Init.html)|  Resets the event values to
their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.GeometryChangedEvent.GetPooled.html)|  Gets an event
from the event pool, and initializes it with the specified values. Use this
method instead of instancing new events. Use Dispose() to release events back
to the event pool.  
---|---  
