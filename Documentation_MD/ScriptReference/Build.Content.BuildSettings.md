...
[buildFlags](Build.Content.BuildSettings-buildFlags.html)| Specific build
options to use when building content.  
---|---  
[group](Build.Content.BuildSettings-group.html)| Platform group for which
content will be built.  
[subtarget](Build.Content.BuildSettings-subtarget.html)| Platform subtarget
for which content will be built.  
[target](Build.Content.BuildSettings-target.html)| Platform target for which
content will be built.  
[typeDB](Build.Content.BuildSettings-typeDB.html)| Type information to use for
building content.  
