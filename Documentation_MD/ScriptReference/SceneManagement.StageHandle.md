...
[Contains](SceneManagement.StageHandle.Contains.html)| Does the stage contain
the given GameObject?  
---|---  
[FindComponentOfType](SceneManagement.StageHandle.FindComponentOfType.html)|
Returns the first active loaded object of the given type.  
[FindComponentsOfType](SceneManagement.StageHandle.FindComponentsOfType.html)|
Returns a list of all active loaded objects of the given type.  
[IsValid](SceneManagement.StageHandle.IsValid.html)| Is this stage handle
valid?  
