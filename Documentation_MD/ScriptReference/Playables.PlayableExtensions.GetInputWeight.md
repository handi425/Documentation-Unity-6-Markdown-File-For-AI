...
#  [PlayableExtensions](Playables.PlayableExtensions.html).GetInputWeight
...
**float** The current weight of the connected
[Playable](Playables.Playable.html).

### Description

Returns the weight of the [Playable](Playables.Playable.html) connected at the
given input port index.
