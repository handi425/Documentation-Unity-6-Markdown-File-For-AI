...
A Button has a text label element that can respond to pointer and mouse
events. You can add an icon to pair it with the text by assigning a Background
(Texture, RenderTexture, Sprite or Vector Image) to the iconImage API or icon-
image UXML property. Please note that by providing an icon image, this will
automatically update the Button's hierarchy to contain an
[Image](UIElements.Image.html) and a text label element.  
  
By default, a single left mouse click activates the Button's
[Clickable](UIElements.Clickable.html) property button. To remove this
activator, or add more activators, modify the `clickable.activators` property.
For details, see
[ManipulatorActivationFilter](UIElements.ManipulatorActivationFilter.html).  
  
To bind a Button's text value to the contents of a variable, set the `binding-
path` property in the UXML file, or the `bindingPath` property in the C# code,
to a string that contains the variable name.  
  
For more information, refer to [UXML element Button](../Manual/UIE-uxml-
element-Button.html).

### Static Properties

[iconOnlyUssClassName](UIElements.Button-iconOnlyUssClassName.html)|  The USS
class name for Button elements with an icon only, no text.  
---|---  
[iconUssClassName](UIElements.Button-iconUssClassName.html)|  The USS class
name for Button elements with an icon.  
[imageUSSClassName](UIElements.Button-imageUSSClassName.html)|  The USS class
name of the image element that will be used to display the icon texture.  
[ussClassName](UIElements.Button-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[clickable](UIElements.Button-clickable.html)|  Clickable MouseManipulator for
this Button.  
---|---  
[iconImage](UIElements.Button-iconImage.html)|  The Texture, Sprite, or
VectorImage that will represent an icon within a Button element.  
...
[clicked](UIElements.Button-clicked.html)|  Callback triggered when the button
is clicked.  
---|---  
[onClick](UIElements.Button-onClick.html)|  Obsolete. Use clicked instead.  
  
### Inherited Members

### Static Properties

[selectableUssClassName](UIElements.TextElement-selectableUssClassName.html)|
USS class name of selectable text elements.  
---|---  
[ussClassName](UIElements.TextElement-ussClassName.html)|  USS class name of
elements of this type.  
...
[displayTooltipWhenElided](UIElements.TextElement-
displayTooltipWhenElided.html)|  When true, a tooltip displays the full
version of elided text, and also if a tooltip had been previously provided, it
will be overwritten.  
[emojiFallbackSupport](UIElements.TextElement-emojiFallbackSupport.html)|
...
standard.  
[enableRichText](UIElements.TextElement-enableRichText.html)|  When false,
rich text tags will not be parsed.  
[experimental](UIElements.TextElement-experimental.html)|  Returns the
TextElement experimental interface.  
[isElided](UIElements.TextElement-isElided.html)|  Returns true if text is
elided, false otherwise.  
[parseEscapeSequences](UIElements.TextElement-parseEscapeSequences.html)|
Specifies whether escape sequences are displayed as is or if they are replaced
by the character they represent.  
[selection](UIElements.TextElement-selection.html)|  Retrieves this
TextElement's ITextSelection  
...
element.  
[MeasureTextSize](UIElements.TextElement.MeasureTextSize.html)|  Computes the
size needed to display a text string based on element style values such as
font, font-size, word-wrap, and so on.  
