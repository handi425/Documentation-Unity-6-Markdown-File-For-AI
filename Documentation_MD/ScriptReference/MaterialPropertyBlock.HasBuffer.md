...
#  [MaterialPropertyBlock](MaterialPropertyBlock.html).HasBuffer
...
ComputeBuffer property with the given name or name ID. To set the property,
use [SetBuffer](MaterialPropertyBlock.SetBuffer.html).
