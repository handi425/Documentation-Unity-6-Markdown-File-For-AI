...
#  [Animator](Animator.html).keepAnimatorStateOnDisable
...
**Note** : When this property is set to true, the Animator also preserves the
animated values for inactive GameObjects. For example, a GameObject's
transform is animated from x=0 to x=3 while it is active. After this
GameObject becomes inactive, it still keeps the animated value x=3 instead of
x=0.  
