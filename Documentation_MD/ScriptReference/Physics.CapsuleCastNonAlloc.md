...
#  [Physics](Physics.html).CapsuleCastNonAlloc
...
public static int CapsuleCastNonAlloc([Vector3](Vector3.html) point1,
[Vector3](Vector3.html) point2, float radius, [Vector3](Vector3.html)
direction, RaycastHit[] results, float maxDistance = Mathf.Infinity, int
...
information on what was hit into the buffer.

Like [Physics.CapsuleCastAll](Physics.CapsuleCastAll.html), but generates no
garbage.
