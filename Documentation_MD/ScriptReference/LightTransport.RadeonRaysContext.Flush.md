...
#  [RadeonRaysContext](LightTransport.RadeonRaysContext.html).Flush
...
Start execution of the enqueued operations. On some platforms the underlying
implementation or driver flushes automatically, on others it is up to the user
to call Flush. The Flush method returns immediately.
    ...
    using var results = new NativeArray<float>(1, [Allocator.Temp](Unity.Collections.Allocator.Temp.html));
