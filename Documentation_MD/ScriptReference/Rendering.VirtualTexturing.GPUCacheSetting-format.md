...
#  [GPUCacheSetting](Rendering.VirtualTexturing.GPUCacheSetting.html).format
...
A format of GraphicsFormat.None indicates this GPUCacheSetting will be used
for any cache formats not specifically mentioned in the settings.
