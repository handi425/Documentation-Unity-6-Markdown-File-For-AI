...
#  [SearchIndexer](Search.SearchIndexer.html).Merge
...
public void Merge(string[] removeDocuments,
[Search.SearchIndexer](Search.SearchIndexer.html) other, int baseScore,
Action<int,SearchIndexer,int> documentIndexing);
