...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetBuildPhaseType
...
The defined build phase types are `PBXSourcesBuildPhase`,
`PBXFrameworksBuildPhase`, `PBXResourcesBuildPhase`, `PBXCopyFilesBuildPhase`,
and `PBXShellScriptBuildPhase`.
    ...
    public class Sample_GetBuildPhaseType  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Retrieve the GUIDs of all Build Phases for the target and print their types to the Console
            ...
            foreach (string phaseGuid in buildPhases)
            {
                ...
                [Debug.Log](Debug.Log.html)($"Type: {phaseType}");
            }
        }
    }
