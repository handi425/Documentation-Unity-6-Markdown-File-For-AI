...
#  [PlayableBehaviour](Playables.PlayableBehaviour.html).PrepareFrame
...
public void PrepareFrame([Playables.Playable](Playables.Playable.html)
...
This function is called during the PrepareFrame phase of the
[PlayableGraph](Playables.PlayableGraph.html).

PrepareFrame should be used to do topological modifications, change connection
weights, time changes , etc.
