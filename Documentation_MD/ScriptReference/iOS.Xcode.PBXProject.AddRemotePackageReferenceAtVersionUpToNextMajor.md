...
#
[PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageReferenceAtVersionUpToNextMajor
...
public string AddRemotePackageReferenceAtVersionUpToNextMajor(string url,
string version);
...
up to the next major version.
    ...
    public class Sample_AddRemotePackageReferenceAtVersionUpToNextMajor  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) using the URL and major version
            string packageGuid = pbxProject.AddRemotePackageReferenceAtVersionUpToNextMajor("https://github.com/apple/swift-system.git", "1.0.0");  
