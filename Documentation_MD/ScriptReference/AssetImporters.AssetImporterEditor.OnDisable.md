...
#  [AssetImporterEditor](AssetImporters.AssetImporterEditor.html).OnDisable
...
This is also called when the editor is destroyed and can be used for any
...
loaded.
    ...
    public class ExampleScript : [AssetImporterEditor](AssetImporters.AssetImporterEditor.html)
    {
        ...
        {
            base.OnDisable();
            [Debug.Log](Debug.Log.html)("editor was removed");
        }
    }
