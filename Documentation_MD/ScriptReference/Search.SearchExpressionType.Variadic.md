...
#  [SearchExpressionType](Search.SearchExpressionType.html).Variadic
...
to specify that a parameter can be used multiples times. For example
count{Iterable1, Iterable2,... IterableN} can be executed with any number of
iterables are parameters.
