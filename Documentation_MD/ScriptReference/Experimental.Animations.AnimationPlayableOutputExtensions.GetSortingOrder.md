...
#
[AnimationPlayableOutputExtensions](Experimental.Animations.AnimationPlayableOutputExtensions.html).GetSortingOrder
...
GetSortingOrder([Animations.AnimationPlayableOutput](Animations.AnimationPlayableOutput.html)
output);
...
Gets the priority index of the specified
