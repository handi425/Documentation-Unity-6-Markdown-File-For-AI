...
#  [Renderer](Renderer.html).motionVectors
...
**Obsolete** Use motionVectorGenerationMode instead. public bool
motionVectors;
...
If set to true, this object will have a per-object motion vector pass
rendererd (in addition to the default camera reconstruction motion vectors).
