...
#  [Input](Input.html).accelerationEvents
...
more](../Manual/Input.html)).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void [Update](PlayerLoop.Update.html)()
        {
            ...
            foreach ([AccelerationEvent](AccelerationEvent.html) accEvent in [Input.accelerationEvents](Input-accelerationEvents.html))
            {
