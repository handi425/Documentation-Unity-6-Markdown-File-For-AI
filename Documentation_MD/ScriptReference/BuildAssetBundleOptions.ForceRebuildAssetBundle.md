...
#
[BuildAssetBundleOptions](BuildAssetBundleOptions.html).ForceRebuildAssetBundle
...
This allows you to rebuild the assetBundle even if none of the included assets
have changed.
    ...
    //This script creates a new [Menu](Menu.html) named “Build [Asset](VersionControl.Asset.html)” and new options within the menu named “Normal” and “Force Rebuild”. Click these menu items to build an [AssetBundle](AssetBundle.html) into a folder.  
    ...
    public class Example
    {
        ...
        //Creates a new item (Force Rebuild) in the new Build [Asset](VersionControl.Asset.html) Bundles menu
        [[MenuItem](MenuItem.html)("Build [Asset](VersionControl.Asset.html) Bundles/Force Rebuild")]
        static void BuildABsForce()
        {
            //Build the AssetBundles in force rebuild mode
            [BuildPipeline.BuildAssetBundles](BuildPipeline.BuildAssetBundles.html)("Assets/MyAssetBuilds", [BuildAssetBundleOptions.ForceRebuildAssetBundle](BuildAssetBundleOptions.ForceRebuildAssetBundle.html), [BuildTarget.StandaloneOSX](BuildTarget.StandaloneOSX.html));
        }
    }
