...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddFolderReference
...
sourceTree | The source tree the path is relative to. [PBXSourceTree.Source](iOS.Xcode.PBXSourceTree.Source.html) is set by default. [PBXSourceTree.Group](iOS.Xcode.PBXSourceTree.Group.html) isn't supported.  
  
### Returns

**string** The GUID of the added folder reference. You can use it later, for
example, to add the file for building to targets.
...
path. To add the folder reference to the list of files to build, pass the
returned value to [AddFileToBuild](iOS.Xcode.PBXProject.AddFileToBuild.html).
    ...
    public class Sample_AddFolderReference  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            string filePath = Path.Combine([Application.dataPath](Application-dataPath.html), "[Resources](Resources.html)/");  
      
            // Add the '[Resources](Resources.html)' directory to the Xcode project
            pbxProject.AddFile(filePath, "[Resources](Resources.html)");  
