...
Configures the repositories for this project. For more information about the
file, see Android's documentation: [Remote
repositories](https://developer.android.com/studio/build/dependencies#remote-
repositories)

### Static Properties

[Google](Unity.Android.Gradle.Repositories.Google.html)| Google reppsitory
google().  
---|---  
[GradlePluginPortal](Unity.Android.Gradle.Repositories.GradlePluginPortal.html)|
GradlePluginPortal reppsitory gradlePluginPortal().  
[JCenter](Unity.Android.Gradle.Repositories.JCenter.html)| JCenter reppsitory
jcenter().  
[Maven](Unity.Android.Gradle.Repositories.Maven.html)| Maven reppsitory
maven().  
[MavenCentral](Unity.Android.Gradle.Repositories.MavenCentral.html)|
MavenCentral reppsitory mavenCentral().  
  
### Constructors

[Repositories](Unity.Android.Gradle.Repositories-ctor.html)| Element
constructor.  
---|---  
  
### Public Methods

[AddRepository](Unity.Android.Gradle.Repositories.AddRepository.html)| Adds a
repository with value.  
---|---  
