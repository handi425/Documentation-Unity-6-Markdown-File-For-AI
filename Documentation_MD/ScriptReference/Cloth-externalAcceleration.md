...
#  [Cloth](Cloth.html).externalAcceleration
...
public [Vector3](Vector3.html) externalAcceleration;
...
Additional resources: [Cloth.randomAcceleration](Cloth-
randomAcceleration.html).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            GetComponent<[Cloth](Cloth.html)>().externalAcceleration =  -[Physics.gravity](Physics-gravity.html) / 2;
        }
    }
