...
#
[TerrainPaintUtility](TerrainTools.TerrainPaintUtility.html).EndPaintHeightmap
...
public static void
EndPaintHeightmap([TerrainTools.PaintContext](TerrainTools.PaintContext.html)
...
back to the original Terrain tiles. This function also signals Unity to update
the dirty regions in each of the affected heightmaps, to update collision and
physics. This function will also release all allocated resources in the
PaintContext.  
