...
#  [NativeArray<T0>](Unity.Collections.NativeArray_1.html).GetSubArray
...
**NativeArray <T>** A view into the array that aliases the original array,
which can't be disposed.
