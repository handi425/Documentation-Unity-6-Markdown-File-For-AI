...
#  [MeshUpdateFlags](Rendering.MeshUpdateFlags.html).Default
...
You can use this flag with "advanced" Mesh API, which includes the following
methods: [Mesh.SetVertexBufferData](Mesh.SetVertexBufferData.html),
