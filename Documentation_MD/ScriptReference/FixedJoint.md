...
[Switch to Manual](../Manual/class-FixedJoint.html "Go to FixedJoint Component
in the Manual")

### Description

The Fixed joint groups together 2 rigidbodies, making them stick together in
their bound position.

Additional resources: [CharacterJoint](CharacterJoint.html),
[HingeJoint](HingeJoint.html), [SpringJoint](SpringJoint.html),
