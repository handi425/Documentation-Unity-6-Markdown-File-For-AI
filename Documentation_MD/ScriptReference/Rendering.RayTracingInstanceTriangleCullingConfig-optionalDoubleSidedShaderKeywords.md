...
#
[RayTracingInstanceTriangleCullingConfig](Rendering.RayTracingInstanceTriangleCullingConfig.html).optionalDoubleSidedShaderKeywords
...
is called, then the geometry that uses that Shader will be considered double-
sided when rays encounter the geometry during acceleration structure traversal
on the GPU.  
