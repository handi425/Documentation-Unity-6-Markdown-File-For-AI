...
#  [PlayerSettings](PlayerSettings.html).SetApplicationIdentifier
...
public static void
SetApplicationIdentifier([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget, string identifier);

**Obsolete** Use SetApplicationIdentifier(NamedBuildTarget buildTarget, string
identifier) instead.

## Declaration

public static void
SetApplicationIdentifier([BuildTargetGroup](BuildTargetGroup.html)
targetGroup, string identifier);
