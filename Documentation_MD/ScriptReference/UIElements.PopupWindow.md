...
Styled visual text element. This element doesn't have any functionality. It's
just a container with a border and a title, rather than a window or popup. For
more information, refer to [UXML element PopupWindow](../Manual/UIE-uxml-
element-PopupWindow.html).

    
    
     var popupWindow = new UnityEngine.UIElements.PopupWindow() { text = "Title" };
     popupWindow.Add(new [Button](UIElements.Button.html)());
    

### Static Properties

[contentUssClassName](UIElements.PopupWindow-contentUssClassName.html)|  USS
class name of content elements in elements of this type.  
---|---  
[ussClassName](UIElements.PopupWindow-ussClassName.html)|  USS class name of
elements of this type.  
  
### Constructors

[PopupWindow](UIElements.PopupWindow-ctor.html)|  Initializes and returns an
instance of PopupWindow.  
---|---  
