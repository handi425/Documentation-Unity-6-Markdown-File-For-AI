...
#  [AndroidGame](Android.AndroidGame.html).SetGameState
...
public static void SetGameState(bool isLoading,
[Android.AndroidGameState](Android.AndroidGameState.html) gameState);

## Declaration

public static void SetGameState(bool isLoading,
[Android.AndroidGameState](Android.AndroidGameState.html) gameState, int
label, int quality);
...
---|---  
gameState |  [AndroidGameState](Android.AndroidGameState.html) state.  
...
in the Android application to specify the loading status. Requires API level
33 (Android 13).
