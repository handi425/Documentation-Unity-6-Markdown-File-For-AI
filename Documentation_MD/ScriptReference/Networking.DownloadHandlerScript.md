...
An abstract base class for user-created scripting-driven
[DownloadHandler](Networking.DownloadHandler.html) implementations.

On its own, a [DownloadHandlerScript](Networking.DownloadHandlerScript.html)
object does no useful work.  
  
Instead, it forwards data received from the network to the
[DownloadHandler.ReceiveData](Networking.DownloadHandler.ReceiveData.html)
callback method, as well as invoking other useful callbacks for download-
related events. By default, a
[DownloadHandlerScript](Networking.DownloadHandlerScript.html) does nothing;
however, you can derive your own subclass from DownloadHandlerScript, override
some or all of its callbacks and thereby implement completely custom data
handling.  
  
Additional resources:
[DownloadHandler.ReceiveData](Networking.DownloadHandler.ReceiveData.html),
DownloadHandler.ReceiveContentLength,
[DownloadHandler.CompleteContent](Networking.DownloadHandler.CompleteContent.html).

### Constructors

[DownloadHandlerScript](Networking.DownloadHandlerScript-ctor.html)| Create a
DownloadHandlerScript which allocates new buffers when passing data to
callbacks.  
---|---  
