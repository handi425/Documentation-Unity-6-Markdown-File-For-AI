...
#  [LightingSettings](LightingSettings.html).denoiserTypeAO
...
Determines the type of denoising that the Progressive Lightmapper applies to
...
the **Ambient Occlusion Denoiser** property in the Lighting Settings Asset
Inspector.  
