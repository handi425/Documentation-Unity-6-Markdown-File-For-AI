...
#  [PhysicsShape2D](PhysicsShape2D.html).radius
...
All [PhysicsShapeType2D](PhysicsShapeType2D.html) use this radius with the
exception of the [Polygon](PhysicsShapeType2D.Polygon.html) type. Refer to the
individual shape types for details on how the radius is used for the
respective shape.
