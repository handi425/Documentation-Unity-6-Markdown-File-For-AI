...
#  [AccessibilityHierarchy](Accessibility.AccessibilityHierarchy.html).AddNode
...
Creates and adds a new node with the given label in this hierarchy under the
given parent node. If no parent is provided, the new node is added as a root
in the hierarchy.
