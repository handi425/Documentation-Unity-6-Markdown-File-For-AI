...
#  [LineRenderer](LineRenderer.html).positionCount
...
[positionCount](LineRenderer-positionCount.html) returns the number of
vertices in the line. The example below shows a line with 3 vertices.
