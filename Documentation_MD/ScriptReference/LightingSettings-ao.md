...
#  [LightingSettings](LightingSettings.html).ao
...
When this is is set to `true`, Unity applies AO to lightmaps. When this is set
to `false`, Unity does not apply AO to lightmaps.  
...
the **Ambient Occlusion** property in the Lighting Settings Asset Inspector.  
