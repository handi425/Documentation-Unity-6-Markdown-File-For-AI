...
#  [Animator](Animator.html).GetIKRotationWeight
...
public float GetIKRotationWeight([AvatarIKGoal](AvatarIKGoal.html) goal);
...
The rotation calculated by the IK is also influenced by a weight value in the
range 0..1 that determines how far between the start and the goal to aim. This
function returns the current weight value for the rotation of the goal.  
  
Additional resources: [GetIKRotation](Animator.GetIKRotation.html),
