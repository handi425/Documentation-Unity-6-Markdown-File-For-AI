...
#  [PBXProject](iOS.Xcode.PBXProject.html).WriteToFile
...
Writes the project contents to the specified file.
    ...
    public class Sample_WriteToFile  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Initialize [PBXProject](iOS.Xcode.PBXProject.html) by specifying the project path
            ...
            // Read project information from the project file
