...
#  [SerializedObject](SerializedObject.html).UpdateIfRequiredOrScript
...
In which case it is not safe to assume that SetDirty has been called. Return
true if an Update was done.
