...
Inherits
from:[Unity.Android.Gradle.BaseGradleFile](Unity.Android.Gradle.BaseGradleFile.html)
...
For more information about the file, see Android's documentation: [Gradle
properties files](https://developer.android.com/studio/build#properties-files)

### Properties

[JvmArgs](Unity.Android.Gradle.GradlePropertiesFile.JvmArgs.html)| The C#
definition of the org.gradle.jvmargs property.  
---|---  
[Parallel](Unity.Android.Gradle.GradlePropertiesFile.Parallel.html)| The C#
definition of the org.gradle.parallel property.  
[UnityProjectPath](Unity.Android.Gradle.GradlePropertiesFile.UnityProjectPath.html)|
The C# definition of the unityProjectPath. Path to Unity project.  
[UnityRootPath](Unity.Android.Gradle.GradlePropertiesFile.UnityRootPath.html)|
The C# definition of the unityRootPath. Path to Unity executable.  
[UnityStreamingAssets](Unity.Android.Gradle.GradlePropertiesFile.UnityStreamingAssets.html)|
The C# definition of the unityStreamingAssets. List of files that are provided
as streaming assets and won't be compressed.  
  
### Constructors

[GradlePropertiesFile](Unity.Android.Gradle.GradlePropertiesFile-ctor.html)|
File constructor.  
---|---  
