...
#
[RayTracingInstanceCullingMaterialTest](Rendering.RayTracingInstanceCullingMaterialTest.html).requiredShaderTags
...
If a Shader contains a Shader Tag from the list then the acceleration
