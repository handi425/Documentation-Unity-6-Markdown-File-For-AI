...
#
[ParticleSystem.CollisionModule](ParticleSystem.CollisionModule.html).bounceMultiplier
...
A multiplier for
[ParticleSystem.CollisionModule.bounce](ParticleSystem.CollisionModule-
bounce.html).

Changing this property is more efficient than accessing the entire curve, if
you only want to change the overall bounce multiplier.
