...
#
[AndroidProjectFilesModifierContext](Android.AndroidProjectFilesModifierContext.html).AddFileAsGuidToCopy
...
If another file with the same destination has already been added, Unity throws
an exception.
