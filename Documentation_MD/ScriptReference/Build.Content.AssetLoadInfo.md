...
[address](Build.Content.AssetLoadInfo-address.html)| Friendly name used to
load the built asset.  
---|---  
[asset](Build.Content.AssetLoadInfo-asset.html)| GUID for the given asset.  
[includedObjects](Build.Content.AssetLoadInfo-includedObjects.html)| List of
objects that an asset contains in its source file.  
[referencedObjects](Build.Content.AssetLoadInfo-referencedObjects.html)| List
of objects that an asset references.  
  
### Constructors

[AssetLoadInfo](Build.Content.AssetLoadInfo-ctor.html)| Default constructor
for an empty AssetLoadInfo.  
---|---  
