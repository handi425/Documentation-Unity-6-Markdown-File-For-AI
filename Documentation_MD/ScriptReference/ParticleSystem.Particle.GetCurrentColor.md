...
#  [ParticleSystem.Particle](ParticleSystem.Particle.html).GetCurrentColor
...
public [Color32](Color32.html)
GetCurrentColor([ParticleSystem](ParticleSystem.html) system);
