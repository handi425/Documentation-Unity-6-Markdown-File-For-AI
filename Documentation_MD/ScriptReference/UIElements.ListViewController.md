...
List view controller. View controllers of this type are meant to take care of
data virtualized by any [ListView](UIElements.ListView.html) inheritor.

### Properties

[listView](UIElements.ListViewController-listView.html)|  View for this
controller, cast as a ListView.  
---|---  
