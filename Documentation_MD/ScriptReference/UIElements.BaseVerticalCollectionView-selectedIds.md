...
#
[BaseVerticalCollectionView](UIElements.BaseVerticalCollectionView.html).selectedIds
...
In a tree, if a child item is collapsed, its ID is included in the persistent
selection.
