...
#  [PlayableExtensions](Playables.PlayableExtensions.html).SetDelay
...
**Obsolete** SetDelay is obsolete; use a custom ScriptPlayable to implement
this feature.
...
The delay is **not** multiplied by the speed of the playable because it
happens before the playable starts.  
