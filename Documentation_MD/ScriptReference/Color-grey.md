...
public static [Color](Color.html) grey;

### Description

English spelling for [gray](Color-gray.html). RGBA is the same (0.5, 0.5, 0.5,
1).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        //Run your mouse over the [GameObject](GameObject.html) to change the [Renderer](Renderer.html)'s material color to grey
        void OnMouseOver()
        {
            m_Renderer.material.color = [Color.grey](Color-grey.html);
        }  
