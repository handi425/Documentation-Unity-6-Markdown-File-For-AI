...
#  [MeshGenerationResult](XR.MeshGenerationResult.html).Rotation
...
The rotation associated with the generated mesh relative to the session
origin.

This value will be [Quaternion.identity](Quaternion-identity.html) unless the
