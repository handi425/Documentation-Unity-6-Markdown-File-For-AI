...
#  [Rigidbody](Rigidbody.html).excludeLayers
...
[Rigidbody](Rigidbody.html) should exclude when deciding if the
...
layers. Use this property to specify additional layers that all
[Collider](Collider.html)s attached to this [Rigidbody](Rigidbody.html)
instance can't contact.  
