...
#  [LineRenderer](LineRenderer.html).generateLightingData
...
Configures a line to generate Normals and Tangents. With this data, Scene
lighting can affect the line via Normal Maps and the Unity Standard Shader, or
