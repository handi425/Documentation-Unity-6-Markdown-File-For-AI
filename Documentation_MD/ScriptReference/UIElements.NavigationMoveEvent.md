...
Inherits
from:[UIElements.NavigationEventBase_1](UIElements.NavigationEventBase_1.html)
...
Event typically sent when the user presses the D-pad, moves a joystick or
presses the arrow keys.

### Properties

[direction](UIElements.NavigationMoveEvent-direction.html)|  The direction of
the navigation.  
---|---  
[move](UIElements.NavigationMoveEvent-move.html)|  The move vector, if
applicable.  
  
### Constructors

[NavigationMoveEvent](UIElements.NavigationMoveEvent-ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.NavigationMoveEvent.Init.html)|  Initialize the event
members.  
---|---  
  
### Static Methods

[GetPooled](UIElements.NavigationMoveEvent.GetPooled.html)|  Gets an event
...
[actionKey](UIElements.NavigationEventBase_1-actionKey.html)|  Gets a boolean
...
[altKey](UIElements.NavigationEventBase_1-altKey.html)|  Gets a boolean value
that indicates whether the Alt key is pressed. True means the Alt key is
pressed. False means it isn't.  
[commandKey](UIElements.NavigationEventBase_1-commandKey.html)|  Gets a
boolean value that indicates whether the Windows/Cmd key is pressed. True
means the Windows/Cmd key is pressed. False means it isn't.  
[ctrlKey](UIElements.NavigationEventBase_1-ctrlKey.html)|  Gets a boolean
value that indicates whether the Ctrl key is pressed. True means the Ctrl key
is pressed. False means it isn't.  
[modifiers](UIElements.NavigationEventBase_1-modifiers.html)|  Gets flags that
indicate whether modifier keys (Alt, Ctrl, Shift, Windows/Cmd) are pressed.  
[shiftKey](UIElements.NavigationEventBase_1-shiftKey.html)|  Gets a boolean
...
event instance.  
[GetPooled](UIElements.NavigationEventBase_1.GetPooled.html)|  Gets an event
from the event pool and initializes it with the given values. Use this
function instead of creating new events. Events obtained from this method
should be released back to the pool using Dispose().  
