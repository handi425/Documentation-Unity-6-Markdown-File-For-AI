...
[change](Experimental.GraphView.StickyNoteChangeEvent-change.html)| The type
of change that occured.  
---|---  
  
### Constructors

[StickyNoteChangeEvent](Experimental.GraphView.StickyNoteChangeEvent-
ctor.html)| Constructor.  
---|---  
  
### Static Methods

[GetPooled](Experimental.GraphView.StickyNoteChangeEvent.GetPooled.html)| Gets
an event from the event pool and initializes it with the given values. Use
