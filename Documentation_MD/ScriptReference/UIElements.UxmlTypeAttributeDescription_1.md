...
[defaultValueAsString](UIElements.UxmlTypeAttributeDescription_1-defaultValueAsString.html)|
The default value for the attribute, as a string.  
---|---  
  
### Constructors

[UxmlTypeAttributeDescription_1](UIElements.UxmlTypeAttributeDescription_1-ctor.html)|
Constructor.  
---|---  
  
### Public Methods

[GetValueFromBag](UIElements.UxmlTypeAttributeDescription_1.GetValueFromBag.html)|
Method that retrieves an attribute's value from an attribute bag. Returns it
if it is found, otherwise return defaultValue.  
---|---  
[TryGetValueFromBag](UIElements.UxmlTypeAttributeDescription_1.TryGetValueFromBag.html)|
Method that tries to retrieve an attribute's value from an attribute bag..
