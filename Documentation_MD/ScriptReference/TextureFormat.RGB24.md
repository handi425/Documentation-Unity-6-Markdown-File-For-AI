...
#  [TextureFormat](TextureFormat.html).RGB24
...
Note that there are almost no GPUs that support this format natively, so at
texture load time it is converted into an [RGBA32](TextureFormat.RGBA32.html)
