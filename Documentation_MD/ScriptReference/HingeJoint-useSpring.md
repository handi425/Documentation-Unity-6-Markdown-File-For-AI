...
#  [HingeJoint](HingeJoint.html).useSpring
...
Enables the joint's [spring](HingeJoint-spring.html). Disabled by default.

Additional resources: [JointSpring](JointSpring.html)  
