...
For more information about the element, see Android's documentation: [Activity
element](https://developer.android.com/guide/topics/manifest/activity-element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.Activity.Attributes.html)| The
attributes container for the <activity> element.  
---|---  
[IntentFilterList](Unity.Android.Gradle.Manifest.Activity.IntentFilterList.html)|
List of <intent-filter> child elements.  
[Layout](Unity.Android.Gradle.Manifest.Activity.Layout.html)| Child element
<layout>.  
[MetaDataList](Unity.Android.Gradle.Manifest.Activity.MetaDataList.html)| List
of <meta-data> child elements.  
  
### Constructors

[Activity](Unity.Android.Gradle.Manifest.Activity-ctor.html)| Element
constructor.  
---|---  
  
### Public Methods

[AddMetaDataResource](Unity.Android.Gradle.Manifest.Activity.AddMetaDataResource.html)|
Adds <meta-data> child element that specifies a resource.  
---|---  
[AddMetaDataValue](Unity.Android.Gradle.Manifest.Activity.AddMetaDataValue.html)|
Adds <meta-data> child element that specifies a resource value.  
[GetLauncherIntentFilter](Unity.Android.Gradle.Manifest.Activity.GetLauncherIntentFilter.html)|
