...
#  [BuildAssetBundleOptions](BuildAssetBundleOptions.html).CollectDependencies
...
This follows all references to any assets, game objects or components and
...
flag is ignored because references are always followed.
