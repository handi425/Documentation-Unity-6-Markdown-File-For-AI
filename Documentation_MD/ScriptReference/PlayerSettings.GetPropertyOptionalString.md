...
#  [PlayerSettings](PlayerSettings.html).GetPropertyOptionalString
...
Property is not required to exist. If it doesn't exist, value variable will
not be changed and this method will return false.
