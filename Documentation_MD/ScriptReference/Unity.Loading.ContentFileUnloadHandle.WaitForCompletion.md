...
#
[ContentFileUnloadHandle](Unity.Loading.ContentFileUnloadHandle.html).WaitForCompletion
...
**bool** Returns false if the timeout was reached before ContentFile completed
loading.
