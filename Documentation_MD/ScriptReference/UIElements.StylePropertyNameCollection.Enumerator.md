...
[Current](UIElements.StylePropertyNameCollection.Enumerator.Current.html)|
Gets the element at the current position of the enumerator.  
---|---  
  
### Public Methods

[Dispose](UIElements.StylePropertyNameCollection.Enumerator.Dispose.html)|
Releases all resources used by the StylePropertyNameCollection enumerator.  
---|---  
[MoveNext](UIElements.StylePropertyNameCollection.Enumerator.MoveNext.html)|
