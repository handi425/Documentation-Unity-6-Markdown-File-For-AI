...
#  [Tilemap](Tilemaps.Tilemap.html).GetEditorPreviewTransformMatrix
...
GetEditorPreviewTransformMatrix([Vector3Int](Vector3Int.html) position);
...
Gets the transform matrix of an editor preview [Tile](Tilemaps.Tile.html)
