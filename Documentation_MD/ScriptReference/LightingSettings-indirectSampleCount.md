...
#  [LightingSettings](LightingSettings.html).indirectSampleCount
...
Specifies the number of samples the Progressive Lightmapper uses for indirect
lighting calculations. (Editor only).

The range is 8 through 131072. The default value is 512. If you increase this
value, the quality of your lightmaps might improve, but baking takes more
time.  
