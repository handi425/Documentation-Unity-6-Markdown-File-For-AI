...
#  [SearchItemOptions](Search.SearchItemOptions.html).Ellipsis
...
If the description is longer than the width of the search view, truncates the
description and adds an ellipsis.
