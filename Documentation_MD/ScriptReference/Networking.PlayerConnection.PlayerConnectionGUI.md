...
Use the methods in this class to manually position UI elements. To
automatically layout UI, use the corresponding methods in
[PlayerConnectionGUILayout](Networking.PlayerConnection.PlayerConnectionGUILayout.html).

### Static Methods

[ConnectionTargetSelectionDropdown](Networking.PlayerConnection.PlayerConnectionGUI.ConnectionTargetSelectionDropdown.html)|
