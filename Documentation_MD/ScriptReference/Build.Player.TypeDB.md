...
This class helps ensure the correct fields are serialized out for content
builds.  
...
[Dispose](Build.Player.TypeDB.Dispose.html)| Dispose the TypeDB destroying all
internal state.  
---|---  
[Equals](Build.Player.TypeDB.Equals.html)| Returns true if the objects are
equal.  
[GetHash128](Build.Player.TypeDB.GetHash128.html)| Gets the hash for the
BuildReferenceMap.  
[GetHashCode](Build.Player.TypeDB.GetHashCode.html)| Gets the hash code for
the TypeDB.  
[GetObjectData](Build.Player.TypeDB.GetObjectData.html)| ISerializable method
for serialization support outside of Unity's internal serialization system.  
