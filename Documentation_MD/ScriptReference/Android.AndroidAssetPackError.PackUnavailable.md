...
#  [AndroidAssetPackError](Android.AndroidAssetPackError.html).PackUnavailable
...
One possible cause of this is that the Android App Bundle file you uploaded to
the store does not include the specified Android asset pack. Additional
resources:
