...
#
[IExcludePropertyAdapter<T0,T1>](Unity.Properties.IExcludePropertyAdapter_2.html).IsExcluded
...
public bool IsExcluded(ExcludeContext<TContainer,TValue> context, ref
TContainer container, ref TValue value);
