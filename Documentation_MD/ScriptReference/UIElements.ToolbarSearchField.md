...
Inherits
from:[UIElements.SearchFieldBase_2](UIElements.SearchFieldBase_2.html)
...
A search field for the toolbar. For more information, refer to [UXML element
ToolbarSearchField](../Manual/UIE-uxml-element-ToolbarSearchField.html).
...
[ToolbarSearchField](UIElements.ToolbarSearchField-ctor.html)|  Constructor.  
---|---  
