...
#  [PlayableExtensions](Playables.PlayableExtensions.html).GetPropagateSetTime
...
Returns the time propagation behavior of this
...
By default, this is disabled. It can be used to automatically synchronize the
local time between an input and an output.
