...
#  [PlistElement](iOS.Xcode.PlistElement.html).AsReal
...
The method is equivalent to `((PlistElementReal) el).value`. Throws exception
if the element is not [PlistElementReal](iOS.Xcode.PlistElementReal.html).
    ...
    public class PlistElementAsRealExample
    {
        [PostProcessBuild]
        public static void AsRealExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
            if (buildTarget == [BuildTarget.iOS](BuildTarget.iOS.html)) 
            {
                ...
                // Retrieve an Info.plist element and convert it to "float" using the helper AsReal method
