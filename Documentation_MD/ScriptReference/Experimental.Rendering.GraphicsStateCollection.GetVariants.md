...
#
[GraphicsStateCollection](Experimental.Rendering.GraphicsStateCollection.html).GetVariants
...
Populate given list with shader variants contained in collection.
    ...
    public class GetVariantsExample : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            [Debug.Log](Debug.Log.html)("Collection contains " + variants.Count + " variants.");
        }
    }
