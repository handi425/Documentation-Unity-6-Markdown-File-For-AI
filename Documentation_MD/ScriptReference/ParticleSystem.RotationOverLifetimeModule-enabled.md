...
#
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html).enabled
...
Additional resources: [ParticleSystem.rotationOverLifetime](ParticleSystem-
rotationOverLifetime.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationOverLifetime.z = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)([Mathf.PI](Mathf.PI.html) * 2.0f, curve);  
