...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetUnityTestTargetName
...
Use the returned target name to retrieve the GUID of the target via
...
**Note** : This function can only be used in Unity-generated projects.
    ...
    public class Sample_GetUnityTestTargetName  
    {
        ...
        {  
            ...
            string testTargetName = [PBXProject.GetUnityTestTargetName](iOS.Xcode.PBXProject.GetUnityTestTargetName.html)();  
