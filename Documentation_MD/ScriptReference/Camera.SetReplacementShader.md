...
#  [Camera](Camera.html).SetReplacementShader
...
public void SetReplacementShader([Shader](Shader.html) shader, string
replacementTag);
...
After calling this function, camera will render its view with shader
replacement. Call [ResetReplacementShader](Camera.ResetReplacementShader.html)
