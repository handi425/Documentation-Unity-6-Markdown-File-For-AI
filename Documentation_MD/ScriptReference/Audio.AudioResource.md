...
Additional resources: [AudioClip](AudioClip.html), AudioRandomContainer
    ...
    // Play an [AudioClip](AudioClip.html), then an [AudioResource](Audio.AudioResource.html), through an [AudioSource](AudioSource.html).
    [[RequireComponent](RequireComponent.html)(typeof([AudioSource](AudioSource.html)))]
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        public [AudioClip](AudioClip.html) m_Clip;
        public [AudioResource](Audio.AudioResource.html) m_Resource;  
        ...
        IEnumerator Start()
        {
            ...
            yield return new [WaitForSeconds](WaitForSeconds.html)(audioSource.clip.length);  
