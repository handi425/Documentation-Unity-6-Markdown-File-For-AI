...
#
[BuiltinRenderTextureType](Rendering.BuiltinRenderTextureType.html).Reflections
...
Used by screen space reflections as a fallback, when it's not possible to get
