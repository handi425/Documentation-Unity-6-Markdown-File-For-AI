...
#  [AnimationUtility](AnimationUtility.html).SetKeyBroken
...
public static void SetKeyBroken([AnimationCurve](AnimationCurve.html) curve,
int index, bool broken);
...
The keyframe broken flag will be used by the Curve Editor to generate tangents
automatically. Changing the broken flag here will also recalculate
