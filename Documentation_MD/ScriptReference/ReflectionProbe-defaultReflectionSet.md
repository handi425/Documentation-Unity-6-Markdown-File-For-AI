...
#  [ReflectionProbe](ReflectionProbe.html).defaultReflectionSet
...
This event is now obsolete. You should instead use the
defaultReflectionTexture event. Note that mixing this callback and the new
defaultReflectionTexture event might cause the event event to be fired
