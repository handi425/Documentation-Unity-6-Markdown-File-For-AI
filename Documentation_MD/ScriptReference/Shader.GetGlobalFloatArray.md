...
#  [Shader](Shader.html).GetGlobalFloatArray
...
Gets a global float array for all shaders previously set using
[SetGlobalFloatArray](Shader.SetGlobalFloatArray.html).
