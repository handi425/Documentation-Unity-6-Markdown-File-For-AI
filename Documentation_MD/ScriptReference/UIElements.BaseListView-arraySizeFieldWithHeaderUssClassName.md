...
#
[BaseListView](UIElements.BaseListView.html).arraySizeFieldWithHeaderUssClassName
...
The USS class name for the size field of the ListView when foldout header is
enabled.
