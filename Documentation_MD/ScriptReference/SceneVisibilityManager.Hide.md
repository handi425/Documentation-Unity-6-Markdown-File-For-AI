...
#  [SceneVisibilityManager](SceneVisibilityManager.html).Hide
...
public void Hide([GameObject](GameObject.html) gameObject, bool
includeDescendants);
...
public void Hide([SceneManagement.Scene](SceneManagement.Scene.html) scene);
