...
#  [StaticEditorFlags](StaticEditorFlags.html).OccludeeStatic
...
For more information, see the documentation on [the Occlusion Culling
system](../Manual/OcclusionCulling.html).
    ...
    public class StaticEditorFlagsExample
    {
        ...
        static void CreateGameObjectAndSetStaticEditorFlags()
        {
            ...
            var flags = [StaticEditorFlags.OccludeeStatic](StaticEditorFlags.OccludeeStatic.html);
