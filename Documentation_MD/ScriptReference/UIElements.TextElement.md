...
Implements
interfaces:[IExperimentalFeatures](UIElements.IExperimentalFeatures.html),
[INotifyValueChanged<T0>](UIElements.INotifyValueChanged_1.html),
[ITextEdition](UIElements.ITextEdition.html),
[ITextElementExperimentalFeatures](UIElements.ITextElementExperimentalFeatures.html),
[ITextSelection](UIElements.ITextSelection.html)
...
Use this as the super class if you are declaring a custom VisualElement that
displays text. For example, [Button](UIElements.Button.html) or
[Label](UIElements.Label.html) use this as their base class. For more
information, refer to [UXML element TextElement](../Manual/UIE-uxml-element-
TextElement.html).
...
[TextElement](UIElements.TextElement-ctor.html)|  Initializes and returns an
instance of TextElement.  
---|---  
