...
#  [Mesh.MeshData](Mesh.MeshData.html).GetVertices
...
vertexCount.html) elements. Unity will convert vertex position data into
[Vector3](Vector3.html) format if needed. Additional resources:
[Mesh.GetVertices](Mesh.GetVertices.html),
