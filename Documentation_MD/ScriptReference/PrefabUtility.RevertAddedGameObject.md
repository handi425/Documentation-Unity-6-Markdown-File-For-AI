...
#  [PrefabUtility](PrefabUtility.html).RevertAddedGameObject
...
public static void RevertAddedGameObject([GameObject](GameObject.html)
gameObject, [InteractionMode](InteractionMode.html) action);
