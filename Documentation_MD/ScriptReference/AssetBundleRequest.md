...
Inherits from:[ResourceRequest](ResourceRequest.html)
...
Asynchronous load request from an [AssetBundle](AssetBundle.html).

Additional resources: [AsyncOperation](AsyncOperation.html).

### Properties

[allAssets](AssetBundleRequest-allAssets.html)| Asset objects with sub assets
being loaded. (Read Only)  
---|---  
[asset](AssetBundleRequest-asset.html)| Asset object being loaded (Read Only).  
...
(Read Only)  
[asset](ResourceRequest-asset.html)| Asset object being loaded (Read Only).  
