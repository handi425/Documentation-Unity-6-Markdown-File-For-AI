...
#  [PrefabUtility](PrefabUtility.html).IsPartOfAnyPrefab
...
public static bool IsPartOfAnyPrefab([Object](Object.html)
...
To check if an object is part of the Prefab’s contents in Prefab Mode, use
