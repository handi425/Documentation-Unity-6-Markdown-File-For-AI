...
Inherits from:[UIElements.ToolbarButton](UIElements.ToolbarButton.html)
...
A clickable button used with
[EditorToolbarElementAttribute](Toolbars.EditorToolbarElementAttribute.html).

### Properties

[icon](Toolbars.EditorToolbarButton-icon.html)| The icon associated with the
element.  
---|---  
[text](Toolbars.EditorToolbarButton-text.html)| The text associated with the
element.  
  
### Constructors

[EditorToolbarButton](Toolbars.EditorToolbarButton-ctor.html)| Constructor.  
---|---  
...
[ussClassName](UIElements.ToolbarButton-ussClassName.html)|  USS class name of
elements of this type.  
