...
#
[AnimatorControllerPlayable](Animations.AnimatorControllerPlayable.html).PlayInFixedTime
...
public void PlayInFixedTime(string stateName, int layer = -1, float fixedTime
= float.NegativeInfinity);

## Declaration

public void PlayInFixedTime(int stateNameHash, int layer = -1, float fixedTime
= float.NegativeInfinity);
