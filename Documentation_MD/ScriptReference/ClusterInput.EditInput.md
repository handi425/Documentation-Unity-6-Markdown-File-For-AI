...
#  [ClusterInput](ClusterInput.html).EditInput
...
public static bool EditInput(string name, string deviceName, string serverUrl,
...
This function is not able to edit persistent input entry defined at “Project
Setting > Cluster Input”.  
