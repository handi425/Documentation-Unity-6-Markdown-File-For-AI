...
#  [Application](Application.html).isEditor
...
Returns true if the game is being run from the Unity Editor; false if run from
any deployment target.
    ...
    class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            if ([Application.isEditor](Application-isEditor.html))
            {
