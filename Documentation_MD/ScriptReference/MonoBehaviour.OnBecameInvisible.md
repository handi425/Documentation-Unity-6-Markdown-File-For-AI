...
#  [MonoBehaviour](MonoBehaviour.html).OnBecameInvisible()
...
OnBecameInvisible is called when the renderer is no longer visible by any
camera.
...
OnBecameInvisible can be a co-routine, simply use the yield statement in the
