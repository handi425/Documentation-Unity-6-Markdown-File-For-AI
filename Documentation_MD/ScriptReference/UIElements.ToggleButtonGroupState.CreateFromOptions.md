...
#
[ToggleButtonGroupState](UIElements.ToggleButtonGroupState.html).CreateFromOptions
...
CreateFromOptions(IList<bool> options);
...
**ToggleButtonGroupState** a ToggleButtonGroupState created by the list of
booleans.
