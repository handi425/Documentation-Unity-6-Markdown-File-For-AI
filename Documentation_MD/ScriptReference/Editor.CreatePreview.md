...
#  [Editor](Editor.html).CreatePreview
...
CreatePreview([UIElements.VisualElement](UIElements.VisualElement.html)
...
Inside this method, you can create your own custom UIElements inspector
preview for a specific object type.  
