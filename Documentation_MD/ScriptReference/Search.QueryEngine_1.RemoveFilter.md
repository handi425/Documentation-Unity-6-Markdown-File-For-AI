...
#  [QueryEngine<T0>](Search.QueryEngine_1.html).RemoveFilter
...
public void
RemoveFilter([Search.IQueryEngineFilter](Search.IQueryEngineFilter.html)
filter);

### Parameters

filter | The filter object returned by [AddFilter](Search.QueryEngine_1.AddFilter.html).  
---|---  
