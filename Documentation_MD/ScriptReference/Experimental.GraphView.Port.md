...
Inherits
from:[Experimental.GraphView.GraphElement](Experimental.GraphView.GraphElement.html)
...
[allowMultiDrag](Experimental.GraphView.Port-allowMultiDrag.html)| When this
property is set to true, you can select multiple edges connected to this port,
and drag them all at the same time (for example, to disconnect them and
reconnect them to another port). When this property is set to false, you can
only drag one connected edge at a time.  
---|---  
[capacity](Experimental.GraphView.Port-capacity.html)| Specify how many edges
a port can have connected.  
[collapsed](Experimental.GraphView.Port-collapsed.html)| Port's collapsed
state.  
[connected](Experimental.GraphView.Port-connected.html)| Port's connected
state.  
[connections](Experimental.GraphView.Port-connections.html)| All the port's
current connections.  
[direction](Experimental.GraphView.Port-direction.html)| Port's direction.  
[disabledPortColor](Experimental.GraphView.Port-disabledPortColor.html)| The
color of the port when disabled.  
[edgeConnector](Experimental.GraphView.Port-edgeConnector.html)| Reference to
the edge connector.  
[highlight](Experimental.GraphView.Port-highlight.html)| Is the port
highlighted.  
[node](Experimental.GraphView.Port-node.html)| Port's node.  
[orientation](Experimental.GraphView.Port-orientation.html)| Port's
orientation.  
[portCapLit](Experimental.GraphView.Port-portCapLit.html)| Is the port cap lit
or not.  
[portColor](Experimental.GraphView.Port-portColor.html)| The color of the
port.  
[portName](Experimental.GraphView.Port-portName.html)| Port name.  
[portType](Experimental.GraphView.Port-portType.html)| Port type.  
[showInMiniMap](Experimental.GraphView.Port-showInMiniMap.html)| Whether the
element is shown in the minimap. For Port, this property is always set to
false.  
[source](Experimental.GraphView.Port-source.html)| Port's source.  
[visualClass](Experimental.GraphView.Port-visualClass.html)| The name of the
uss class to use to style the port.  
  
### Public Methods

[Connect](Experimental.GraphView.Port.Connect.html)| Connect and edge to the
port.  
---|---  
[ConnectTo](Experimental.GraphView.Port.ConnectTo.html)| Creates an edge
between this port and the 'other' port.  
[ContainsPoint](Experimental.GraphView.Port.ContainsPoint.html)| Check if
point is on top of port. Used for selection and hover.  
[Disconnect](Experimental.GraphView.Port.Disconnect.html)| Disconnect edge
from port.  
[DisconnectAll](Experimental.GraphView.Port.DisconnectAll.html)| Disconnect
all edges from port.  
[GetGlobalCenter](Experimental.GraphView.Port.GetGlobalCenter.html)| Get the
port's center.  
[OnStartEdgeDragging](Experimental.GraphView.Port.OnStartEdgeDragging.html)|
Called when an edge is dragged.  
[OnStopEdgeDragging](Experimental.GraphView.Port.OnStopEdgeDragging.html)|
Called when an edge dragging ends.  
  
### Protected Methods

[OnCustomStyleResolved](Experimental.GraphView.Port.OnCustomStyleResolved.html)|
Called when the custom style properties are resolved.  
---|---  
  
### Static Methods

[Create](Experimental.GraphView.Port.Create.html)| Factory method for creating
a port.  
---|---  
