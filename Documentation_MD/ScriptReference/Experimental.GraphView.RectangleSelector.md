...
[RectangleSelector](Experimental.GraphView.RectangleSelector-ctor.html)|
RectangleSelector's constructor.  
---|---  
  
### Public Methods

[ComputeAxisAlignedBound](Experimental.GraphView.RectangleSelector.ComputeAxisAlignedBound.html)|
Computer the axis-aligned bound rectangle.  
---|---  
  
### Protected Methods

[RegisterCallbacksOnTarget](Experimental.GraphView.RectangleSelector.RegisterCallbacksOnTarget.html)|
Called to register click event callbacks on the target element.  
---|---  
[UnregisterCallbacksFromTarget](Experimental.GraphView.RectangleSelector.UnregisterCallbacksFromTarget.html)|
