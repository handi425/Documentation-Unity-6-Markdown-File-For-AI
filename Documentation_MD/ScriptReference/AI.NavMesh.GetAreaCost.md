...
#  [NavMesh](AI.NavMesh.html).GetAreaCost
...
The value applies to all agents unless you the value has been customized per
agent by calling [NavMeshAgent.SetAreaCost](AI.NavMeshAgent.SetAreaCost.html).  
  
Use [GetAreaFromName](AI.NavMesh.GetAreaFromName.html) to find the area index
based on the name of the [NavMesh](AI.NavMesh.html) area type.  
