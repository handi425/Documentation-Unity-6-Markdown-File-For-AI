...
#  [Tilemap](Tilemaps.Tilemap.html).GetEditorPreviewColor
...
public [Color](Color.html) GetEditorPreviewColor([Vector3Int](Vector3Int.html)
position);
...
**Color** Color of the editor preview [Tile](Tilemaps.Tile.html) at the XYZ
coordinate.

### Description

Gets the Color of an editor preview [Tile](Tilemaps.Tile.html) given the XYZ
