...
#
[QueryEngine<T0>](Search.QueryEngine_1.html).SetFilterNestedQueryTransformer
...
public void SetFilterNestedQueryTransformer(string filterToken,
...
query.</typeparam> <typeparam name="TRhs">The type expected on the right-hand
side of the filter.</typeparam>
