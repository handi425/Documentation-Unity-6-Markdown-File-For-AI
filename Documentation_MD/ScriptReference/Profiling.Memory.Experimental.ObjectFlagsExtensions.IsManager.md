...
#
[ObjectFlagsExtensions](Profiling.Memory.Experimental.ObjectFlagsExtensions.html).IsManager
...
public static bool IsManager(ObjectFlags flags);
...
**bool** Returns true if the object associated with this ObjectFlags is a
manager.
