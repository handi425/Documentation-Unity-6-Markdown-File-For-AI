...
GraphElement that enables user to dynamically define members of a Graph (such
as fields/properties) grouped by sections (BlackboardSection).

### Properties

[addItemRequested](Experimental.GraphView.Blackboard-addItemRequested.html)|
Called when user clicks on the Add button of this Blackboard.  
---|---  
[contentContainer](Experimental.GraphView.Blackboard-contentContainer.html)|
The content container of this Blackboard.  
[editTextRequested](Experimental.GraphView.Blackboard-editTextRequested.html)|
Called when user has edited the text of this BlackboardField.  
[graphView](Experimental.GraphView.Blackboard-graphView.html)| The GraphView
that the Blackboard is attached to.  
[moveItemRequested](Experimental.GraphView.Blackboard-moveItemRequested.html)|
Called when user has dragged and dropped a BlackboardField to a new location
inside its BlackboardSection.  
[scrollable](Experimental.GraphView.Blackboard-scrollable.html)| Indicates
whether the content of this Blackboard can be vertically scrolled by user. It
is false by default.  
[selection](Experimental.GraphView.Blackboard-selection.html)| All selected
elements in the GraphView that the Blackboard is attached to.  
[subTitle](Experimental.GraphView.Blackboard-subTitle.html)| The subtitle of
this Blackboard.  
[title](Experimental.GraphView.Blackboard-title.html)| The title of this
Blackboard.  
[windowed](Experimental.GraphView.Blackboard-windowed.html)| Set to true when
the Blackboard displays in a separate window. Set to false when the Blackboard
displays in the GraphView.  
  
### Constructors

[Blackboard](Experimental.GraphView.Blackboard-ctor.html)| Constructs a
Blackboard.  
---|---  
  
### Public Methods

[AddToSelection](Experimental.GraphView.Blackboard.AddToSelection.html)| Adds
an element to the selection in the GraphView that the Blackboard is attached
to.  
---|---  
[ClearSelection](Experimental.GraphView.Blackboard.ClearSelection.html)|
Clears the selection in the GraphView that the Blackboard is attached to.  
[RemoveFromSelection](Experimental.GraphView.Blackboard.RemoveFromSelection.html)|
