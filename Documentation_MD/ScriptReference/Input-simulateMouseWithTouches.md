...
#  [Input](Input.html).simulateMouseWithTouches
...
If enabled, up to three concurrent touches are translated to state on the
respective mouse buttons (example: a two-finger tap will be equal to a right-
button mouse click).
