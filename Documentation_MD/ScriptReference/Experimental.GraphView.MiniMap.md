...
[anchored](Experimental.GraphView.MiniMap-anchored.html)| True if the MiniMap
is pinned or achored (non-movable). False if you can drag and move it around.  
---|---  
[graphView](Experimental.GraphView.MiniMap-graphView.html)| The GraphView that
the MiniMap is attached to.  
[maxHeight](Experimental.GraphView.MiniMap-maxHeight.html)| Max height.  
[maxWidth](Experimental.GraphView.MiniMap-maxWidth.html)| Max width.  
[windowed](Experimental.GraphView.MiniMap-windowed.html)| Set to true when the
MiniMap displays in a separate window. Set to false when the MiniMap displays
in the GraphView.  
[zoomFactorTextChanged](Experimental.GraphView.MiniMap-
zoomFactorTextChanged.html)| Callback for when the zoom factor text has
changed.  
  
### Constructors

[MiniMap](Experimental.GraphView.MiniMap-ctor.html)| MiniMap's constructor.  
---|---  
  
### Public Methods

[BuildContextualMenu](Experimental.GraphView.MiniMap.BuildContextualMenu.html)|
Add menu items to the MiniMap contextual menu.  
---|---  
[OnResized](Experimental.GraphView.MiniMap.OnResized.html)| Call this method
after a user has resized a MiniMap to let the MiniMap know it needs to get
updated.  
