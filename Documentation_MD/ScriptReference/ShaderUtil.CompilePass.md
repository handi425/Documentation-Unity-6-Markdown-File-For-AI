...
#  [ShaderUtil](ShaderUtil.html).CompilePass
...
public static void CompilePass([Material](Material.html) material, int pass,
bool forceSync);
...
Request the Editor to compile the Shader Variant needed for the specific pass
of the given Material.

Additional resources: :ref::IsPassCompiled,
