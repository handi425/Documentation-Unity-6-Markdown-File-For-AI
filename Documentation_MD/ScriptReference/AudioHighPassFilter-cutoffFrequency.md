...
#  [AudioHighPassFilter](AudioHighPassFilter.html).cutoffFrequency
...
Highpass cutoff frequency in hz. 10.0 to 22000.0. Default = 5000.0.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        {
            GetComponent<[AudioHighPassFilter](AudioHighPassFilter.html)>().cutoffFrequency = ([Mathf.Sin](Mathf.Sin.html)([Time.time](Time-time.html)) * 11010 + 11000);
        }
    }
