...
public UxmlAttributeNames(string fieldName, string uxmlName, Type
typeReference, params string[] obsoleteNames);
...
[UxmlAttributeNames](UIElements.UxmlAttributeNames.html).
