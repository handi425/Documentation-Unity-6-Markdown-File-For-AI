...
#  [QualitySettings](QualitySettings.html).antiAliasing
...
The value indicates the number of samples per pixel. Valid values are 0 (no
MSAA), 2, 4, and 8. If the graphics API does not support the value you
provide, it uses the next highest supported value.  
...
processing](../Manual/PostProcessingOverview.html).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            ...
            [QualitySettings.antiAliasing](QualitySettings-antiAliasing.html) = 2;
        }
    }
