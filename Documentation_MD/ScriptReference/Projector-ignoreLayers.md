...
#  [Projector](Projector.html).ignoreLayers
...
See [layer mask](../Manual/Layers.html).  
  
By default this is zero - i.e. no layers are ignored. Each set bit in
`ignoreLayers` will make this layer not affected by the projector.
