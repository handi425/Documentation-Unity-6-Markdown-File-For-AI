...
#  [ArticulationBody](ArticulationBody.html).SetJointAccelerations
...
**Obsolete** Setting joint accelerations is not supported in forward
kinematics. To have inverse dynamics take acceleration into account, use
GetJointForcesForAcceleration instead.
...
Assigns articulation body joint accelerations for the entire hierarchy of
bodies.

This sets joint accelerations in the reduced coordinate space for the entire
articulation hierarchy starting from root using the supplied list of floats.
Every joint acceleration DOF is represented by one float value, however
...
[GetJointAccelerations](ArticulationBody.GetJointAccelerations.html).
