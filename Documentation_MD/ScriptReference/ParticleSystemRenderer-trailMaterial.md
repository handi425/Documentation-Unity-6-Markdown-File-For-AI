...
#  [ParticleSystemRenderer](ParticleSystemRenderer.html).trailMaterial
...
public [Material](Material.html) trailMaterial;

### Description

Set the Material that the TrailModule uses to attach trails to particles.

Additional resources: [ParticleSystem.trails](ParticleSystem-trails.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {  
        ...
        void OnGUI() {
            ...
            hSliderValueRatio = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(55, 45, 100, 30), hSliderValueRatio, 0.0f, 1.0f);
        }
    }
