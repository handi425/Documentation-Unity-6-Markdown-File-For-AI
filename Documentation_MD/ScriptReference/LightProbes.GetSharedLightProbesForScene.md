...
#  [LightProbes](LightProbes.html).GetSharedLightProbesForScene
...
GetSharedLightProbesForScene([SceneManagement.Scene](SceneManagement.Scene.html)
scene);
...
`LightProbes` object returned by this method. You may affect all currently
loaded versions of the scene, or change the light probe data stored in
Lighting Data assets. Use
