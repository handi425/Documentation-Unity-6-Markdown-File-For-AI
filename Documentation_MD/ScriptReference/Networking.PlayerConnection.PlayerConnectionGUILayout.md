...
Use the methods in this class to automatically lay out UI elements. For manual
positioning, use the corresponding methods in
[PlayerConnectionGUI](Networking.PlayerConnection.PlayerConnectionGUI.html).

### Static Methods

[ConnectionTargetSelectionDropdown](Networking.PlayerConnection.PlayerConnectionGUILayout.ConnectionTargetSelectionDropdown.html)|
