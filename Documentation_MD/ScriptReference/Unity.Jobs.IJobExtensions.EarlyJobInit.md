...
#  [IJobExtensions](Unity.Jobs.IJobExtensions.html).EarlyJobInit
...
Unity is responsible for calling this method: don't call it yourself. When the
Jobs package is included in the project, Unity generates code to call
...
IJob&lt;MyJobType&lt;T&gt;&gt;) manually for each specialization with
