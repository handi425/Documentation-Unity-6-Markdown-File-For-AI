...
[newData](UIElements.InputEvent-newData.html)|  The new text.  
---|---  
[previousData](UIElements.InputEvent-previousData.html)|  The text before the
change occured.  
  
### Constructors

[InputEvent](UIElements.InputEvent-ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.InputEvent.Init.html)|  Resets the event members to their
initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.InputEvent.GetPooled.html)|  Gets an event from the
