...
#  [PBXProject](iOS.Xcode.PBXProject.html).BuildConfigByName
...
Returns the GUID of build configuration with the given name for the specific
target.
...
Returns Null if such configuration does not exist.
    ...
    public class Sample_BuildConfigByName  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // For example, add a Build Property
