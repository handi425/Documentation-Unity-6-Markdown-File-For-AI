...
#  [Time](Time.html).unscaledDeltaTime
...
[FixedUpdate](MonoBehaviour.FixedUpdate.html), it returns the unscaled fixed
framerate delta time.  
  
Unlike [deltaTime](Time-deltaTime.html) this value is not affected by
[timeScale](Time-timeScale.html).  
