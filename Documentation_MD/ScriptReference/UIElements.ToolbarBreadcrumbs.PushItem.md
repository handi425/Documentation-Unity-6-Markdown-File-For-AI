...
#  [ToolbarBreadcrumbs](UIElements.ToolbarBreadcrumbs.html).PushItem
...
public void PushItem(string label,
...
Adds an item to the end of the breadcrumbs, which makes that item the deepest
