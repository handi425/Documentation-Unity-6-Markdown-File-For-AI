...
#  [PaintContext](TerrainTools.PaintContext.html).Cleanup
...
`destinationRenderTexture`. When restoreRenderTexture is true, it also
restores RenderTexture.active to the value saved as _oldRenderTexture. This
