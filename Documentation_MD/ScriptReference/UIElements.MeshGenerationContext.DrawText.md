...
#  [MeshGenerationContext](UIElements.MeshGenerationContext.html).DrawText
...
public void DrawText(string text, [Vector2](Vector2.html) pos, float fontSize,
[Color](Color.html) color,
[TextCore.Text.FontAsset](TextCore.Text.FontAsset.html) font);
