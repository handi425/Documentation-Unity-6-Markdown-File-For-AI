...
#
[GraphicsTextureDescriptor](Rendering.GraphicsTextureDescriptor.html).dimension
...
Indicates type of a GraphicsTexture (2D Texture, 2D Texture array, cubemap, 3D
volume Texture, etc.).  
