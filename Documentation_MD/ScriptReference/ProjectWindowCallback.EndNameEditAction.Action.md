...
#  [EndNameEditAction](ProjectWindowCallback.EndNameEditAction.html).Action
...
Unity calls this function when the user accepts an edited name, either by
pressing the Enter key or by losing the keyboard input focus.
