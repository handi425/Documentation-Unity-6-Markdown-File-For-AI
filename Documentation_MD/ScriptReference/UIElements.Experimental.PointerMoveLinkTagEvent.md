...
[linkID](UIElements.Experimental.PointerMoveLinkTagEvent-linkID.html)|
LinkTag corresponding linkID.  
---|---  
[linkText](UIElements.Experimental.PointerMoveLinkTagEvent-linkText.html)|
LinkTag corresponding text.  
  
### Constructors

[PointerMoveLinkTagEvent](UIElements.Experimental.PointerMoveLinkTagEvent-
ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.Experimental.PointerMoveLinkTagEvent.Init.html)|  Resets the
event members to their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.Experimental.PointerMoveLinkTagEvent.GetPooled.html)|
