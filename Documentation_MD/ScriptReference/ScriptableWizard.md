...
Editor wizards are typically opened using a menu item.
    ...
    // Creates a simple wizard that lets you create a [Light](Light.html) [GameObject](GameObject.html)
    ...
    public class WizardCreateLight : [ScriptableWizard](ScriptableWizard.html)
    {
        public float range = 500;
        public [Color](Color.html) color = [Color.red](Color-red.html);  
      
        [[MenuItem](MenuItem.html)("[GameObject](GameObject.html)/Create [Light](Light.html) Wizard")]
        static void CreateWizard()
        {
            [ScriptableWizard.DisplayWizard](ScriptableWizard.DisplayWizard.html)<WizardCreateLight>("Create [Light](Light.html)", "Create", "Apply");
            //If you don't want to use the secondary button simply leave it out:
            //[ScriptableWizard.DisplayWizard](ScriptableWizard.DisplayWizard.html)<WizardCreateLight>("Create [Light](Light.html)", "Create");
        }  
      
        void OnWizardCreate()
        {
            [GameObject](GameObject.html) go = new [GameObject](GameObject.html)("New [Light](Light.html)");
            [Light](Light.html) lt = go.AddComponent<[Light](Light.html)>();
            lt.range = range;
            lt.color = color;
        }  
        ...
        {
            if ([Selection.activeTransform](Selection-activeTransform.html) != null)
            {
                [Light](Light.html) lt = Selection.activeTransform.GetComponent<[Light](Light.html)>();  
      
                if (lt != null)
                {
                    lt.color = [Color.red](Color-red.html);
                }
            }
        }
    }
