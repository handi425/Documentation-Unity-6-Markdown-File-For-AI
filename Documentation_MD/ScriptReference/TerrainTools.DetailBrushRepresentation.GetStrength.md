...
#
[DetailBrushRepresentation](TerrainTools.DetailBrushRepresentation.html).GetStrength
...
public float GetStrength([Vector2Int](Vector2Int.html) position);
...
**Note:** This method is an overloaded method using a `Vector2Int` instead of
two separate ints for position.
