...
#  [ArticulationBody](ArticulationBody.html).GetJointPositions
...
Reads back articulation body joint positions of the entire hierarchy to the
supplied list of floats .

This returns joint positions in the reduced coordinate space for the entire
articulation hierarchy starting from root to the supplied list of floats.
Every joint position DOF is represented by one float value, however depending
...
[SetJointPositions](ArticulationBody.SetJointPositions.html).
