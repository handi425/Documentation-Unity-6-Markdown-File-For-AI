...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetComputeIntParam
...
public void SetComputeIntParam([ComputeShader](ComputeShader.html)
computeShader, string name, int val);

## Declaration

public void SetComputeIntParam([ComputeShader](ComputeShader.html)
computeShader, int nameID, int val);
