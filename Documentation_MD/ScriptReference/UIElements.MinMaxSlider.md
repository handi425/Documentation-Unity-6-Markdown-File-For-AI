...
A min/max slider containing a representation of a range. For more information,
refer to [UXML element MinMaxSlider](../Manual/UIE-uxml-element-
MinMaxSlider.html).

The MinMaxSlider manages navigation events in a customized manner. The
MinMaxSlider has four navigation states:

  * Min thumb: adjusts the slider's minimum value if the [NavigationMoveEvent](UIElements.NavigationMoveEvent.html) aligns with the slider's direction.
  * Max thumb: adjusts the slider's maximum value if the [NavigationMoveEvent](UIElements.NavigationMoveEvent.html) aligns with the slider's direction.
  * Middle thumb: adjusts the slider's minimum and maximum values if the [NavigationMoveEvent](UIElements.NavigationMoveEvent.html) aligns with the slider's direction.
  * Default navigation: [NavigationMoveEvent](UIElements.NavigationMoveEvent.html) are ignored and handled by the default systems.

The MinMaxSlider cycles through the navigation states when a
[NavigationSubmitEvent](UIElements.NavigationSubmitEvent.html) is received.  
  
Additional resources: [Slider](UIElements.Slider.html)

### Static Properties

[draggerUssClassName](UIElements.MinMaxSlider-draggerUssClassName.html)|  USS
class name of dragger elements in elements of this type.  
---|---  
[inputUssClassName](UIElements.MinMaxSlider-inputUssClassName.html)|  USS
class name of input elements in elements of this type.  
[labelUssClassName](UIElements.MinMaxSlider-labelUssClassName.html)|  USS
class name of labels in elements of this type.  
[maxThumbUssClassName](UIElements.MinMaxSlider-maxThumbUssClassName.html)|
USS class name of the maximum thumb elements in elements of this type.  
[minThumbUssClassName](UIElements.MinMaxSlider-minThumbUssClassName.html)|
USS class name of the minimum thumb elements in elements of this type.  
[movableUssClassName](UIElements.MinMaxSlider-movableUssClassName.html)|  USS
class name of the element that is currently controlled by NavigationMoveEvent.
When a NavigationSubmitEvent is received the slider cycles through the
elements in the following order: 1\. Minimum thumb. 2\. Maximum thumb. 3\.
Middle bar. 4\. None (Default Navigation behavior).  
[trackerUssClassName](UIElements.MinMaxSlider-trackerUssClassName.html)|  USS
class name of tracker elements in elements of this type.  
[ussClassName](UIElements.MinMaxSlider-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[highLimit](UIElements.MinMaxSlider-highLimit.html)|  This is the high limit
of the slider.  
---|---  
[lowLimit](UIElements.MinMaxSlider-lowLimit.html)|  This is the low limit of
the slider.  
[maxValue](UIElements.MinMaxSlider-maxValue.html)|  This is the high value of
the range represented on the slider.  
[minValue](UIElements.MinMaxSlider-minValue.html)|  This is the low value of
the range represented on the slider.  
[range](UIElements.MinMaxSlider-range.html)|  Returns the range of the
low/high limits of the slider.  
[value](UIElements.MinMaxSlider-value.html)|  This is the value of the slider.
This is a Vector2 where the x is the lower bound and the y is the higher
bound.  
  
### Constructors

[MinMaxSlider](UIElements.MinMaxSlider-ctor.html)|  Constructor.  
---|---  
