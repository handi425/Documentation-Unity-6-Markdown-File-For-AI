...
A button that executes an action repeatedly while it is pressed. For more
information, refer to [UXML element RepeatButton](../Manual/UIE-uxml-element-
RepeatButton.html).

### Static Properties

[ussClassName](UIElements.RepeatButton-ussClassName.html)|  USS class name of
elements of this type.  
---|---  
  
### Constructors

[RepeatButton](UIElements.RepeatButton-ctor.html)|  Constructor.  
---|---  
  
### Public Methods

[SetAction](UIElements.RepeatButton.SetAction.html)|  Set the action that
should be executed when the button is pressed.  
---|---  
