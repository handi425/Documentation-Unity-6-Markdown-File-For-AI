...
Inherits
from:[UIElements.DragAndDropEventBase_1](UIElements.DragAndDropEventBase_1.html)
...
Use the DragEnterEvent class to manage events that occur when dragging enters
an element or one of its descendants. The DragEnterEvent does not trickle down
and does not bubble up.

### Constructors

[DragEnterEvent](UIElements.DragEnterEvent-ctor.html)|  Constructor. Avoid
renewing events. Instead, use GetPooled() to get an event from a pool of
reusable events.  
---|---  
  
### Protected Methods

[Init](UIElements.DragEnterEvent.Init.html)|  Resets the event members to
