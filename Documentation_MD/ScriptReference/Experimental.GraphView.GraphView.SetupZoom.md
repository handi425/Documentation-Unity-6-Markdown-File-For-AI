...
#  [GraphView](Experimental.GraphView.GraphView.html).SetupZoom
...
public void SetupZoom(float minScaleSetup, float maxScaleSetup, float
scaleStepSetup, float referenceScaleSetup);
