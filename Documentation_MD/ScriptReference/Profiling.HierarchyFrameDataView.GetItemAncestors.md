...
#
[HierarchyFrameDataView](Profiling.HierarchyFrameDataView.html).GetItemAncestors
...
The result is written to _outAncestors_ list which is resized if necessary.
The list contains identifiers of item parents in bottom-up order.  
  
Additional resources:
[TreeView.GetAncestors](IMGUI.Controls.TreeView.GetAncestors.html).
