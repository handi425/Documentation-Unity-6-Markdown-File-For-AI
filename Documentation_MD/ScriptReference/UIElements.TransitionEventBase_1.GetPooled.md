...
#  [TransitionEventBase<T0>](UIElements.TransitionEventBase_1.html).GetPooled
...
public static T
GetPooled([UIElements.StylePropertyName](UIElements.StylePropertyName.html)
stylePropertyName, double elapsedTime);
