...
Transitions define when and how the state machine switch from on state to
another. AnimatorTransition always originate from a StateMachine or a
StateMachine entry. They do not define timing parameters.

A transition happens when all its conditions are met.

### Constructors

[AnimatorTransition](Animations.AnimatorTransition-ctor.html)| Creates a new
animator transition.  
---|---  
