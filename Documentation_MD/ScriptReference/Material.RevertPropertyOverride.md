...
#  [Material](Material.html).RevertPropertyOverride
...
After the Editor reverts a Property override, it no longer marks that Property
as overriden. That Property now inherits its value from the parent. Note that
this method is Editor-only.  
  
Additional resources:
[Material.IsPropertyOverriden](Material.IsPropertyOverriden.html),
[Material.ApplyPropertyOverride](Material.ApplyPropertyOverride.html).
