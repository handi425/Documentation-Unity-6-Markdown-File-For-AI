...
Inherits
from:[UIElements.AbstractProgressBar](UIElements.AbstractProgressBar.html)
...
For more information, refer to [UXML element ProgressBar](../Manual/UIE-uxml-
element-ProgressBar.html).

    
    
     public [ProgressBar](UIElements.ProgressBar.html) CreateProgressBar()
     {
         var progressBar = new [ProgressBar](UIElements.ProgressBar.html)
         {
             title = "[Progress](Progress.html)",
             lowValue = 0f,
             highValue = 100f,
             value = 0f
         };  
...
[backgroundUssClassName](UIElements.AbstractProgressBar-
backgroundUssClassName.html)|  USS Class Name used to style the background of
the ProgressBar.  
---|---  
[containerUssClassName](UIElements.AbstractProgressBar-
containerUssClassName.html)|  USS Class Name used to style the container of
the ProgressBar.  
[progressUssClassName](UIElements.AbstractProgressBar-
progressUssClassName.html)|  USS Class Name used to style the progress bar of
the ProgressBar.  
[titleContainerUssClassName](UIElements.AbstractProgressBar-
titleContainerUssClassName.html)|  USS Class Name used to style the container
of the title of the ProgressBar.  
[titleUssClassName](UIElements.AbstractProgressBar-titleUssClassName.html)|
USS Class Name used to style the title of the ProgressBar.  
[ussClassName](UIElements.AbstractProgressBar-ussClassName.html)|  USS Class
Name used to style the ProgressBar.  
[disabledUssClassName](UIElements.VisualElement-disabledUssClassName.html)|
USS class name of local disabled elements.  
  
### Properties

[highValue](UIElements.AbstractProgressBar-highValue.html)|  Sets the maximum
value of the ProgressBar.  
---|---  
[lowValue](UIElements.AbstractProgressBar-lowValue.html)|  Sets the minimum
value of the ProgressBar.  
[title](UIElements.AbstractProgressBar-title.html)|  Sets the title of the
ProgressBar that displays in the center of the control.  
[value](UIElements.AbstractProgressBar-value.html)|  Sets the progress value.
...
[SetValueWithoutNotify](UIElements.AbstractProgressBar.SetValueWithoutNotify.html)|
