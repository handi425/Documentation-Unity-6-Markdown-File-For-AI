...
Inherits
from:[UIElements.TransitionEventBase_1](UIElements.TransitionEventBase_1.html)
...
Event sent at the completion of the transition. In the case where a transition
is removed before completion then the event will not fire.
