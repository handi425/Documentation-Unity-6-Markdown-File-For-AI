...
#  [StandaloneBuildSubtarget](StandaloneBuildSubtarget.html).Server
...
He application output compiles the standalone player based on the following
target platforms:  
  
**Mac player:** Compiled as a standard console application.  
  
**Win Player:** Compiled with /System:Console and runs as a standard windows
console application.  
