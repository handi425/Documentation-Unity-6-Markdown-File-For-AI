...
#  [RenderTexture](RenderTexture.html).graphicsFormat
...
The color format of the render texture. You can set the color format to None
to achieve depth-only rendering.
