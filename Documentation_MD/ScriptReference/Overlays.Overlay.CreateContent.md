...
#  [Overlay](Overlays.Overlay.html).CreateContent
...
CreateContent([Overlays.Layout](Overlays.Layout.html) requestedLayout);
...
If the requestedLayout cannot be used, then the system uses another layout. If
the layout is not able to be created, the default Panel layout content is
returned.
