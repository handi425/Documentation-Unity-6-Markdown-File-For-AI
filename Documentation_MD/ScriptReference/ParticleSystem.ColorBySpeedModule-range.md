...
#
[ParticleSystem.ColorBySpeedModule](ParticleSystem.ColorBySpeedModule.html).range
...
[ParticleSystem.ColorBySpeedModule.color](ParticleSystem.ColorBySpeedModule-
color.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            colorBySpeed.range = new [Vector2](Vector2.html)(1.0f, 5.0f);
        }  
