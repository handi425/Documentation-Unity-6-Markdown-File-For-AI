...
For more information about the element, see Android's documentation: [Queries
element](https://developer.android.com/guide/topics/manifest/queries-element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.Queries.Attributes.html)| The
attributes container for the <queries> element.  
---|---  
[IntentList](Unity.Android.Gradle.Manifest.Queries.IntentList.html)| List of
<intent> child elements.  
[PackageList](Unity.Android.Gradle.Manifest.Queries.PackageList.html)| List of
<package> child elements.  
[ProviderList](Unity.Android.Gradle.Manifest.Queries.ProviderList.html)| List
of <provider> child elements.  
  
### Constructors

[Queries](Unity.Android.Gradle.Manifest.Queries-ctor.html)| Element
constructor.  
---|---  
