...
#  [LightingSettings](LightingSettings.html).filteringGaussianRadiusIndirect
...
public float filteringGaussianRadiusIndirect;

### Description

Specifies the method that the Progressive Lightmapper uses to reduce noise in
