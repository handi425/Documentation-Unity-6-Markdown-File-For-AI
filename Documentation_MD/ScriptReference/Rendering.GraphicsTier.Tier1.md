...
#  [GraphicsTier](Rendering.GraphicsTier.html).Tier1
...
For information on which devices this graphics tier corresponds to, and how to
work with graphics tiers, see [Graphics tiers](../Manual/graphics-tiers.html).  
