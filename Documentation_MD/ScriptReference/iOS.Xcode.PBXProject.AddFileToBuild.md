...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddFileToBuild
...
In projects containing multiple native targets, you can configure a single
file or folder reference to build in all, some, or none of the targets. The
file or folder reference is added to appropriate build section depending on
the file extension.
    ...
    public class Sample_AddFileToBuild  
    {
        [PostProcessBuild]
