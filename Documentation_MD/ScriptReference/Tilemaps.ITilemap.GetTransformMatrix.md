...
#  [ITilemap](Tilemaps.ITilemap.html).GetTransformMatrix
...
GetTransformMatrix([Vector3Int](Vector3Int.html) position);
...
Gets the transform matrix of a Tile given the XYZ coordinates of a cell in the
Tilemap.
