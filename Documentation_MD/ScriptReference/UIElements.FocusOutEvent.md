...
Inherits from:[UIElements.FocusEventBase_1](UIElements.FocusEventBase_1.html)
...
Event sent immediately before an element loses focus. This event trickles down
and bubbles up.

### Constructors

[FocusOutEvent](UIElements.FocusOutEvent-ctor.html)|  Constructor. Avoid
...
[Init](UIElements.FocusOutEvent.Init.html)|  Resets the event members to their
initial values.  
---|---  
...
[direction](UIElements.FocusEventBase_1-direction.html)|  Direction of the
focus change.  
[focusController](UIElements.FocusEventBase_1-focusController.html)|  The
focus controller that emitted the event.  
[relatedTarget](UIElements.FocusEventBase_1-relatedTarget.html)|  For FocusOut
and Blur events, contains the element that gains the focus. For FocusIn and
...
event instance.  
[GetPooled](UIElements.FocusEventBase_1.GetPooled.html)|  Gets an event from
