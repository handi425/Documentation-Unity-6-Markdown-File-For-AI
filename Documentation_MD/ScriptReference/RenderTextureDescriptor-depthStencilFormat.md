...
#  [RenderTextureDescriptor](RenderTextureDescriptor.html).depthStencilFormat
...
A RenderTexture can use a different but compatible format if the format is not
supported on this platform or graphics API. See Also:
