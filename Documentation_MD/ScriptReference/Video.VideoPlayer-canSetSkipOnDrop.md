...
#  [VideoPlayer](Video.VideoPlayer.html).canSetSkipOnDrop
...
When `true`, the value of [VideoPlayer.skipOnDrop](Video.VideoPlayer-
skipOnDrop.html) can be changed. When `false`, the value cannot be changed.
