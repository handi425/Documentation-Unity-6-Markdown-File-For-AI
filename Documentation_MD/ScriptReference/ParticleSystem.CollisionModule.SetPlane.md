...
#
[ParticleSystem.CollisionModule](ParticleSystem.CollisionModule.html).SetPlane
...
public void SetPlane(int index, [Transform](Transform.html) transform);
...
If the index is greater than the number of planes currently assigned to the
