...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddFrameworksBuildPhase
...
If the frameworks build phase is already configured for the target, the
function returns the existing phase.  
  
The new phase is placed at the end of the list of build phases configured for
the target.
    ...
    public class Sample_AddFrameworksBuildPhase  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get GUID of the target you want to add the Framework Build Phase to
            string mainTargetGuid = pbxProject.GetUnityMainTargetGuid();  
      
            // Add the Framework Build Phase. Note that if this phase already exists, the function doesn't create a new one and returns GUID to the existing phase
            pbxProject.AddFrameworksBuildPhase(mainTargetGuid);  
