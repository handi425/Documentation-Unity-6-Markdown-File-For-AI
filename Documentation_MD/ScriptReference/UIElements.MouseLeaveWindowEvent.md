...
Event sent when the mouse pointer exits a window. The event bubbles up but
does not trickle down.

### Constructors

[MouseLeaveWindowEvent](UIElements.MouseLeaveWindowEvent-ctor.html)|
...
[Init](UIElements.MouseLeaveWindowEvent.Init.html)|  Resets the event members
to their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.MouseLeaveWindowEvent.GetPooled.html)|  Gets an event
