...
VisualElement that draws the edge lines and detects if mouse is on top of
edge.

### Static Properties

[k_MinEdgeWidth](Experimental.GraphView.EdgeControl-k_MinEdgeWidth.html)| Min
edge width.  
---|---  
  
### Properties

[capRadius](Experimental.GraphView.EdgeControl-capRadius.html)| Radius of the
edge's end caps.  
---|---  
[controlPoints](Experimental.GraphView.EdgeControl-controlPoints.html)| Edge's
control points.  
[drawFromCap](Experimental.GraphView.EdgeControl-drawFromCap.html)| Whether or
not to draw the From Cap.  
[drawToCap](Experimental.GraphView.EdgeControl-drawToCap.html)| Whether or not
to draw the To Cap.  
[edgeWidth](Experimental.GraphView.EdgeControl-edgeWidth.html)| Edge's visible
width.  
[from](Experimental.GraphView.EdgeControl-from.html)| Edge's From postion.  
[fromCapColor](Experimental.GraphView.EdgeControl-fromCapColor.html)| The
color of the cap color at the "from" end of the edge.  
[inputColor](Experimental.GraphView.EdgeControl-inputColor.html)| Color on the
edge's input.  
[inputOrientation](Experimental.GraphView.EdgeControl-inputOrientation.html)|
Edge input port orientation (vertical/horizontal).  
[interceptWidth](Experimental.GraphView.EdgeControl-interceptWidth.html)|
Width that will be used for mouse hit detection.  
[outputColor](Experimental.GraphView.EdgeControl-outputColor.html)| Color on
the edge's output.  
[outputOrientation](Experimental.GraphView.EdgeControl-
outputOrientation.html)| Edge output port orientation (vertical/horizontal).  
[to](Experimental.GraphView.EdgeControl-to.html)| Edge's To postion.  
[toCapColor](Experimental.GraphView.EdgeControl-toCapColor.html)| The color of
the cap color at the "to" end of the edge.  
  
### Constructors

[EdgeControl](Experimental.GraphView.EdgeControl-ctor.html)| EdgeControl's
constructor.  
---|---  
  
### Public Methods

[ContainsPoint](Experimental.GraphView.EdgeControl.ContainsPoint.html)| Check
if point is on top of edge.  
---|---  
[Overlaps](Experimental.GraphView.EdgeControl.Overlaps.html)| Check if edge
overlaps rectangle.  
[UpdateLayout](Experimental.GraphView.EdgeControl.UpdateLayout.html)| Update
the edge layout.  
  
### Protected Methods

[ComputeControlPoints](Experimental.GraphView.EdgeControl.ComputeControlPoints.html)|
Compute the edge's control points.  
---|---  
[PointsChanged](Experimental.GraphView.EdgeControl.PointsChanged.html)| Check
if the edge points have changed.  
[UpdateRenderPoints](Experimental.GraphView.EdgeControl.UpdateRenderPoints.html)|
