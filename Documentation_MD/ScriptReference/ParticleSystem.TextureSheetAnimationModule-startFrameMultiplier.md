...
#
[ParticleSystem.TextureSheetAnimationModule](ParticleSystem.TextureSheetAnimationModule.html).startFrameMultiplier
...
you only want to change the overall start frame multiplier.
