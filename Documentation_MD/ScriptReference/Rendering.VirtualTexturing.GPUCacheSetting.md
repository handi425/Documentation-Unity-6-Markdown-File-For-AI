...
[format](Rendering.VirtualTexturing.GPUCacheSetting-format.html)| Format of
the cache these settings are applied to.  
---|---  
[sizeInMegaBytes](Rendering.VirtualTexturing.GPUCacheSetting-
sizeInMegaBytes.html)| Size in MegaBytes of the cache created with these
settings.  
