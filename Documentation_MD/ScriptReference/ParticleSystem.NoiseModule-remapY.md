...
#  [ParticleSystem.NoiseModule](ParticleSystem.NoiseModule.html).remapY
...
public [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html) remapY;

### Description

Define how the noise values are remapped on the y-axis, when using the
