...
#  [SearchUtils](Search.SearchUtils.html).ShowIconPicker
...
In example, this API is used to select search query icons. This API try to
filter out texture that would be suitable as an icon.
