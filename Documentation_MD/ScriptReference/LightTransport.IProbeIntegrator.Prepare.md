...
#  [IProbeIntegrator](LightTransport.IProbeIntegrator.html).Prepare
...
public void
Prepare([LightTransport.IDeviceContext](LightTransport.IDeviceContext.html)
context, [LightTransport.IWorld](LightTransport.IWorld.html) world,
BufferSlice<Vector3> positions, float pushoff, int bounceCount);
...
The preparation can take a significant time if the world is large or shaders
are not written to cache yet.
