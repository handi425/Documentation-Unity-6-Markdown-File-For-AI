...
This channel is also commonly called "UV4". It maps to the shader semantic
`TEXCOORD4`. When you call
[Mesh.HasVertexAttribute](Mesh.HasVertexAttribute.html), this channel
corresponds to
[VertexAttribute.TexCoord4](Rendering.VertexAttribute.TexCoord4.html).  
