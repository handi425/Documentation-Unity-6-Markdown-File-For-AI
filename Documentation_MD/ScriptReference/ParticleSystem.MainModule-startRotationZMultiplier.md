...
#
[ParticleSystem.MainModule](ParticleSystem.MainModule.html).startRotationZMultiplier
...
The initial rotation multiplier of particles around the z-axis when the
