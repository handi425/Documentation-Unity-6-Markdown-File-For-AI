...
#  [Material](Material.html).SetPropertyLock
...
this Material will be unable to change the value of the property. Note that
this method is Editor-only.  
  
Additional resources: Material.GetPropertyLock,
[Material.IsPropertyLockedByAncestor](Material.IsPropertyLockedByAncestor.html).
