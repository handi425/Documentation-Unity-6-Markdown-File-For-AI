...
#  [MouseCursor](MouseCursor.html).SplitResizeUpDown
...
Up-Down resize arrows for window splitters.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.SplitResizeUpDown](MouseCursor.SplitResizeUpDown.html));
        }
    }
