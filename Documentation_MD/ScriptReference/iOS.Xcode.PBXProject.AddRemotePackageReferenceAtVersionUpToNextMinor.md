...
#
[PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageReferenceAtVersionUpToNextMinor
...
public string AddRemotePackageReferenceAtVersionUpToNextMinor(string url,
string version);
...
up to the next minor version.
    ...
    public class Sample_AddRemotePackageReferenceAtVersionUpToNextMinor  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) using the URL and minor version
            string packageGuid = pbxProject.AddRemotePackageReferenceAtVersionUpToNextMinor("https://github.com/apple/swift-system.git", "1.2.0");  
