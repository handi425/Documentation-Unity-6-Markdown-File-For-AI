...
#  [PlayerSettings](PlayerSettings.html).SetArchitecture
...
public static void
SetArchitecture([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget, int architecture);

**Obsolete** Use SetArchitecture(NamedBuildTarget buildTarget, int
architecture) instead.

## Declaration

public static void SetArchitecture([BuildTargetGroup](BuildTargetGroup.html)
targetGroup, int architecture);
