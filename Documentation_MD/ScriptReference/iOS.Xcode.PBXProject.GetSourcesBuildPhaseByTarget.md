...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetSourcesBuildPhaseByTarget
...
**string** Returns the GUID of the existing phase or `null` if it does not
exist.
...
Returns the GUID of sources build phase for the given target.
    ...
    public class Sample_GetSourcesBuildPhaseByTarget  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the "Sources Build" build phase GUID 
            string sourcesBuildPhase = pbxProject.GetSourcesBuildPhaseByTarget(targetGuid);  
      
            // Log the "Sources Build" phase GUID for debugging
            [Debug.Log](Debug.Log.html)("'Sources Build' phase GUID: " + sourcesBuildPhase);
        }
    }
