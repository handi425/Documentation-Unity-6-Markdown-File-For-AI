...
[DependencyResolutionManagement](Unity.Android.Gradle.GradleSettingsFile.DependencyResolutionManagement.html)|
The C# definition of the dependencyResolutionManagement element in a gradle
file.  
---|---  
[IncludeList](Unity.Android.Gradle.GradleSettingsFile.IncludeList.html)| The
C# definition of a list of include element in a gradle file.  
[PluginManagement](Unity.Android.Gradle.GradleSettingsFile.PluginManagement.html)|
The C# definition of the pluginManagement element in a settings.gradle file.  
  
### Constructors

[GradleSettingsFile](Unity.Android.Gradle.GradleSettingsFile-ctor.html)|
Element constructor.  
---|---  
