...
For more information about the element, see Android's documentation: [Category
element](https://developer.android.com/guide/topics/manifest/category-element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.Category.Attributes.html)| The
attributes container for the <category> element.  
---|---  
  
### Constructors

[Category](Unity.Android.Gradle.Manifest.Category-ctor.html)| Element
constructor.  
---|---  
