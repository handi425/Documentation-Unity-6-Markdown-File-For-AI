...
#  [ParticleSystem](ParticleSystem.html).colorBySpeed
...
public
[ParticleSystem.ColorBySpeedModule](ParticleSystem.ColorBySpeedModule.html)
colorBySpeed;
...
This module assigns colors to the particles based on the speed that they are
travelling.  
