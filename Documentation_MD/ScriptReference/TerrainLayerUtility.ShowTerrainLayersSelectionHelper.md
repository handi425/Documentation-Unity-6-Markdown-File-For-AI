...
#
[TerrainLayerUtility](TerrainLayerUtility.html).ShowTerrainLayersSelectionHelper
...
public static int ShowTerrainLayersSelectionHelper([Terrain](Terrain.html)
terrain, int activeTerrainLayer);
