...
#  [ParticleSystem](ParticleSystem.html).rotationOverLifetime
...
public
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html)
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            [AnimationCurve](AnimationCurve.html) curve2 = new [AnimationCurve](AnimationCurve.html)();
            curve2.AddKey(0.0f, 0.2f);
            curve2.AddKey(0.5f, 0.9f);  
      
            rot.z = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(2.0f, curve, curve2);
        }
    }
