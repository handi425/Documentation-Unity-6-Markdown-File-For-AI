...
[Equals](Unity.Android.Gradle.Manifest.AttributeString.Equals.html)|
Determines if this string and specified string have the same values.  
---|---  
[EqualsTrue](Unity.Android.Gradle.Manifest.AttributeString.EqualsTrue.html)|
Determines if this string is equal to true.  
[Get](Unity.Android.Gradle.Manifest.AttributeString.Get.html)| Gets the value
of the string attribute.  
[Set](Unity.Android.Gradle.Manifest.AttributeString.Set.html)| Sets a new
