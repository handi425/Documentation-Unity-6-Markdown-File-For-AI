...
#  [MouseCursor](MouseCursor.html).ArrowMinus
...
Arrow with the minus symbol next to it.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.ArrowMinus](MouseCursor.ArrowMinus.html));
        }
    }
