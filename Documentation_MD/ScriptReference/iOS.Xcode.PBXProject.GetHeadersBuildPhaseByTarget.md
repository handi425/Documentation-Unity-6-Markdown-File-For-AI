...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetHeadersBuildPhaseByTarget
...
Returns the GUID of the headers build phase for the given target.
    ...
    public class Sample_GetHeadersBuildPhaseByTarget  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the "Headers Build" build phase GUID 
            string headersBuildPhase = pbxProject.GetHeadersBuildPhaseByTarget(targetGuid);  
      
            // Log the "Headers Build" phase GUID for debugging
            [Debug.Log](Debug.Log.html)("'Headers Build' phase GUID: " + headersBuildPhase);
        }
    }
