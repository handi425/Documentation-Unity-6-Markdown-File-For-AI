...
[Button](UIElements.Button.html) elements.

The ToggleButtonGroup has a label and a group of interactable
[Button](UIElements.Button.html) elements.  
  
To create buttons, add [Button](UIElements.Button.html) elements directly to
the ToggleButtonGroup. This will automatically style and configure the button
to work properly.

### Static Properties

[buttonClassName](UIElements.ToggleButtonGroup-buttonClassName.html)|  USS
class name for any Buttons in the group.  
---|---  
[buttonGroupClassName](UIElements.ToggleButtonGroup-
buttonGroupClassName.html)|  USS class name of container element of this type.  
[buttonLeftClassName](UIElements.ToggleButtonGroup-buttonLeftClassName.html)|
USS class name for the leftmost Button in the group.  
[buttonMidClassName](UIElements.ToggleButtonGroup-buttonMidClassName.html)|
USS class name for any Buttons in the middle of the group.  
[buttonRightClassName](UIElements.ToggleButtonGroup-
buttonRightClassName.html)|  USS class name for the rightmost Button in the
group.  
[buttonStandaloneClassName](UIElements.ToggleButtonGroup-
buttonStandaloneClassName.html)|  USS class name for the Button if only one is
available in the group.  
[containerUssClassName](UIElements.ToggleButtonGroup-
containerUssClassName.html)|  USS class name of container element of this
type.  
[emptyStateLabelClassName](UIElements.ToggleButtonGroup-
emptyStateLabelClassName.html)|  USS class name for empty state label.  
[ussClassName](UIElements.ToggleButtonGroup-ussClassName.html)|  USS class
name of elements for this type.  
  
### Properties

[allowEmptySelection](UIElements.ToggleButtonGroup-allowEmptySelection.html)|
Allows having all buttons to be unchecked when set to true.  
---|---  
[isMultipleSelection](UIElements.ToggleButtonGroup-isMultipleSelection.html)|
Whether all buttons can be selected.  
  
### Constructors

[ToggleButtonGroup](UIElements.ToggleButtonGroup-ctor.html)|  Constructs a
ToggleButtonGroup.  
---|---  
  
### Public Methods

[SetValueWithoutNotify](UIElements.ToggleButtonGroup.SetValueWithoutNotify.html)|
