...
#  [PlistElementDict](iOS.Xcode.PlistElementDict.html).SetString
...
Convenience method to set a string property.
    ...
    public class PlistSetStringExample
    {
        [PostProcessBuild]
        public static void SetStringExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
            if (buildTarget == [BuildTarget.iOS](BuildTarget.iOS.html)) 
            {
                ...
                rootDict.SetString("CFBundleVersion","7.6.5");  
      
                // Use SetString to create a new Info.plist entry called "ExampleString" with "Hello, World!" as the value
