...
#
[BatchCullingOutputDrawCommands](Rendering.BatchCullingOutputDrawCommands.html).drawRanges
...
Each draw range covers a continuous range of draw commands in the
[BatchCullingOutputDrawCommands.drawCommands](Rendering.BatchCullingOutputDrawCommands-
drawCommands.html) array, and the settings in the
[BatchDrawRange](Rendering.BatchDrawRange.html) struct apply to all of them.
You must populate this with at least one draw range, but you can use more if
necessary.  
