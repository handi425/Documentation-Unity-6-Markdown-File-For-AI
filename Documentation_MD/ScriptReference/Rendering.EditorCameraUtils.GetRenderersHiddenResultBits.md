...
#
[EditorCameraUtils](Rendering.EditorCameraUtils.html).GetRenderersHiddenResultBits
...
public static void GetRenderersHiddenResultBits(ReadOnlySpan<int> rendererIDs,
Span<ulong> resultBits);

### Parameters

rendererIDs | The span of renderer [instance IDs](Object.GetInstanceID.html) to check.  
---|---  
...
Refer to [SceneVisibility](../Manual/SceneVisibility.html) for more
information about scene visibility.
