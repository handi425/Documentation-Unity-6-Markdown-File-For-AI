...
public QueryParameters(int layerMask, bool hitMultipleFaces,
[QueryTriggerInteraction](QueryTriggerInteraction.html) hitTriggers, bool
hitBackfaces);
...
Struct used to set up parameters for queries:
