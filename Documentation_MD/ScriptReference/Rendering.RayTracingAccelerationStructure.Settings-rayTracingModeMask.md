...
#
[RayTracingAccelerationStructure.Settings](Rendering.RayTracingAccelerationStructure.Settings.html).rayTracingModeMask
...
An enum that determines the
[RayTracingMode](Experimental.Rendering.RayTracingMode.html)s a
[Renderer](Renderer.html) must have in order to add it to the
