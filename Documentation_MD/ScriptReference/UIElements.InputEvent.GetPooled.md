...
#  [InputEvent](UIElements.InputEvent.html).GetPooled
...
public static [UIElements.InputEvent](UIElements.InputEvent.html)
GetPooled(string previousData, string newData);
