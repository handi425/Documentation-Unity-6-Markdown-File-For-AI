...
Container for holding information about lighting information being used in a
build.

This struct helps ensure the correct Shared Variants and Mesh Channels are
included in the build correctly.  
...
[operator |=](Build.Content.BuildUsageTagGlobal-operator_bitwiseor.html)|
Combines the usage data from another BuildUsageTagGlobal with this
BuildUsageTagGlobal.  
---|---  
