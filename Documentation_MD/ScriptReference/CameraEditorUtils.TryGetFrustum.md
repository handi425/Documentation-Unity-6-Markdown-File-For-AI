...
#  [CameraEditorUtils](CameraEditorUtils.html).TryGetFrustum
...
public static bool TryGetFrustum([Camera](Camera.html) camera, Vector3[] near,
Vector3[] far, out float frustumAspect);
