...
#  [Rigidbody](Rigidbody.html).angularDamping
...
Angular damping can be used to slow down the rotation of an object. The higher
the damping the more the rotation slows down.
