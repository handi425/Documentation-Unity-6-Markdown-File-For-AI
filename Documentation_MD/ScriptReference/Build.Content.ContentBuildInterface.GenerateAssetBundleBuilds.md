...
#
[ContentBuildInterface](Build.Content.ContentBuildInterface.html).GenerateAssetBundleBuilds
...
This API does not generate a build, instead it is a convenient function to
populate the build definition into the format expected by some signatures of
[BuildPipeline.BuildAssetBundles](BuildPipeline.BuildAssetBundles.html), or
the Scriptable Build Pipeline.  
  
Additional resources:
[BuildPipeline.BuildAssetBundles](BuildPipeline.BuildAssetBundles.html),
[AssetDatabase.GetAllAssetBundleNames](AssetDatabase.GetAllAssetBundleNames.html),
