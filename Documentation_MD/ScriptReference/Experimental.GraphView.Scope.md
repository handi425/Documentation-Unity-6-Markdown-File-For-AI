...
This class allows for nodes to be grouped into a common area, or Scope. This
class includes methods that automatically resize and position the Scope to
encompass the group of nodes.
...
[Scope](Experimental.GraphView.Scope-ctor.html)| Scope constructor.  
---|---  
  
### Public Methods

[AcceptsElement](Experimental.GraphView.Scope.AcceptsElement.html)| Whether
the GraphElement can be added to this scope.  
---|---  
...
[OnElementsAdded](Experimental.GraphView.Scope.OnElementsAdded.html)| Called
when GraphElements are added to the Scope.  
---|---  
[OnElementsRemoved](Experimental.GraphView.Scope.OnElementsRemoved.html)|
