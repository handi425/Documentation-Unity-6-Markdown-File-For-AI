...
public static [Color](Color.html) cyan;
...
Cyan. RGBA is (0, 1, 1, 1).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        //Run your mouse over the [GameObject](GameObject.html) to change the [Renderer](Renderer.html)'s material color to cyan
        void OnMouseOver()
        {
            m_Renderer.material.color = [Color.cyan](Color-cyan.html);
        }  
