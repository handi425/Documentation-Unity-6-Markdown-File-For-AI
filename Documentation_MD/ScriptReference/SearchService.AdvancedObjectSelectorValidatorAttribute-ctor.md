...
selector validator. If the identifier is not unique, the advanced object
selector validator is not registered and a warning is displayed in the
console. The same identifier must be used by the attribute
[AdvancedObjectSelectorAttribute](SearchService.AdvancedObjectSelectorAttribute.html)
to properly register an advanced object selector.
