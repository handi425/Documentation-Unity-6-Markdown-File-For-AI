...
development lifecycle. For more information about the element, see Android's
documentation:
[buildType](https://developer.android.com/reference/tools/gradle-
api/com/android/build/api/dsl/BuildType)

### Properties

[Debuggable](Unity.Android.Gradle.BuildType.Debuggable.html)| The C#
definition of the debuggable property.  
---|---  
[JniDebuggable](Unity.Android.Gradle.BuildType.JniDebuggable.html)| The C#
definition of the jniDebuggable property.  
[MinifyEnabled](Unity.Android.Gradle.BuildType.MinifyEnabled.html)| The C#
definition of the minifyEnabled property.  
[ProguardFiles](Unity.Android.Gradle.BuildType.ProguardFiles.html)| The C#
definition of the proguardFiles property.  
[SigningConfig](Unity.Android.Gradle.BuildType.SigningConfig.html)| The C#
definition of the signingConfigs child elements in a gradle file.  
  
### Constructors

[BuildType](Unity.Android.Gradle.BuildType-ctor.html)| Element constructor.  
---|---  
