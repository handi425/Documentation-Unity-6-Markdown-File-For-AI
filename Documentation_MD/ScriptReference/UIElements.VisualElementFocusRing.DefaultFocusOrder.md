...
[ChildOrder](UIElements.VisualElementFocusRing.DefaultFocusOrder.ChildOrder.html)|
Order elements using a depth-first pre-order traversal of the element tree.  
---|---  
[PositionXY](UIElements.VisualElementFocusRing.DefaultFocusOrder.PositionXY.html)|
Order elements according to their position, first by X, then by Y.  
[PositionYX](UIElements.VisualElementFocusRing.DefaultFocusOrder.PositionYX.html)|
