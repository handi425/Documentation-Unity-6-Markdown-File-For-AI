...
Audio importer lets you modify [AudioClip](AudioClip.html) import settings
from editor scripts.

Settings of this class match the ones exposed in [Audio Import
Settings](../Manual/class-AudioClip.html).

### Properties

[ambisonic](AudioImporter-ambisonic.html)| When this flag is set, the audio
clip will be treated as being ambisonic.  
---|---  
[defaultSampleSettings](AudioImporter-defaultSampleSettings.html)| The default
sample settings for the AudioClip importer.  
[forceToMono](AudioImporter-forceToMono.html)| Force audioclips to mono?  
[loadInBackground](AudioImporter-loadInBackground.html)| Corresponding to the
"Load In Background" flag in the AudioClip inspector, when this flag is set,
the loading of the clip will happen delayed without blocking the main thread.  
  
### Public Methods

[ClearSampleSettingOverride](AudioImporter.ClearSampleSettingOverride.html)|
Clears the sample settings override for the given platform.  
---|---  
[ContainsSampleSettingsOverride](AudioImporter.ContainsSampleSettingsOverride.html)|
Returns whether a given build target has its sample settings currently
overridden.  
[GetOverrideSampleSettings](AudioImporter.GetOverrideSampleSettings.html)|
Return the current override settings for the given platform.  
[SetOverrideSampleSettings](AudioImporter.SetOverrideSampleSettings.html)|
