...
#  [PlayerSettings](PlayerSettings.html).legacyClampBlendShapeWeights
...
public static bool legacyClampBlendShapeWeights;
...
If set to true, the range of BlendShape weights in SkinnedMeshRenderers will
be clamped, otherwise BlendShape weights can take any value.  
