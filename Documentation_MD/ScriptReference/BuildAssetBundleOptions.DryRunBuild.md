...
#  [BuildAssetBundleOptions](BuildAssetBundleOptions.html).DryRunBuild
...
This allows you to do a dry run build for the AssetBundles but not actually
build them. With this option enabled,
[BuildPipeline.BuildAssetBundles](BuildPipeline.BuildAssetBundles.html) still
returns an [AssetBundleManifest](AssetBundleManifest.html) object which
contains valid AssetBundle dependencies and hashes.
    ...
    //This script creates a new [Menu](Menu.html) named “Build [Asset](VersionControl.Asset.html)” and new options within the menu named “Normal” and “Dry Run Build”. Click these menu items to build an [AssetBundle](AssetBundle.html) into a folder.  
