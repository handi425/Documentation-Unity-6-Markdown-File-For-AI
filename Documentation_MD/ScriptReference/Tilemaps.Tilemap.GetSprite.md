...
#  [Tilemap](Tilemaps.Tilemap.html).GetSprite
...
public [Sprite](Sprite.html) GetSprite([Vector3Int](Vector3Int.html)
position);
...
**Sprite** [Sprite](Sprite.html) at the XYZ coordinate.

### Description

Gets the [Sprite](Sprite.html) used in a [Tile](Tilemaps.Tile.html) given the
