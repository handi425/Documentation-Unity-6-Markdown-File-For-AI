...
#  [PBXProject](iOS.Xcode.PBXProject.html).FindFileGuidByProjectPath
...
Finds a file with the given project path in the project.
    ...
    public class Sample_FindFileGuidByProjectPath  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID by using a path relative to the Xcode project structure and print it to the Console
