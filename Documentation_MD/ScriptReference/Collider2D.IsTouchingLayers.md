...
#  [Collider2D](Collider2D.html).IsTouchingLayers
...
**bool** Whether this collider is touching any collider on the specified
`layerMask` or not.
...
is performed against the last physics system update i.e. the state of touching
