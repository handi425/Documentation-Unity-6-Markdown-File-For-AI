...
numeric-format-strings#FFormatString).
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            [Vector4](Vector4.html) vector = new [Vector4](Vector4.html)(1, 2, 3, 4);
            [Debug.Log](Debug.Log.html)(vector.ToString()); // output displayed as: "(1.00, 2.00, 3.00, 4.00)"
        }
    }
