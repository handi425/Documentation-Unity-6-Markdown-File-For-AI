...
#  [MouseCursor](MouseCursor.html).ScaleArrow
...
Arrow with the scale symbol next to it for the sceneview.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.ScaleArrow](MouseCursor.ScaleArrow.html));
        }
    }
