...
#  [ParticleSystem](ParticleSystem.html).forceOverLifetime
...
public
[ParticleSystem.ForceOverLifetimeModule](ParticleSystem.ForceOverLifetimeModule.html)
forceOverLifetime;
...
Apply forces to particles using this module. Forces are applied to the
particle velocities on each frame.  
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            fo.x = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(1.5f, curve);
        }
    }
