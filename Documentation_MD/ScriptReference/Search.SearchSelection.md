...
Provides methods to give readonly access to the current list of selected items
in Search.
...
[Count](Search.SearchSelection.Count.html)| The number of items selected.  
---|---  
  
### Constructors

[SearchSelection](Search.SearchSelection-ctor.html)| Creates a new
SearchSelection.  
---|---  
  
### Public Methods

[Contains](Search.SearchSelection.Contains.html)| Checks if the search item is
contained in the current selection.  
---|---  
[First](Search.SearchSelection.First.html)| Gets the first selected item in
the selection.  
[GetEnumerator](Search.SearchSelection.GetEnumerator.html)| Gets an enumerator
on the currently selected SearchItems.  
[Last](Search.SearchSelection.Last.html)| Gets the last selected item in the
selection.  
[MaxIndex](Search.SearchSelection.MaxIndex.html)| Highest selected index of
any item in the selection.  
[MinIndex](Search.SearchSelection.MinIndex.html)| Lowest selected index of any
