...
Implements
interfaces:[IToolbarMenuElement](UIElements.IToolbarMenuElement.html)
...
A drop-down menu for the toolbar. For more information, refer to [UXML element
ToolbarMenu](../Manual/UIE-uxml-element-ToolbarMenu.html).

### Static Properties

[arrowUssClassName](UIElements.ToolbarMenu-arrowUssClassName.html)|  USS class
name of arrow indicators in elements of this type.  
---|---  
[popupVariantUssClassName](UIElements.ToolbarMenu-
popupVariantUssClassName.html)|  USS class name of elements of this type, when
they are displayed as popup menu.  
[textUssClassName](UIElements.ToolbarMenu-textUssClassName.html)|  USS class
name of text elements in elements of this type.  
[ussClassName](UIElements.ToolbarMenu-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[menu](UIElements.ToolbarMenu-menu.html)|  The menu.  
---|---  
[variant](UIElements.ToolbarMenu-variant.html)|  The display styles that you
can use when creating menus.  
  
### Constructors

[ToolbarMenu](UIElements.ToolbarMenu-ctor.html)|  Constructor.  
---|---  
