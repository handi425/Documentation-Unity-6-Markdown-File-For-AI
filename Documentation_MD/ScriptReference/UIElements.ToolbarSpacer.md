...
A toolbar spacer of static size. For more information, refer to [UXML element
ToolbarSpacer](../Manual/UIE-uxml-element-ToolbarSpacer.html).

### Static Properties

[flexibleSpacerVariantUssClassName](UIElements.ToolbarSpacer-
flexibleSpacerVariantUssClassName.html)|  USS class name of elements of this
type, when they are of flexible size.  
---|---  
[ussClassName](UIElements.ToolbarSpacer-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[flex](UIElements.ToolbarSpacer-flex.html)|  Return true if the spacer
stretches or shrinks to occupy available space.  
---|---  
  
### Constructors

[ToolbarSpacer](UIElements.ToolbarSpacer-ctor.html)|  Constructor.  
---|---  
