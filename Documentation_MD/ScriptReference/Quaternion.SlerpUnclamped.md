...
#  [Quaternion](Quaternion.html).SlerpUnclamped
...
SlerpUnclamped([Quaternion](Quaternion.html) a, [Quaternion](Quaternion.html)
b, float t);
...
**Quaternion** A unit quaternion spherically interpolated between unit
quaternions `a` and `b`.
...
Additional resources: [LerpUnclamped](Quaternion.LerpUnclamped.html),
[Slerp](Quaternion.Slerp.html).
