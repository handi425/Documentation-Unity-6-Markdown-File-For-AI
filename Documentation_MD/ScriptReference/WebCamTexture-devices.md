...
#  [WebCamTexture](WebCamTexture.html).devices
...
You should cache this value by keeping a copy of the result if you want to use
it repeatedly.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < devices.Length; i++)
                [Debug.Log](Debug.Log.html)(devices[i].name);
        }
    }
