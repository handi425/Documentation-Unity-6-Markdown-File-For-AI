...
#  [Quaternion](Quaternion.html).Inverse
...
Inverse([Quaternion](Quaternion.html) rotation);
...
Returns the Inverse of `rotation`.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        {
            transform.rotation = [Quaternion.Inverse](Quaternion.Inverse.html)(target.rotation);
        }
    }
