...
The PackageManager [Client](PackageManager.Client.html) class returns a
SearchRequest instance when you call the
[Client.Search](PackageManager.Client.Search.html) method to find a package or
the [Client.SearchAll](PackageManager.Client.SearchAll.html) method to find
all discoverable packages. Use this object to determine when the request is
complete and to access the result.  
  
Once the request is complete, you can retrieve the array of
[PackageInfo](PackageManager.PackageInfo.html) instances from the Result
property.

### Properties

[PackageIdOrName](PackageManager.Requests.SearchRequest.PackageIdOrName.html)|
