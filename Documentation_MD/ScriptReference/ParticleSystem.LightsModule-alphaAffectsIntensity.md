...
#
[ParticleSystem.LightsModule](ParticleSystem.LightsModule.html).alphaAffectsIntensity
...
This is useful to fade the Lights out at the same time as the particles, to
avoid popping.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void [Update](PlayerLoop.Update.html)()
        {
            ...
            var main = ps.main;
            main.startColor = new [Color](Color.html)(1.0f, 1.0f, 1.0f, hSliderValueA);
        }  
      
        void OnGUI()
        {
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 40, 100, 30), "Alpha");  
      
            hSliderValueA = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(95, 45, 100, 30), hSliderValueA, 0.0f, 1.0f);
            alphaAffectsIntensity = [GUI.Toggle](GUI.Toggle.html)(new [Rect](Rect.html)(25, 85, 200, 30), alphaAffectsIntensity, "[Particle](ParticleSystem.Particle.html) Alpha Affects [Light](Light.html) Intensity");
        }
    }
