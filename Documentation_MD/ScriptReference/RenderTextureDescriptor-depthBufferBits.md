...
#  [RenderTextureDescriptor](RenderTextureDescriptor.html).depthBufferBits
...
The actual format of the depth/stencil buffer that is selected based on the
given number of bits can be different per platform or graphics API. Read more
about the decision tree here Additional resources:
[RenderTexture.depth](RenderTexture-depth.html). Additional resources:
