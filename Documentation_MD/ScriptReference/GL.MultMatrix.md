...
public static void MultMatrix([Matrix4x4](Matrix4x4.html) m);

### Description

Sets the current model matrix to the one specified.

The model matrix is typically the local-to-world matrix of the object being
drawn.  
