...
#  [AssetPostprocessor](AssetPostprocessor.html).OnPreprocessModel()
...
Add this function to a subclass to get a notification just before a model
(.fbx, .mb file etc.) is imported.
