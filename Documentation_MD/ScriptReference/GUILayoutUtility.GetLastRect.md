...
#  [GUILayoutUtility](GUILayoutUtility.html).GetLastRect
...
public static [Rect](Rect.html) GetLastRect();
...
Note that this only works during the Repaint event.
    ...
    public class ExampleScript : [MonoBehaviour](MonoBehaviour.html)
    {
        void OnGUI()
        {
            [GUILayout.Button](GUILayout.Button.html)("My button");
            ...
            {
                [GUILayout.Label](GUILayout.Label.html)("Mouse over!");
            }
            else
            {
                [GUILayout.Label](GUILayout.Label.html)("Mouse somewhere else");
            }
        }
    }
