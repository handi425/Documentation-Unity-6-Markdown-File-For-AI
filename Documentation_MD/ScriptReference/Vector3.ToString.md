...
numeric-format-strings#FFormatString).
    ...
    public class ExampleScript : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            ...
            [Vector3](Vector3.html) vector = new [Vector3](Vector3.html)(1, 2, 3);
            [Debug.Log](Debug.Log.html)(vector.ToString());  
      
            // unity displays by default (1.23, 5.68, 9.01)
            vector = new [Vector3](Vector3.html)(1.234f, 5.678f, 9.012f);
            [Debug.Log](Debug.Log.html)(vector.ToString());  
      
            // but we can show this using format - 3 numbers after the decimal point
            // (1.234, 5.678, 9.012)
            [Debug.Log](Debug.Log.html)(vector.ToString("F3"));  
      
            // now let's create some longer numbers
            vector = new [Vector3](Vector3.html)(1.0f / 3.0f, -[Mathf.PI](Mathf.PI.html), [Mathf.Exp](Mathf.Exp.html)(-2.0f));  
      
            // we get (0.333333, -3.141593, 0.135335)
            [Debug.Log](Debug.Log.html)("fractional part is 6: " + vector.ToString("F6"));  
      
            // note how F8 cannot display these numbers as we want
            // (0.33333330, -3.14159300, 0.13533530)
            [Debug.Log](Debug.Log.html)("fractional part is 8: " + vector.ToString("F8"));
        }
    }
