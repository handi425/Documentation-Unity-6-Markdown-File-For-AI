...
public MeshTransform(ref [XR.MeshId](XR.MeshId.html) meshId, ulong timestamp,
ref [Vector3](Vector3.html) position, ref [Quaternion](Quaternion.html)
rotation, ref [Vector3](Vector3.html) scale);
...
Creates a new [MeshTransform](XR.MeshTransform.html).
