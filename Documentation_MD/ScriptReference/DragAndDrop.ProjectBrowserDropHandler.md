...
#  [DragAndDrop](DragAndDrop.html).ProjectBrowserDropHandler
...
ProjectBrowserDropHandler(int dragInstanceId, string dropUponPath, bool
perform);
...
is not able to process the event. In that case a new handler will be called
for processing. Any other [DragAndDropVisualMode](DragAndDropVisualMode.html)
