...
Implements interfaces:[IBindable](UIElements.IBindable.html)
...
A SerializedProperty wrapper VisualElement that, on Bind(), will generate the
correct field elements with the correct binding paths. For more information,
refer to [UXML element PropertyField](../Manual/UIE-uxml-element-
PropertyField.html).

### Static Properties

[inputUssClassName](UIElements.PropertyField-inputUssClassName.html)|  USS
class name of input elements in elements of this type.  
---|---  
[inspectorElementUssClassName](UIElements.PropertyField-
inspectorElementUssClassName.html)|  USS class name of property fields in
inspector elements  
[labelUssClassName](UIElements.PropertyField-labelUssClassName.html)|  USS
class name of labels in elements of this type.  
[ussClassName](UIElements.PropertyField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[binding](UIElements.PropertyField-binding.html)|  Binding object that will be
updated.  
---|---  
[bindingPath](UIElements.PropertyField-bindingPath.html)|  Path of the target
property to be bound.  
[label](UIElements.PropertyField-label.html)|  Optionally overwrite the label
of the generate property field. If no label is provided the string will be
taken from the SerializedProperty.  
  
### Constructors

[PropertyField](UIElements.PropertyField-ctor.html)|  PropertyField
constructor.  
---|---  
  
### Public Methods

[RegisterValueChangeCallback](UIElements.PropertyField.RegisterValueChangeCallback.html)|
Registers this callback to receive SerializedPropertyChangeEvent when a value
is changed.  
---|---  
