...
#  [SortingLayer](SortingLayer.html).GetLayerValueFromName
...
Returns the final sorting layer value. Additional resources:
[GetLayerValueFromID](SortingLayer.GetLayerValueFromID.html).
