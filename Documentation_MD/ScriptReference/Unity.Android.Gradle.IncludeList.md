...
[IncludeList](Unity.Android.Gradle.IncludeList-ctor.html)| Element
constructor.  
---|---  
  
### Public Methods

[AddPluginByName](Unity.Android.Gradle.IncludeList.AddPluginByName.html)| Adds
a plugin include: "include '{name}'".  
---|---  
