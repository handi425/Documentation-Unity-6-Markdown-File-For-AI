...
#  [TrailRenderer](TrailRenderer.html).time
...
How long does the trail take to fade out.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 20, 200, 30), "[Time](Time.html)");
            time = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(125, 25, 200, 30), time, 0.1f, 10.0f);
        }
    }
