...
[Overlay](Overlays.OverlayToolbar.Overlay.html).

Use this class with
[ICreateHorizontalToolbar](Overlays.OverlayToolbar.ICreateHorizontalToolbar.html)
and
[ICreateVerticalToolbar](Overlays.OverlayToolbar.ICreateVerticalToolbar.html)
...
[OverlayToolbar](Overlays.OverlayToolbar-ctor.html)| Create a new
OverlayToolbar.  
---|---  
  
### Public Methods

[SetupChildrenAsButtonStrip](Overlays.OverlayToolbar.SetupChildrenAsButtonStrip.html)|
Use this method to apply button strip styling to the contents of this
VisualElement.  
---|---  
