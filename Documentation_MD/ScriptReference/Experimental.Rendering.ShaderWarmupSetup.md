...
to correctly prewarm shader variants for these graphics APIs.  
  
Additional resources: [ShaderWarmup](Experimental.Rendering.ShaderWarmup.html)

### Properties

[vdecl](Experimental.Rendering.ShaderWarmupSetup-vdecl.html)| The vertex data
layout to use when prewarming shader variants.  
---|---  
