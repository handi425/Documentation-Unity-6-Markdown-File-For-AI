...
#
[RayTracingGeometryInstanceConfig](Rendering.RayTracingGeometryInstanceConfig.html).subMeshFlags
...
The Material type can influence the value of this flag. For example if Unity
considers the Material opaque, you can specify the
...
flags together for maximum ray tracing performance.
