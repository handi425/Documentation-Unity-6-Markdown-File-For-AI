...
#  [CustomRenderTexture](CustomRenderTexture.html).updateZoneSpace
...
The space in which Unity expresses update zones. You can set this to
Normalized or Pixel space.
