...
[menu](UIElements.ContextualMenuPopulateEvent-menu.html)|  The menu to
populate.  
---|---  
[triggerEvent](UIElements.ContextualMenuPopulateEvent-triggerEvent.html)|  The
event that triggered the ContextualMenuPopulateEvent.  
  
### Constructors

[ContextualMenuPopulateEvent](UIElements.ContextualMenuPopulateEvent-
ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.ContextualMenuPopulateEvent.Init.html)|  Resets the event
members to their initial values.  
---|---  
  
### Static Methods

[GetPooled](UIElements.ContextualMenuPopulateEvent.GetPooled.html)|  Gets an
