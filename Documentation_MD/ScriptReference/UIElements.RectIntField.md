...
A [RectInt](RectInt.html) field. For more information, refer to [UXML element
RectIntField](../Manual/UIE-uxm-element-RectIntField.html).

### Static Properties

[inputUssClassName](UIElements.RectIntField-inputUssClassName.html)|  USS
class name of input elements in elements of this type.  
---|---  
[labelUssClassName](UIElements.RectIntField-labelUssClassName.html)|  USS
class name of labels in elements of this type.  
[ussClassName](UIElements.RectIntField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Constructors

[RectIntField](UIElements.RectIntField-ctor.html)|  Initializes and returns an
instance of RectIntField.  
---|---  
