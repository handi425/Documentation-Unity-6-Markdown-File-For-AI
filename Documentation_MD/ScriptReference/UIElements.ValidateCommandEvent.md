...
Inherits
from:[UIElements.CommandEventBase_1](UIElements.CommandEventBase_1.html)
...
This event is sent by the Editor while it determines whether the command will
be handled by an element in the panel.

See also: [Command Events](../Manual/UIE-Command-Events.html).

### Inherited Members

### Properties

[commandName](UIElements.CommandEventBase_1-commandName.html)|  The command to
validate or execute.  
---|---  
...
[Init](UIElements.CommandEventBase_1.Init.html)|  Resets the event members to
...
[GetPooled](UIElements.CommandEventBase_1.GetPooled.html)|  Gets an event from
