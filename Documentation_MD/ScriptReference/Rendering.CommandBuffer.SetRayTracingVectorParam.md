...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetRayTracingVectorParam
...
public void
SetRayTracingVectorParam([Rendering.RayTracingShader](Rendering.RayTracingShader.html)
rayTracingShader, string name, [Vector4](Vector4.html) val);

## Declaration

public void
SetRayTracingVectorParam([Rendering.RayTracingShader](Rendering.RayTracingShader.html)
rayTracingShader, int nameID, [Vector4](Vector4.html) val);
...
Only shaders defined in the .raytrace file can access the vector you designate
as the argument for this method. To make this vector accessible to all ray
