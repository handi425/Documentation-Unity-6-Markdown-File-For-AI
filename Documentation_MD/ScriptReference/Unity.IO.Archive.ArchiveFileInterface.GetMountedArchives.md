...
#
[ArchiveFileInterface](Unity.IO.Archive.ArchiveFileInterface.html).GetMountedArchives
...
GetMountedArchives([Unity.Content.ContentNamespace](Unity.Content.ContentNamespace.html)
namespaceId);
