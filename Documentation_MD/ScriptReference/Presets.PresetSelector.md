...
This class implements a modal window that selects a
[Preset](Presets.Preset.html) asset from the Project.

### Static Methods

[DrawPresetButton](Presets.PresetSelector.DrawPresetButton.html)| Draw a
Preset button that opens the default PresetSelector using the targets array.  
---|---  
[ShowSelector](Presets.PresetSelector.ShowSelector.html)| Opens a modal window
to select a Preset.  
