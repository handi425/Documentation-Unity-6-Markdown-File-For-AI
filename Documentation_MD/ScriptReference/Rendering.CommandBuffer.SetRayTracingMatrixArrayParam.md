...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetRayTracingMatrixArrayParam
...
public void
SetRayTracingMatrixArrayParam([Rendering.RayTracingShader](Rendering.RayTracingShader.html)
rayTracingShader, string name, params Matrix4x4[] values);

## Declaration

public void
SetRayTracingMatrixArrayParam([Rendering.RayTracingShader](Rendering.RayTracingShader.html)
rayTracingShader, int nameID, params Matrix4x4[] values);
...
Only shaders defined in the .raytrace file can access the matrix array you
designate as the argument for this method. To make this matrix array
