...
#
[ScriptableRenderContext](Rendering.ScriptableRenderContext.html).CreateWireOverlayRendererList
...
CreateWireOverlayRendererList([Camera](Camera.html) camera);
...
Creates a new WireOverlay [RendererList](Rendering.RendererList.html).

A [RendererList](Rendering.RendererList.html) represents a set of draw
commands. To draw the WireOverlay in a RendererList, add the
