...
#  [BuildOptions](BuildOptions.html).SymlinkLibraries
...
**Obsolete** BuildOptions.SymlinkLibraries is obsolete. Use
BuildOptions.SymlinkSources instead.  
**Upgrade to[SymlinkSources](BuildOptions.SymlinkSources.html)**
