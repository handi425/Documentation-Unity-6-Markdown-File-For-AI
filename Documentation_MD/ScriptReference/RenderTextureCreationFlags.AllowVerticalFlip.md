...
#
[RenderTextureCreationFlags](RenderTextureCreationFlags.html).AllowVerticalFlip
...
not automatically flip the texture when being displayed. This is platform
specific and It is set by default. This flag is only cleared when part of a
