...
#  [PBXProject](iOS.Xcode.PBXProject.html).RemoveAssetTagFromDefaultInstall
...
The function does nothing if the tag isn't already configured for downloading
during initial installation.
    ...
    public class Sample_RemoveAssetTagFromDefaultInstall  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Remove the [Asset](VersionControl.Asset.html) Tag from list of tags to be downloaded during initial installation
            pbxProject.RemoveAssetTagFromDefaultInstall(mainTargetGuid, "exampleTag");  
