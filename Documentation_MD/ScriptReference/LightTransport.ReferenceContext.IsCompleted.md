...
#  [ReferenceContext](LightTransport.ReferenceContext.html).IsCompleted
...
Operations always complete immediately when queued on the
[ReferenceContext](LightTransport.ReferenceContext.html). This method will
always return true.
