...
#  [ModelImporter](ModelImporter.html).defaultClipAnimations
...
[ModelImporterClipAnimation](ModelImporterClipAnimation.html). Additional
resources: [TakeInfo](TakeInfo.html).
