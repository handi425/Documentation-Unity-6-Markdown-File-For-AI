...
#  [Shader](Shader.html).SetGlobalVector
...
public static void SetGlobalVector(string name, [Vector4](Vector4.html)
value);

## Declaration

public static void SetGlobalVector(int nameID, [Vector4](Vector4.html) value);
...
"global" vector (for example, wind direction). Then you can set the global
property from script and don't have to setup the same vector in all materials.  
