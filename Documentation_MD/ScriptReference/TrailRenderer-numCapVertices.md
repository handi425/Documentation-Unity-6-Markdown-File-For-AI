...
#  [TrailRenderer](TrailRenderer.html).numCapVertices
...
Set this to a value greater than 0, to get rounded corners on each end of the
trail.

The value controls how many vertices are added to each end, where a higher
value will give a smoother result.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 20, 200, 30), "Num Cap Vertices");
            numCapVertices = (int)[GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(165, 25, 200, 30), (float)numCapVertices, 0.0f, 20.0f);  
      
            [GUI.Label](GUI.Label.html)(new [Rect](Rect.html)(25, 60, 200, 30), "Num Corner Vertices");
            numCornerVertices = (int)[GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(165, 65, 200, 30), (float)numCornerVertices, 0.0f, 20.0f);
        }
    }
