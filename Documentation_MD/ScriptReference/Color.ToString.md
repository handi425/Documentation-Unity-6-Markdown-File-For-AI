...
Returns a formatted string of this color.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            [Color](Color.html) color = [Color.magenta](Color-magenta.html);  
      
            // Print "RGBA(1.000, 0.000, 1.000, 1.000)"
            print(color.ToString());  
      
            color = new [Color](Color.html)([Random.value](Random-value.html), [Random.value](Random-value.html), [Random.value](Random-value.html), 1.0f);  
