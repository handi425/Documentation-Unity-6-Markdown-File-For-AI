...
#  [TreeView](IMGUI.Controls.TreeView.html).FindItem
...
FindItem(int id,
[IMGUI.Controls.TreeViewItem](IMGUI.Controls.TreeViewItem.html)
searchFromThisItem);
...
**TreeViewItem** This search method returns the TreeViewItem found and returns
null if not found.
