...
#  [BaseListView](UIElements.BaseListView.html).arraySizeFieldUssClassName
...
The USS class name for the size field of the ListView when show bound
collection size is enabled
