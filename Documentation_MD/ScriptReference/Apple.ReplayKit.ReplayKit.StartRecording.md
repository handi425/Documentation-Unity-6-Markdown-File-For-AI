...
**bool** A boolean value of True if recording started successfully or False if
an error occurred.
...
When StartRecording() is first called, an alert window displays asking the
user to confirm recording. The alert window displays again if 8 minutes or
more have passed since the last time StartRecording() was called.  
