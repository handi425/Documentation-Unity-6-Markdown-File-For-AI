...
#  [PlayableExtensions](Playables.PlayableExtensions.html).GetPreviousTime
...
**double** The previous time in seconds.

### Description

Returns the previous local time of the [Playable](Playables.Playable.html).
