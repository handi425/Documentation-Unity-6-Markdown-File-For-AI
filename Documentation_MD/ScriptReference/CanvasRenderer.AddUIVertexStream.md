...
#
[CanvasRenderer](CanvasRenderer.html).AddUIVertexStream(List<UIVertex>,List<Vector3>,List<Color32>,List<Vector2>,List<Vector2>,List<Vector3>,List<Vector4>)
...
Take the Vertex stream and split it corrisponding arrays (positions, colors,
uv0s, uv1s, normals and tangents).
