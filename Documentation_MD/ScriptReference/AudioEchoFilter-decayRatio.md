...
#  [AudioEchoFilter](AudioEchoFilter.html).decayRatio
...
Echo decay per delay. 0 to 1. 1.0 = No decay, 0.0 = total decay (i.e. simple 1
line delay). Default = 0.5.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            GetComponent<[AudioEchoFilter](AudioEchoFilter.html)>().decayRatio = 0.0f;
        }
    }
