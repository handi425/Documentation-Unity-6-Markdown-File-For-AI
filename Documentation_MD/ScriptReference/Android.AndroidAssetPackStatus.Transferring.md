...
#  [AndroidAssetPackStatus](Android.AndroidAssetPackStatus.html).Transferring
...
Indicates that the device has downloaded the Android asset pack and is
unpacking the asset pack to its final location.
