...
#  [AudioCurveRendering](AudioCurveRendering.html).DrawMinMaxFilledCurve
...
public static void DrawMinMaxFilledCurve([Rect](Rect.html) r,
[AudioCurveRendering.AudioMinMaxCurveAndColorEvaluator](AudioCurveRendering.AudioMinMaxCurveAndColorEvaluator.html)
eval);
...
Fills the area between the two curves evaluated by the
