...
#  [MouseCursor](MouseCursor.html).FPS
...
Cursor with an eye and stylized arrow keys for FPS navigation.
    ...
    public class MouseCursorExample : [EditorWindow](EditorWindow.html)
    {
        ...
        void OnGUI()
        {
            ...
            [EditorGUIUtility.AddCursorRect](EditorGUIUtility.AddCursorRect.html)(new [Rect](Rect.html)(20, 20, 140, 40), [MouseCursor.FPS](MouseCursor.FPS.html));
        }
    }
