...
[callbackOrder](Build.BuildPlayerProcessor-callbackOrder.html)| Returns the
relative callback order for callbacks. Callbacks with lower values are called
before ones with higher values.  
---|---  
  
### Public Methods

[PrepareForBuild](Build.BuildPlayerProcessor.PrepareForBuild.html)| Implement
this function to receive a callback before a player build starts.  
---|---  
