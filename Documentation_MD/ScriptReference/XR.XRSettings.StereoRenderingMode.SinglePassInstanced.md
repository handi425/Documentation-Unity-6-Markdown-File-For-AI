...
#
[XRSettings.StereoRenderingMode](XR.XRSettings.StereoRenderingMode.html).SinglePassInstanced
...
[XRSettings.StereoRenderingMode.SinglePass](XR.XRSettings.StereoRenderingMode.SinglePass.html)
mode.
...
support is required for this mode to run. See the
[manual](../Manual/SinglePassStereoRendering.html) for how to get the most out
of instanced rendering. Additional resources:
