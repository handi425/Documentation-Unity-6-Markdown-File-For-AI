...
For more information about the element, see Gradle's documentation: [The top-
level build file](https://developer.android.com/studio/build#top-level)

### Properties

[Plugins](Unity.Android.Gradle.ProjectLevelBuildGradleFile.Plugins.html)| The
C# definition of the plugins element in a gradle file.  
---|---  
  
### Constructors

[ProjectLevelBuildGradleFile](Unity.Android.Gradle.ProjectLevelBuildGradleFile-
