...
#
[BaseTreeView](UIElements.BaseTreeView.html).itemIndentsContainerUssClassName
...
**Obsolete** Individual item indents are no longer used, see
itemIndentUssClassName instead. public static string
