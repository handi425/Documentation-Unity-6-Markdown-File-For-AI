...
Inherits
from:[PackageManager.Requests.Request](PackageManager.Requests.Request.html)
...
RemoveRequest instance when you call the
[Client.Remove](PackageManager.Client.Remove.html) method to remove a package
from your project. Use this object to determine when the request is complete.

### Properties

[PackageIdOrName](PackageManager.Requests.RemoveRequest.PackageIdOrName.html)|
