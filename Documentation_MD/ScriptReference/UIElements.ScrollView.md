...
[ScrollView](../Manual/UIE-uxml-element-ScrollView.html).

### Static Properties

[contentAndVerticalScrollUssClassName](UIElements.ScrollView-
contentAndVerticalScrollUssClassName.html)|  USS class name of content
elements in elements of this type.  
---|---  
[contentUssClassName](UIElements.ScrollView-contentUssClassName.html)|  USS
class name of content elements in elements of this type.  
[horizontalVariantContentUssClassName](UIElements.ScrollView-
horizontalVariantContentUssClassName.html)|  USS class name that's added when
the ContentContainer is in horizontal mode. ScrollViewMode.Horizontal  
[horizontalVariantUssClassName](UIElements.ScrollView-
horizontalVariantUssClassName.html)|  USS class name that's added when the
ScrollView is in horizontal mode. ScrollViewMode.Horizontal  
[horizontalVariantViewportUssClassName](UIElements.ScrollView-
horizontalVariantViewportUssClassName.html)|  USS class name that's added when
the Viewport is in horizontal mode. ScrollViewMode.Horizontal  
[hScrollerUssClassName](UIElements.ScrollView-hScrollerUssClassName.html)|
USS class name of horizontal scrollers in elements of this type.  
[ussClassName](UIElements.ScrollView-ussClassName.html)|  USS class name of
elements of this type.  
[verticalHorizontalVariantContentUssClassName](UIElements.ScrollView-
verticalHorizontalVariantContentUssClassName.html)|  USS class name that's
added when the ContentContainer is in both horizontal and vertical mode.
ScrollViewMode.VerticalAndHorizontal  
[verticalHorizontalVariantUssClassName](UIElements.ScrollView-
verticalHorizontalVariantUssClassName.html)|  USS class name that's added when
the ScrollView is in both horizontal and vertical mode.
ScrollViewMode.VerticalAndHorizontal  
[verticalHorizontalVariantViewportUssClassName](UIElements.ScrollView-
verticalHorizontalVariantViewportUssClassName.html)|  USS class name that's
added when the Viewport is in both horizontal and vertical mode.
ScrollViewMode.VerticalAndHorizontal  
[verticalVariantContentUssClassName](UIElements.ScrollView-
verticalVariantContentUssClassName.html)|  USS class name that's added when
the ContentContainer is in vertical mode. ScrollViewMode.Vertical  
[verticalVariantUssClassName](UIElements.ScrollView-
verticalVariantUssClassName.html)|  USS class name that's added when the
ScrollView is in vertical mode. ScrollViewMode.Vertical  
[verticalVariantViewportUssClassName](UIElements.ScrollView-
verticalVariantViewportUssClassName.html)|  USS class name that's added when
the Viewport is in vertical mode. ScrollViewMode.Vertical  
[viewportUssClassName](UIElements.ScrollView-viewportUssClassName.html)|  USS
class name of viewport elements in elements of this type.  
[vScrollerUssClassName](UIElements.ScrollView-vScrollerUssClassName.html)|
USS class name of vertical scrollers in elements of this type.  
  
### Properties

[contentContainer](UIElements.ScrollView-contentContainer.html)|  Contains
full content, potentially partially visible.  
---|---  
[contentViewport](UIElements.ScrollView-contentViewport.html)|  Represents the
visible part of contentContainer.  
[elasticAnimationIntervalMs](UIElements.ScrollView-
elasticAnimationIntervalMs.html)|  The minimum amount of time, in
milliseconds, between executions of elastic spring animation.  
[elasticity](UIElements.ScrollView-elasticity.html)|  The amount of elasticity
to use when a user tries to scroll past the boundaries of the scroll view.  
[horizontalPageSize](UIElements.ScrollView-horizontalPageSize.html)|  This
property controls the speed of the horizontal scrolling when using a keyboard
or the on-screen scrollbar buttons (arrows and handle), based on the size of
the page.  
[horizontalScroller](UIElements.ScrollView-horizontalScroller.html)|
Horizontal scrollbar.  
[horizontalScrollerVisibility](UIElements.ScrollView-
horizontalScrollerVisibility.html)|  Specifies whether the horizontal scroll
bar is visible.  
[mode](UIElements.ScrollView-mode.html)|  Controls how the ScrollView allows
the user to scroll the contents. ScrollViewMode  
[mouseWheelScrollSize](UIElements.ScrollView-mouseWheelScrollSize.html)|  This
property controls the scrolling speed only when using a mouse scroll wheel,
based on the size of the page. It takes precedence over the --unity-metrics-
single_line-height USS variable.  
[nestedInteractionKind](UIElements.ScrollView-nestedInteractionKind.html)|
The behavior to use when scrolling reaches limits of a nested ScrollView.  
[scrollDecelerationRate](UIElements.ScrollView-scrollDecelerationRate.html)|
Controls the rate at which the scrolling movement slows after a user scrolls
using a touch interaction.  
[scrollOffset](UIElements.ScrollView-scrollOffset.html)|  The current
scrolling position.  
[touchScrollBehavior](UIElements.ScrollView-touchScrollBehavior.html)|  The
behavior to use when a user tries to scroll past the boundaries of the
ScrollView content using a touch interaction.  
[verticalPageSize](UIElements.ScrollView-verticalPageSize.html)|  This
property controls the speed of the vertical scrolling when using a keyboard or
the on-screen scrollbar buttons (arrows and handle), based on the size of the
page.  
[verticalScroller](UIElements.ScrollView-verticalScroller.html)|  Vertical
Scrollbar.  
[verticalScrollerVisibility](UIElements.ScrollView-
verticalScrollerVisibility.html)|  Specifies whether the vertical scroll bar
is visible.  
...
[ScrollTo](UIElements.ScrollView.ScrollTo.html)|  Scroll to a specific child
element.  
---|---  
