...
#  [ParticleSystem.LightsModule](ParticleSystem.LightsModule.html).ratio
...
Use a value between 0 and 1, where 0 attaches Lights to no particles, and 1
attaches Lights to every particle.
