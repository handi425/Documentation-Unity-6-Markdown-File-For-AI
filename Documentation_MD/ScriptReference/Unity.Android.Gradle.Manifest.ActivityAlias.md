...
[ActivityAlias
element](https://developer.android.com/guide/topics/manifest/activity-alias-
element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.ActivityAlias.Attributes.html)| The
attributes container for the <activity-alias> element.  
---|---  
[IntentFilterList](Unity.Android.Gradle.Manifest.ActivityAlias.IntentFilterList.html)|
List of <intent-filter> child elements.  
[MetaDataList](Unity.Android.Gradle.Manifest.ActivityAlias.MetaDataList.html)|
List of <meta-data> child elements.  
  
### Constructors

[ActivityAlias](Unity.Android.Gradle.Manifest.ActivityAlias-ctor.html)|
Element constructor.  
---|---  
