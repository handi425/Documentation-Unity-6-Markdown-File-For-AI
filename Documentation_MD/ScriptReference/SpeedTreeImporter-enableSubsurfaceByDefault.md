...
#  [SpeedTreeImporter](SpeedTreeImporter.html).enableSubsurfaceByDefault
...
public bool enableSubsurfaceByDefault;
...
other two-sided SpeedTree materials to simulate a translucent surface.  
  
To change this setting for a specific LOD, see
[SpeedTreeImporter.enableSubsurface](SpeedTreeImporter-enableSubsurface.html)
and [SpeedTreeImporter.enableSettingOverride](SpeedTreeImporter-
