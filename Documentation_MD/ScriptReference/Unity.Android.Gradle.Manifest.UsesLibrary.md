...
[UsesLibrary
element](https://developer.android.com/guide/topics/manifest/uses-library-
element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.UsesLibrary.Attributes.html)| The
attributes container for the <uses-library> element.  
---|---  
  
### Constructors

[UsesLibrary](Unity.Android.Gradle.Manifest.UsesLibrary-ctor.html)| Element
constructor.  
---|---  
