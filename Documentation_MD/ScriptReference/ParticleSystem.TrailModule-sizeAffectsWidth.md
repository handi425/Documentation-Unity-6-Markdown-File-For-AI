...
#
[ParticleSystem.TrailModule](ParticleSystem.TrailModule.html).sizeAffectsWidth
...
Useful for making larger particles have wider trails.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            sizeAffectsWidth = [GUI.Toggle](GUI.Toggle.html)(new [Rect](Rect.html)(25, 25, 200, 30), sizeAffectsWidth, "Size affects width");
        }
    }
