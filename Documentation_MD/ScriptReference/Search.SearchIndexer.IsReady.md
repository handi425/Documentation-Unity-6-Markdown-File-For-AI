...
#  [SearchIndexer](Search.SearchIndexer.html).IsReady
...
Indicates if the index is fully built, up to date, and ready for search.
    ...
    {
        [[MenuItem](MenuItem.html)("Examples/[SearchIndexer](Search.SearchIndexer.html)/IsReady")]
        public static void Run()
        {
            ...
            while (!si.IsReady())
                ;
            [Debug.Log](Debug.Log.html)("Indexing is completed");
        }
    }
