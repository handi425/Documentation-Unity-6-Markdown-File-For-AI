...
#  [Gradient](Gradient.html).SetKeys
...
public void SetKeys(GradientColorKey[] colorKeys, GradientAlphaKey[]
alphaKeys);
...
and that it is ensured to always have a minimum of 2 color keys and 2 alpha
keys.
