...
#  [Object](Object.html).FindObjectsOfTypeIncludingAssets
...
**Object[]** The array of objects and assets found matching the type
specified.
...
In addition to all active and inactive Scene objects, this function also
returns assets that match the type specified (meshes, textures, prefabs,
etc.). This does not return objects that have
[HideFlags.DontSave](HideFlags.DontSave.html) set.  
  
Be aware that when running in the editor, this function will also return
hidden objects used by Unity itself such as the Scene view camera and preview
camera.  
