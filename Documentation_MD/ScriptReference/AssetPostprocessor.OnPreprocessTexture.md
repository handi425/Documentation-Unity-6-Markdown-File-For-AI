...
#  [AssetPostprocessor](AssetPostprocessor.html).OnPreprocessTexture()
...
Add this function to a subclass to get a notification just before the texture
importer is run.
...
Use this callback if you want to change the compression format of the texture.
    ...
    class MyTexturePostprocessor : [AssetPostprocessor](AssetPostprocessor.html)
    {
