...
#  [GUISkin](GUISkin.html).horizontalScrollbarThumb
...
public [GUIStyle](GUIStyle.html) horizontalScrollbarThumb;
...
[GUI.HorizontalScrollbar](GUI.HorizontalScrollbar.html) controls.
    ...
    {
        // Modifies only the horizontal scrollbar thumb of the current [GUISkin](GUISkin.html)
        float hSbarValue;
