...
#  [PaintContext](TerrainTools.PaintContext.html).GatherAlphamap
...
public void GatherAlphamap([TerrainLayer](TerrainLayer.html) inputLayer, bool
...
This function collects the alphamap data from all Terrain tiles in the
PaintContext into `sourceRenderTexture`.  
