...
#  [ObjectIdResult](Rendering.ObjectIdResult.html).idToObjectMapping
...
An array of Objects that can be used to deterimine the object at each pixel in
...
and then by looking up this index in this array.
