...
#  [EditorGUI](EditorGUI.html).DelayedDoubleField
...
public static double DelayedDoubleField([Rect](Rect.html) position, double
value, [GUIStyle](GUIStyle.html) style = EditorStyles.numberField);

## Declaration

public static double DelayedDoubleField([Rect](Rect.html) position, string
label, double value, [GUIStyle](GUIStyle.html) style =
EditorStyles.numberField);

## Declaration

public static double DelayedDoubleField([Rect](Rect.html) position,
...
Similar to [EditorGUI.DoubleField](EditorGUI.DoubleField.html) but will not
return the new value until the user has pressed enter or focus is moved away
from the double field.
