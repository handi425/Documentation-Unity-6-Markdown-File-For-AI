...
#  [ComputeBuffer](ComputeBuffer.html).SetCounterValue
...
number of elements in them with a special counter variable. SetCounterValue
explicitly sets the counter value.  
...
Additional resources: [CopyCount](ComputeBuffer.CopyCount.html),
[Graphics.SetRandomWriteTarget](Graphics.SetRandomWriteTarget.html).
