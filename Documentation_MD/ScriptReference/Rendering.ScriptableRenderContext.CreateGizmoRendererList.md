...
#
[ScriptableRenderContext](Rendering.ScriptableRenderContext.html).CreateGizmoRendererList
...
CreateGizmoRendererList([Camera](Camera.html) camera,
...
Creates a new Gizmo [RendererList](Rendering.RendererList.html).

A [RendererList](Rendering.RendererList.html) represents a set of draw
commands. To draw the Gizmo in a RendererList, add the
