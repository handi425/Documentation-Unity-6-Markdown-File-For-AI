...
**Obsolete** Procedural Virtual Texturing is experimental, not ready for
production use and Unity does not currently support it. The feature might be
changed or removed in the future.

### Description

Static class representing the Procedural Virtual Texturing system. Unity does
not currently support this system.
