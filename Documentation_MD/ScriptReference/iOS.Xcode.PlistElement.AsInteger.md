...
#  [PlistElement](iOS.Xcode.PlistElement.html).AsInteger
...
The method is equivalent to `((PlistElementInteger) el).value`. Throws
exception if the element is not
[PlistElementInteger](iOS.Xcode.PlistElementInteger.html).
    ...
    public class PlistElementAsIntegerExample
    {
        [PostProcessBuild]
        public static void AsIntegerExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
