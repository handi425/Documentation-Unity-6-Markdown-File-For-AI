...
#  [MonoBehaviour](MonoBehaviour.html).OnCollisionEnter(Collision)
...
other | The [Collision](Collision.html) data associated with this collision.  
---|---  
...
In contrast to [OnTriggerEnter](MonoBehaviour.OnTriggerEnter.html),
[OnCollisionEnter](MonoBehaviour.OnCollisionEnter.html) is passed the
...
OnCollisionEnter can be a co-routine, simply use the yield statement in the
function.
