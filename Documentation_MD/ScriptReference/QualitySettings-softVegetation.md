...
#  [QualitySettings](QualitySettings.html).softVegetation
...
If enabled, vegetation will have smoothed edges, if disabled all plants will
have hard edges but are rendered roughly twice as fast.  
