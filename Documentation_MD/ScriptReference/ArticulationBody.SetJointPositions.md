...
#  [ArticulationBody](ArticulationBody.html).SetJointPositions
...
This sets joint positions in the reduced coordinate space for the entire
...
[GetJointPositions](ArticulationBody.GetJointPositions.html).
