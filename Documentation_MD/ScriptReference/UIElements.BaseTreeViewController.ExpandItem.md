...
#  [BaseTreeViewController](UIElements.BaseTreeViewController.html).ExpandItem
...
Expands the item with the specified ID, making its children visible. Allows to
expand the whole hierarchy under that item.
