...
#
[ParticleSystem.RotationBySpeedModule](ParticleSystem.RotationBySpeedModule.html).separateAxes
...
When disabled, only the z-axis rotation curve is used.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationBySpeed.x = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(1.0f, curve);
