...
#
[PointerCaptureEventBase<T0>](UIElements.PointerCaptureEventBase_1.html).GetPooled
...
[UIElements.IEventHandler](UIElements.IEventHandler.html) relatedTarget, int
pointerId);
