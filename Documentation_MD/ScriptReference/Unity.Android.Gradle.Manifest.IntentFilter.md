...
[IntentFilter
element](https://developer.android.com/guide/topics/manifest/intent-filter-
element)

### Properties

[ActionList](Unity.Android.Gradle.Manifest.IntentFilter.ActionList.html)| List
of <action> child elements.  
---|---  
[Attributes](Unity.Android.Gradle.Manifest.IntentFilter.Attributes.html)| The
attributes container for the <intent-filter> element.  
[CategoryList](Unity.Android.Gradle.Manifest.IntentFilter.CategoryList.html)|
List of <category> child elements.  
[DataList](Unity.Android.Gradle.Manifest.IntentFilter.DataList.html)| List of
<data> child elements.  
  
### Constructors

[IntentFilter](Unity.Android.Gradle.Manifest.IntentFilter-ctor.html)| Element
constructor.  
---|---  
