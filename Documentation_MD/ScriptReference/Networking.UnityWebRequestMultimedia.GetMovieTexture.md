...
#
[UnityWebRequestMultimedia](Networking.UnityWebRequestMultimedia.html).GetMovieTexture
...
download a movie clip via HTTP GET and create an MovieTexture based on the
retrieved data.
