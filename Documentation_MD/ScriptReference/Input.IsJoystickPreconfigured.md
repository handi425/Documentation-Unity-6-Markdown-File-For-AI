...
#  [Input](Input.html).IsJoystickPreconfigured
...
joystickName | The name of the joystick to check (returned by [Input.GetJoystickNames](Input.GetJoystickNames.html)).  
---|---  
...
Preconfigured joysticks report indices for buttons and axes in the following
order. Buttons: A, B, X, Y, left bumper, right bumper, select, start, guide,
left stick press, right stick press Axes: left stick x, left stick y, left
trigger, right stick x, right stick y, right trigger, dpad horizontal, dpad
vertical.
