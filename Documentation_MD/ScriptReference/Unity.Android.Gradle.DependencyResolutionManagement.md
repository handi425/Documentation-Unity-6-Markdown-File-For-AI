...
For more information about the element, see Android's documentation: [Remote
repositories](https://developer.android.com/studio/build/dependencies#remote-
repositories)

### Properties

[Repositories](Unity.Android.Gradle.DependencyResolutionManagement.Repositories.html)|
The C# definition of the repositories element in a gradle file.  
---|---  
[RepositoriesMode](Unity.Android.Gradle.DependencyResolutionManagement.RepositoriesMode.html)|
The repository mode configures how repositories are setup in the build.  
  
### Constructors

[DependencyResolutionManagement](Unity.Android.Gradle.DependencyResolutionManagement-
ctor.html)| Element constructor.  
---|---  
  
### Public Methods

[AddPlugin](Unity.Android.Gradle.DependencyResolutionManagement.AddPlugin.html)|
Adds a plugin.  
---|---  
