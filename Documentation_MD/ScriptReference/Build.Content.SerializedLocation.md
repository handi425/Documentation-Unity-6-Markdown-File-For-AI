...
[fileName](Build.Content.SerializedLocation-fileName.html)| File path on disk
where the object was serialized.  
---|---  
[offset](Build.Content.SerializedLocation-offset.html)| Byte offset for the
start of the object's data.  
[size](Build.Content.SerializedLocation-size.html)| Size of the object's data.  
