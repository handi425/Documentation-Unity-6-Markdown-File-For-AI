...
interface in UnityEngine.LowLevelPhysics
...
[GeometryType](LowLevelPhysics.IGeometry.GeometryType.html)| Return the
geometry type of the shape that implemented this interface.  
---|---  
