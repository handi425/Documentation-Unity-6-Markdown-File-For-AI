...
Makes a dropdown for switching between enum flag values that are marked with
the Flags attribute.
...
top of the menu. The names for the values 0 and ~0 can be overriden by
defining these values in the enum type.  
  
For more information, refer to [UXML element EnumFlagsField](../Manual/UIE-
uxml-element-EnumFlagsField.html).

### Static Properties

[inputUssClassName](UIElements.EnumFlagsField-inputUssClassName.html)|  USS
class name for input elements of this type.  
---|---  
[labelUssClassName](UIElements.EnumFlagsField-labelUssClassName.html)|  USS
class name for labels of this type.  
[ussClassName](UIElements.EnumFlagsField-ussClassName.html)|  USS class name
for elements of this type.  
  
### Constructors

[EnumFlagsField](UIElements.EnumFlagsField-ctor.html)|  Constructs an
EnumFlagsField with a default value, and initializes its underlying type.  
---|---  
  
### Public Methods

[Init](UIElements.EnumFlagsField.Init.html)|  Initializes the EnumFlagsField
with a default value, and initializes its underlying type.  
---|---  
