...
#  [QualitySettings](QualitySettings.html).IncreaseLevel
...
Increase the current quality level.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            [QualitySettings.IncreaseLevel](QualitySettings.IncreaseLevel.html)(false);
        }
    }
...
Additional resources: [DecreaseLevel](QualitySettings.DecreaseLevel.html),
