...
#  [ISelectorEngine](SearchService.ISelectorEngine.html).SelectObject
...
public bool
SelectObject([SearchService.ISearchContext](SearchService.ISearchContext.html)
context, Action<Object,bool> onObjectSelectorClosed, Action<Object>
...
**bool** True if the search engine handles the object select operation, false
otherwise. If false is returned, the default object selector is used instead.

### Description

This function is called when a window must be opened to perform a search and
select operation.
