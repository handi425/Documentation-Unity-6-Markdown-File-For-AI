...
Inherits from:[UIElements.Button](UIElements.Button.html)
...
A button for the toolbar. For more information, refer to [UXML element
ToolbarButton](../Manual/UIE-uxml-element-ToolbarButton.html).
...
[ToolbarButton](UIElements.ToolbarButton-ctor.html)|  Constructor.  
---|---  
