...
[Switch to Manual](../Manual/class-MeshRenderer.html "Go to MeshRenderer
Component in the Manual")

### Description

Renders meshes inserted by the [MeshFilter](MeshFilter.html) or
[TextMesh](TextMesh.html).

### Properties

[additionalVertexStreams](MeshRenderer-additionalVertexStreams.html)| Vertex
attributes in this mesh will override or add attributes of the primary mesh in
the MeshRenderer.  
---|---  
[enlightenVertexStream](MeshRenderer-enlightenVertexStream.html)| Vertex
attributes that override the primary mesh when the MeshRenderer uses lightmaps
in the Realtime Global Illumination system.  
[receiveGI](MeshRenderer-receiveGI.html)| Determines how the object will
receive global illumination. (Editor only)  
[scaleInLightmap](MeshRenderer-scaleInLightmap.html)| Specifies the relative
lightmap resolution of this object. (Editor only)  
[stitchLightmapSeams](MeshRenderer-stitchLightmapSeams.html)| When enabled,
seams in baked lightmaps will get smoothed. (Editor only)  
[subMeshStartIndex](MeshRenderer-subMeshStartIndex.html)| Index of the first
sub-mesh to use from the Mesh associated with this MeshRenderer (Read Only).  
