...
Makes a field for editing an [Gradient](Gradient.html). For more information,
refer to [UXML element GradientField](../Manual/UIE-uxml-element-
GradientField.html).

### Static Properties

[backgroundUssClassName](UIElements.GradientField-
backgroundUssClassName.html)|  USS class name for the background of the
gradient visual in the GradientField element.  
---|---  
[contentUssClassName](UIElements.GradientField-contentUssClassName.html)|  USS
class name for the content for the gradient visual in the GradientField
element.  
[inputUssClassName](UIElements.GradientField-inputUssClassName.html)|  USS
class name for input elements in elements of this type.  
[labelUssClassName](UIElements.GradientField-labelUssClassName.html)|  USS
class name for labels in elements of this type.  
[ussClassName](UIElements.GradientField-ussClassName.html)|  USS class name
for elements of this type.  
  
### Properties

[colorSpace](UIElements.GradientField-colorSpace.html)|  The color space
currently used by the field.  
---|---  
[hdr](UIElements.GradientField-hdr.html)|  If true, treats the color as an HDR
value. If false, treats the color as a standard LDR value.  
[value](UIElements.GradientField-value.html)|  The Gradient currently being
exposed by the field.  
  
### Constructors

[GradientField](UIElements.GradientField-ctor.html)|  Constructor.  
---|---  
