...
#  [Shader](Shader.html).FindTextureStack
...
public bool FindTextureStack(int propertyIndex, out string stackName, out int
layerIndex);
...
**bool** True, if a stack was found for the given texture property, false if
not.
