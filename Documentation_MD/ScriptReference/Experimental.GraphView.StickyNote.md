...
Implements interfaces:[IResizable](Experimental.GraphView.IResizable.html)
...
[defaultSize](Experimental.GraphView.StickyNote-defaultSize.html)| The default
size of the [StickyNote].  
---|---  
  
### Properties

[contents](Experimental.GraphView.StickyNote-contents.html)| The textual
content of the [StickyNote].  
---|---  
[fontSize](Experimental.GraphView.StickyNote-fontSize.html)| The font size of
the [StickyNote].  
[theme](Experimental.GraphView.StickyNote-theme.html)| The visual theme of the
[StickyNote].  
[title](Experimental.GraphView.StickyNote-title.html)| The title of the
[StickyNote].  
  
### Constructors

[StickyNote](Experimental.GraphView.StickyNote-ctor.html)| Constructor for
[StickyNote].  
---|---  
  
### Public Methods

[BuildContextualMenu](Experimental.GraphView.StickyNote.BuildContextualMenu.html)|
Builds the [StickyNote] contextual menu.  
---|---  
[FitText](Experimental.GraphView.StickyNote.FitText.html)| Resizes the
[StickyNote] so that its textual content is visible.  
[GetPosition](Experimental.GraphView.StickyNote.GetPosition.html)| Gets the
position of the [StickyNote].  
[OnResized](Experimental.GraphView.StickyNote.OnResized.html)| Called when the
[StickyNote] is about to be resized.  
[OnStartResize](Experimental.GraphView.StickyNote.OnStartResize.html)| Called
when the [StickyNote] will be resized.  
[SetPosition](Experimental.GraphView.StickyNote.SetPosition.html)| Sets the
position of the [StickyNote].  
