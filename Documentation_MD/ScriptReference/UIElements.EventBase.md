...
The base class for all UIElements events. The class implements IDisposable to
ensure proper release of the event from the pool and of any unmanaged
...
[eventTypeId](UIElements.EventBase-eventTypeId.html)|  Retrieves the type ID
...
[Dispose](UIElements.EventBase.Dispose.html)|  Implementation of IDisposable.  
---|---  
...
[Init](UIElements.EventBase.Init.html)|  Resets all event members to their
initial values.  
---|---  
