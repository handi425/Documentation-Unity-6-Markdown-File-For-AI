...
#  [Resources](Resources.html).InstanceIDToObjectList
...
public static void InstanceIDToObjectList(NativeArray<int> instanceIDs,
List<Object> objects);
...
This is similar to [InstanceIDToObject](Resources.InstanceIDToObject.html) but
resolves several IDs at once.
