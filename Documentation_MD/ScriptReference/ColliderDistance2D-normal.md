...
#  [ColliderDistance2D](ColliderDistance2D.html).normal
...
The normalized vector points from [pointB](ColliderDistance2D-pointB.html) to
[pointA](ColliderDistance2D-pointA.html). When it is scaled with the
[distance](ColliderDistance2D-distance.html) is produces a vector that can be
