...
#  [EditorGUI](EditorGUI.html).LongField
...
public static long LongField([Rect](Rect.html) position, string label, long
value, [GUIStyle](GUIStyle.html) style = EditorStyles.numberField);

## Declaration

public static long LongField([Rect](Rect.html) position,
[GUIContent](GUIContent.html) label, long value, [GUIStyle](GUIStyle.html)
