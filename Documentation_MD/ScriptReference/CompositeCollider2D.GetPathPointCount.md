...
#  [CompositeCollider2D](CompositeCollider2D.html).GetPathPointCount
...
Gets the number of points in the specified path from the Collider by its
index.

Additional resources: [GetPath](CompositeCollider2D.GetPath.html) &
