...
'b' key.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void [Update](PlayerLoop.Update.html)()
        {
            ...
            if ([Input.GetKeyDown](Input.GetKeyDown.html)([KeyCode.B](KeyCode.B.html)))
                [Debug.Log](Debug.Log.html)("B key was pressed.");  
      
            //Detect when the B arrow key has been released
            if ([Input.GetKeyUp](Input.GetKeyUp.html)([KeyCode.B](KeyCode.B.html)))
                [Debug.Log](Debug.Log.html)("B key was released.");
        }
    }
