...
#
[ToggleButtonGroupState](UIElements.ToggleButtonGroupState.html).FromEnumFlags
...
FromEnumFlags(T options, int length);
...
**ToggleButtonGroupState** A ToggleButtonGroupState based on the EnumFlag
