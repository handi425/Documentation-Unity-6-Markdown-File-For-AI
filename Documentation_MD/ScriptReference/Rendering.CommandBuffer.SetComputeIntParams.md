...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetComputeIntParams
...
public void SetComputeIntParams([ComputeShader](ComputeShader.html)
computeShader, string name, params int[] values);

## Declaration

public void SetComputeIntParams([ComputeShader](ComputeShader.html)
computeShader, int nameID, params int[] values);
...
vector array values. For example, `int4 myArray[2]` in the compute shader can
be filled by passing 8 integers. See [Compute Shaders](../Manual/class-
