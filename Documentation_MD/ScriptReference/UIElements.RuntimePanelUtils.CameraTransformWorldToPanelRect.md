...
#
[RuntimePanelUtils](UIElements.RuntimePanelUtils.html).CameraTransformWorldToPanelRect
...
CameraTransformWorldToPanelRect([UIElements.IPanel](UIElements.IPanel.html)
panel, [Vector3](Vector3.html) worldPosition, [Vector2](Vector2.html)
worldSize, [Camera](Camera.html) camera);
...
**Rect** A (position, size) Rect in panel coordinates that corresponds to the
provided world position and size.
