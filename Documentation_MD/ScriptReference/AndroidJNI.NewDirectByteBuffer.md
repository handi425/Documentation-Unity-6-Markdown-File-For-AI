...
#  [AndroidJNI](AndroidJNI.html).NewDirectByteBuffer
...
Allocates and returns a direct java.nio.ByteBuffer referring to the same block
of memory as the given NativeArray.
