...
#  [PBXProject](iOS.Xcode.PBXProject.html).SetTeamId
...
Use the [Apple developer
site](https://developer.apple.com/account/#/membership) to find your Team ID.
    ...
    public class Sample_SetTeamId  
    {
        ...
        {  
            ...
            // Set team ID for selected target by specifying the 10-character ID string
