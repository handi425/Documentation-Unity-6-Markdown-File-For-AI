...
#  [LightingSettings](LightingSettings.html).lightmapMaxSize
...
The default value is 1024. Values are squared, so a value of 1024 results in a
maximum resolution of 1024 x 1024. Smaller lightmaps might also be generated
instead. This happens if it is possible to fit the required UVs into a smaller
texture.  
...
the **Max Lightmap Size** property in the Lighting Settings Asset Inspector.  
