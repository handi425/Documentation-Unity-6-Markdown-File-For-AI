...
Allows interactive manipulation of elements (drag, hide) over a virtual
placemat.

### Properties

[Collapsed](Experimental.GraphView.Placemat.Collapsed.html)| Whether the
placemat is collapsed (true) or expanded (false).  
---|---  
[CollapsedElements](Experimental.GraphView.Placemat.CollapsedElements.html)|
The list of elements hidden by the placemat when collapsed. The list is empty
when the placemat is expanded.  
[CollapsedSize](Experimental.GraphView.Placemat.CollapsedSize.html)| The size
of the placemat when collapsed.  
[Color](Experimental.GraphView.Placemat.Color.html)| The color of the
placemat.  
[ExpandedPosition](Experimental.GraphView.Placemat.ExpandedPosition.html)| The
rect representing the expanded placemat, regardless of the current collapsed
state.  
[title](Experimental.GraphView.Placemat-title.html)| The title of the
placemat.  
[UncollapsedSize](Experimental.GraphView.Placemat.UncollapsedSize.html)| The
size of the placemat when expanded.  
[ZOrder](Experimental.GraphView.Placemat.ZOrder.html)| The Z order of the
placemat in the PlacematContainer.  
  
### Constructors

[Placemat](Experimental.GraphView.Placemat-ctor.html)| Constructor.  
---|---  
  
### Public Methods

[SetPosition](Experimental.GraphView.Placemat.SetPosition.html)| Sets the
placemat position  
---|---  
[StartEditTitle](Experimental.GraphView.Placemat.StartEditTitle.html)| Sets
the focus to the title of placemat and sets the title for editing.  
  
### Protected Methods

[BuildContextualMenu](Experimental.GraphView.Placemat.BuildContextualMenu.html)|
Adds menu items to the placemat contextual menu.  
---|---  
[SetCollapsedElements](Experimental.GraphView.Placemat.SetCollapsedElements.html)|
Sets the list of collapsed elements. This method is not meant to be called.  
  
### Static Methods

[ComputeElementBounds](Experimental.GraphView.Placemat.ComputeElementBounds.html)|
