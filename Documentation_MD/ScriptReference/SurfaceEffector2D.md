...
This effector can be used to create constant speed elevators and moving
surfaces.

### Properties

[forceScale](SurfaceEffector2D-forceScale.html)| The scale of the impulse
force applied while attempting to reach the surface speed.  
---|---  
[speed](SurfaceEffector2D-speed.html)| The speed to be maintained along the
surface.  
[speedVariation](SurfaceEffector2D-speedVariation.html)| The speed variation
(from zero to the variation) added to base speed to be applied.  
[useBounce](SurfaceEffector2D-useBounce.html)| Should bounce be used for any
contact with the surface?  
[useContactForce](SurfaceEffector2D-useContactForce.html)| Should the impulse
force but applied to the contact point?  
[useFriction](SurfaceEffector2D-useFriction.html)| Should friction be used for
