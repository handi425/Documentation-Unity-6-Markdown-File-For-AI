...
#
[ParticleSystem.CollisionModule](ParticleSystem.CollisionModule.html).radiusScale
...
Useful for improving the visual accuracy of collisions, for example when there
is an alpha border in the particle texture. Additional resources:
[ParticleSystem.collision](ParticleSystem-collision.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void OnGUI()
        {
            hSliderValue = [GUI.HorizontalSlider](GUI.HorizontalSlider.html)(new [Rect](Rect.html)(25, 40, 100, 30), hSliderValue, 0.0F, 2.0F);
        }
    }
