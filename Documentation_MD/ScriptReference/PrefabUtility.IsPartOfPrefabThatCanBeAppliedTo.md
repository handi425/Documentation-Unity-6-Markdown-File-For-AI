...
#  [PrefabUtility](PrefabUtility.html).IsPartOfPrefabThatCanBeAppliedTo
...
public static bool IsPartOfPrefabThatCanBeAppliedTo([Object](Object.html)
...
Examples of Prefab Assets that cannot be applied to are immutable Prefab
Assets and Prefab Assets with missing scripts.  
...
that have corresponding assets that can be applied to. To check if an object
is part of the Prefab’s contents in Prefab Mode, use
