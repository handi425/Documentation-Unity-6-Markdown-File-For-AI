...
Configures this project and each of its sub-projects. For more information
about the element, see Gradle's documentation: [allprojects
element](https://docs.gradle.org/current/dsl/org.gradle.api.Project.html#org.gradle.api.Project:allprojects\(groovy.lang.Closure\))

### Properties

[Buildscript](Unity.Android.Gradle.AllProjects.Buildscript.html)| The C#
definition of the buildscript element in a gradle file.  
---|---  
[Repositories](Unity.Android.Gradle.AllProjects.Repositories.html)| The C#
definition of the repositories element in a gradle file.  
[Version](Unity.Android.Gradle.AllProjects.Version.html)| The C# definition of
the version element in a gradle file.  
  
### Constructors

[AllProjects](Unity.Android.Gradle.AllProjects-ctor.html)| Element
constructor.  
---|---  
