...
#  [ToggleButtonGroupState](UIElements.ToggleButtonGroupState.html).Equals
...
public bool
Equals([UIElements.ToggleButtonGroupState](UIElements.ToggleButtonGroupState.html)
other);
...
**bool** True if both option has the same data and number of options,
