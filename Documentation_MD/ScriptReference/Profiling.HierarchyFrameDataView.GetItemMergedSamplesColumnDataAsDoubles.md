...
#
[HierarchyFrameDataView](Profiling.HierarchyFrameDataView.html).GetItemMergedSamplesColumnDataAsDoubles
...
public void GetItemMergedSamplesColumnDataAsDoubles(int id, int column,
...
Use _GetItemMergedSamplesColumnDataAsDoubles_ to obtain double values for
individual samples in a merged hierarchy.  
The resulting list of doubles is written to _outValues_. This list is resized
if necessary.  
