...
#  [UnityEventBase](Events.UnityEventBase.html).GetValidMethodInfo
...
public static
[Profiling.FrameDataView.MethodInfo](Profiling.FrameDataView.MethodInfo.html)
GetValidMethodInfo(Type objectType, string functionName, Type[]
argumentTypes);
...
Given an object type, function name, and a list of argument types; find the
method that matches.
