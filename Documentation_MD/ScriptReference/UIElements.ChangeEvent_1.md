...
Implements interfaces:[IChangeEvent](UIElements.IChangeEvent.html)
...
[newValue](UIElements.ChangeEvent_1-newValue.html)|  The new value.  
---|---  
[previousValue](UIElements.ChangeEvent_1-previousValue.html)|  The value
before the change occured.  
  
### Constructors

[ChangeEvent_1](UIElements.ChangeEvent_1-ctor.html)|  Constructor.  
---|---  
  
### Protected Methods

[Init](UIElements.ChangeEvent_1.Init.html)|  Sets the event to its initial
state.  
---|---  
  
### Static Methods

[GetPooled](UIElements.ChangeEvent_1.GetPooled.html)|  Gets an event from the
