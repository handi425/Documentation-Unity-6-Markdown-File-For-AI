...
#
[BuildAssetBundleOptions](BuildAssetBundleOptions.html).AppendHashToAssetBundleName
...
This allows you to append the hash to the assetBundle name.
    ...
    //This script creates a new [Menu](Menu.html) named “Build [Asset](VersionControl.Asset.html)” and new options within the menu named “Normal” and “Append Hash To [Asset](VersionControl.Asset.html) [Bundle](Unity.Android.Gradle.Bundle.html) Name”. Click these menu items to build an [AssetBundle](AssetBundle.html).  
    ...
    public class Example
    {
        ...
        //Creates a new item (Append Hash) in the new Build [Asset](VersionControl.Asset.html) Bundles menu
        [[MenuItem](MenuItem.html)("Build [Asset](VersionControl.Asset.html) Bundles/Append Hash")]
        static void BuildABsAppend()
        {
            //Build the AssetBundles in this mode
            [BuildPipeline.BuildAssetBundles](BuildPipeline.BuildAssetBundles.html)("Assets/MyAssetBuilds", [BuildAssetBundleOptions.AppendHashToAssetBundleName](BuildAssetBundleOptions.AppendHashToAssetBundleName.html), [BuildTarget.StandaloneOSX](BuildTarget.StandaloneOSX.html));
        }
    }
