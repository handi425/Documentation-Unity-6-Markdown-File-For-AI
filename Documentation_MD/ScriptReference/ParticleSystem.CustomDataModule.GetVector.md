...
#
[ParticleSystem.CustomDataModule](ParticleSystem.CustomDataModule.html).GetVector
...
GetVector([ParticleSystemCustomData](ParticleSystemCustomData.html) stream,
int component);
...
Get a [MinMaxCurve](ParticleSystem.MinMaxCurve.html), that is being used to
generate custom data.

Additional resources:
[ParticleSystem.CustomDataModule.SetVector](ParticleSystem.CustomDataModule.SetVector.html),
