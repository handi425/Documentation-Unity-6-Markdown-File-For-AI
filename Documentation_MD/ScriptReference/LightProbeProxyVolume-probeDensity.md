...
#  [LightProbeProxyVolume](LightProbeProxyVolume.html).probeDensity
...
This value is used only when the [resolutionMode](LightProbeProxyVolume-
resolutionMode.html) is **Automatic**.
