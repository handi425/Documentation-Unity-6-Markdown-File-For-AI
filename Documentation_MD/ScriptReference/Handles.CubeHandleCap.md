...
#  [Handles](Handles.html).CubeHandleCap
...
public static void CubeHandleCap(int controlID, [Vector3](Vector3.html)
...
![](../StaticFiles/ScriptRefImages/CubeCap.png) _Cube Handle Cap in the Scene
View._  
  
Add the following script to your Assets folder as CubeExample.cs and add the
CubeExample component to an object in the Scene.
...
Add the following script to Assets/Editor as CubeExampleEditor.cs and select
the object with the CubeExample component.
    ...
    public class CubeExampleEditor : [Editor](Editor.html)
    {
        float size = 1f;  
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            {
                [Transform](Transform.html) transform = ((CubeExample)target).transform;
