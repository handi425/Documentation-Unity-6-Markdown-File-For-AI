...
#  [CameraEditorUtils](CameraEditorUtils.html).PerspectiveClipToWorld
...
PerspectiveClipToWorld([Matrix4x4](Matrix4x4.html) clipToWorld,
[Vector3](Vector3.html) viewPositionWS, [Vector3](Vector3.html) positionCS);
...
The z component will be used to get the point at the distance z from the
viewer.
