...
#  [PlayerSettings](PlayerSettings.html).GetPropertyBool
...
[BuildTargetGroup](BuildTargetGroup.html) target);
...
This is now obsolete. Use an explicit API instead. For example,
PlayerSettings.WebGL.useEmbeddedResources.

Additional resources: SetPropertyBool.
