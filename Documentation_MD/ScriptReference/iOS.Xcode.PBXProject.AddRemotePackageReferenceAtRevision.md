...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddRemotePackageReferenceAtRevision
...
public string AddRemotePackageReferenceAtRevision(string url, string
revision);
...
Adds a reference to the remote package at the given revision.
    ...
    public class Sample_AddRemotePackageReferenceAtRevision  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID of the [Remote](tvOS.Remote.html) [Package](Unity.Android.Gradle.Manifest.Package.html) using the URL and revision
            string packageGuid = pbxProject.AddRemotePackageReferenceAtRevision("https://github.com/apple/swift-system.git", "403776dc2aa36b585b0bd5e78d2313e2c59163b8");  
