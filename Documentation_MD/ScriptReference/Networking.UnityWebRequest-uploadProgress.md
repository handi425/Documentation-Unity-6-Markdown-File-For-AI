...
#  [UnityWebRequest](Networking.UnityWebRequest.html).uploadProgress
...
the remote server, and [uploadHandler](Networking.UnityWebRequest-
uploadHandler.html) is `null`, this property will return zero. If
