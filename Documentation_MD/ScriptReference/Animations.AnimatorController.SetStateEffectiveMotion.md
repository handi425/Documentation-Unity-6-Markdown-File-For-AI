...
#
[AnimatorController](Animations.AnimatorController.html).SetStateEffectiveMotion
...
public void
SetStateEffectiveMotion([Animations.AnimatorState](Animations.AnimatorState.html)
state, [Motion](Motion.html) motion);

## Declaration

public void
SetStateEffectiveMotion([Animations.AnimatorState](Animations.AnimatorState.html)
state, [Motion](Motion.html) motion, int layerIndex);
