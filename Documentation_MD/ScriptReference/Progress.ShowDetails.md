...
#  [Progress](Progress.html).ShowDetails
...
You can use this window to monitor all running progress indicators and
finished tasks. You can also use it to cancel any running progress indicator's
associated task.
