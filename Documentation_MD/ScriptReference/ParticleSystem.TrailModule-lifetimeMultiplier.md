...
#
[ParticleSystem.TrailModule](ParticleSystem.TrailModule.html).lifetimeMultiplier
...
A multiplier for
[ParticleSystem.TrailModule.lifetime](ParticleSystem.TrailModule-
lifetime.html).

This is more efficient than accessing the whole curve, if you only want to
change the overall lifetime multiplier.
