...
#  [TrailRenderer](TrailRenderer.html).GetVisiblePositions
...
This method is similar to [GetPositions](TrailRenderer.GetPositions.html),
except that it will not return positions that the Trail Renderer created while
[emitting](TrailRenderer-emitting.html) was set to `false`.
