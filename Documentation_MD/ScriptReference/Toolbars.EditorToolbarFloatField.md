...
Inherits from:[UIElements.FloatField](UIElements.FloatField.html)
...
A float field used with
[EditorToolbarElementAttribute](Toolbars.EditorToolbarElementAttribute.html).

### Constructors

[EditorToolbarFloatField](Toolbars.EditorToolbarFloatField-ctor.html)| Creates
a float field visual element that is styled to match a toolbar in an
