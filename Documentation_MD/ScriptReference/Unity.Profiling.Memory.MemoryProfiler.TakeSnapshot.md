...
* When you call this from a Player that is **not** connected to an Editor via [PlayerConnection](Networking.PlayerConnection.PlayerConnection.html), the file is created on the host device of the Player.  
