...
[changedProperty](UIElements.SerializedPropertyChangeEvent-
changedProperty.html)|  The SerializedProperty whose value changed.  
---|---  
  
### Constructors

[SerializedPropertyChangeEvent](UIElements.SerializedPropertyChangeEvent-
ctor.html)|  Constructor. Use GetPooled instead.  
---|---  
  
### Protected Methods

[Init](UIElements.SerializedPropertyChangeEvent.Init.html)|  Sets the event to
its initial state.  
---|---  
  
### Static Methods

[GetPooled](UIElements.SerializedPropertyChangeEvent.GetPooled.html)|  Gets an
event from the event pool and initializes it with the values provided. Use
this function instead of creating new events. Events obtained using this
