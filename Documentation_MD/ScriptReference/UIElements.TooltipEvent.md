...
[VisualElement.tooltip](UIElements.VisualElement-tooltip.html) to compute
tooltips only when they are about to be displayed.

### Properties

[rect](UIElements.TooltipEvent-rect.html)|  Rectangle of the hovered
VisualElement in the panel coordinate system.  
---|---  
[tooltip](UIElements.TooltipEvent-tooltip.html)|  Text to display inside the
tooltip box.  
  
### Constructors

[TooltipEvent](UIElements.TooltipEvent-ctor.html)|  Initializes and returns an
instance of TooltipEvent.  
---|---  
  
### Protected Methods

[Init](UIElements.TooltipEvent.Init.html)|  Resets the event members to their
initial values.  
---|---  
