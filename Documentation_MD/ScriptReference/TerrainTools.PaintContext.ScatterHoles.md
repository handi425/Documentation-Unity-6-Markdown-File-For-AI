...
#  [PaintContext](TerrainTools.PaintContext.html).ScatterHoles
...
Applies an edited Terrain holes PaintContext by copying modifications back to
the source Terrain tiles.
...
Terrain. ScatterHoles performs this copy. This function will also create a
delayed action to rebuild collision, physics, grass, trees and details.  
  
This function is called internally by
[TerrainPaintUtility.EndPaintHoles](TerrainTools.TerrainPaintUtility.EndPaintHoles.html).  
  
Additional resources:
[PaintContext.GatherHoles](TerrainTools.PaintContext.GatherHoles.html) and
