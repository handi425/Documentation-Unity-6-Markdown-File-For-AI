...
#  [AnimationCurve](AnimationCurve.html).Constant
...
public static [AnimationCurve](AnimationCurve.html) Constant(float timeStart,
float timeEnd, float value);
...
Creates a constant "curve" starting at `timeStart`, ending at `timeEnd`, and
