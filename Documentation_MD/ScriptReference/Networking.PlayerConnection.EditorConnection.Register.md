...
#
[EditorConnection](Networking.PlayerConnection.EditorConnection.html).Register
...
There can be multiple registered callbacks for one message ID, and these can
be deregistered individually with
[EditorConnection.Unregister](Networking.PlayerConnection.EditorConnection.Unregister.html).
