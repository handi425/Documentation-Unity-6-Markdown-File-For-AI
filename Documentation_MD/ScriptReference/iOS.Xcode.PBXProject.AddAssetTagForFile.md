...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddAssetTagForFile
...
public void AddAssetTagForFile(string targetGuid, string fileGuid, string
tag);
...
The asset tags identify resources that are downloaded via On Demand Resources
functionality. A request for a specific tag initiates the download of all
files, configured for that tag.
