...
#  [PBXProject](iOS.Xcode.PBXProject.html).RemoveFileFromBuild
...
Removes the given file from the list of files to build for the given target.
    ...
    public class Sample_RemoveFileFromBuild  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the file GUID you want to remove
            string filePath = "Path/To/ExampleFile.txt";
            string fileGuid = pbxProject.FindFileGuidByProjectPath(filePath);  
      
            // Remove the file from build. Note that this doesn't remove the file from project
