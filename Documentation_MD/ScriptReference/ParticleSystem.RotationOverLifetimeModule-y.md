...
#
[ParticleSystem.RotationOverLifetimeModule](ParticleSystem.RotationOverLifetimeModule.html).y
...
Additional resources: [MinMaxCurve](ParticleSystem.MinMaxCurve.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            rotationOverLifetime.y = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)([Mathf.PI](Mathf.PI.html) * 2.0f, curve);
