...
#  [Camera](Camera.html).GetStereoProjectionMatrix
...
GetStereoProjectionMatrix([Camera.StereoscopicEye](Camera.StereoscopicEye.html)
eye);
...
The projection matrix will be provided by the VR SDK unless
[Camera.SetStereoProjectionMatrix](Camera.SetStereoProjectionMatrix.html) or
Camera.SetStereoProjectionMatrices have been used, in which case this method
will return the value given to those methods. You can use
