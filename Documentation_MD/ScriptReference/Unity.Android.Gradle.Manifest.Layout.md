...
For more information about the element, see Android's documentation: [Layout
element](https://developer.android.com/reference/android/content/pm/ActivityInfo.WindowLayout)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.Layout.Attributes.html)| The
attributes container for the <layout> element.  
---|---  
  
### Constructors

[Layout](Unity.Android.Gradle.Manifest.Layout-ctor.html)| Element constructor.  
---|---  
