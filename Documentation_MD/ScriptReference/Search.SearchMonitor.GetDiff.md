...
#  [SearchMonitor](Search.SearchMonitor.html).GetDiff
...
public static [Search.AssetIndexChangeSet](Search.AssetIndexChangeSet.html)
GetDiff(long timestamp, IEnumerable<string> deletedAssets, Func<string,bool>
predicate);
