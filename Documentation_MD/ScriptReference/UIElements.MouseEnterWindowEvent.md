...
Event sent when the mouse pointer enters a window. The event bubbles up but
does not trickle down.

### Constructors

[MouseEnterWindowEvent](UIElements.MouseEnterWindowEvent-ctor.html)|
...
[Init](UIElements.MouseEnterWindowEvent.Init.html)|  Resets the event members
