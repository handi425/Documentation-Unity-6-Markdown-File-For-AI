...
Makes a field for selecting a color. For more information, refer to [UXML
element ColorField](../Manual/UIE-uxml-element-ColorField.html).

### Static Properties

[colorContainerUssClassName](UIElements.ColorField-
colorContainerUssClassName.html)|  USS class name of color container elements
in elements of this type.  
---|---  
[colorUssClassName](UIElements.ColorField-colorUssClassName.html)|  USS class
name of color elements in elements of this type.  
[eyeDropperUssClassName](UIElements.ColorField-eyeDropperUssClassName.html)|
USS class name of eyedropper elements in elements of this type.  
[gradientContainerUssClassName](UIElements.ColorField-
gradientContainerUssClassName.html)|  USS class name of gradient container
elements in elements of this type.  
[hdrLabelUssClassName](UIElements.ColorField-hdrLabelUssClassName.html)|  USS
class name of hdr label elements in elements of this type.  
[inputUssClassName](UIElements.ColorField-inputUssClassName.html)|  USS class
name of input elements in elements of this type.  
[labelUssClassName](UIElements.ColorField-labelUssClassName.html)|  USS class
name of labels in elements of this type.  
[mixedValueColorUssClassName](UIElements.ColorField-
mixedValueColorUssClassName.html)|  USS class name of color elements in
elements of this type when showing mixed values.  
[ussClassName](UIElements.ColorField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[hdr](UIElements.ColorField-hdr.html)|  If true, treats the color as an HDR
value. If false, treats the color as a standard LDR value.  
---|---  
[showAlpha](UIElements.ColorField-showAlpha.html)|  If true, allows the user
to set an alpha value for the color. If false, hides the alpha component.  
[showEyeDropper](UIElements.ColorField-showEyeDropper.html)|  If true, the
color picker will show the eyedropper control. If false, the color picker
won't show the eyedropper control.  
  
### Constructors

[ColorField](UIElements.ColorField-ctor.html)|  Initializes and returns an
instance of ColorField.  
---|---  
