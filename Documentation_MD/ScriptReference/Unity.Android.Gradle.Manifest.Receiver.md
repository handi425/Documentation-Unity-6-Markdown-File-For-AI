...
For more information about the element, see Android's documentation: [Receiver
element](https://developer.android.com/guide/topics/manifest/receiver-element)

### Properties

[Attributes](Unity.Android.Gradle.Manifest.Receiver.Attributes.html)| The
attributes container for the <receiver> element.  
---|---  
[IntentFilterList](Unity.Android.Gradle.Manifest.Receiver.IntentFilterList.html)|
List of <intent-filter> child elements.  
[MetaDataList](Unity.Android.Gradle.Manifest.Receiver.MetaDataList.html)| List
of <meta-data> child elements.  
  
### Constructors

[Receiver](Unity.Android.Gradle.Manifest.Receiver-ctor.html)| Element
constructor.  
---|---  
