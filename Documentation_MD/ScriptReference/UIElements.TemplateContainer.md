...
Represents the root [VisualElement](UIElements.VisualElement.html) of UXML
file.

A TemplateContainer instance is created by Unity to represent the root of the
UXML file and acts as the parent for all elements in the file. Users typically
don't create TemplateContainer objects directly. When using
[VisualTreeAsset.Instantiate](UIElements.VisualTreeAsset.Instantiate.html), a
TemplateContainer instance is returned to you to represent the root of the
hierarchy. When using UXML templates, a TemplateContainer is generated for the
template instance and inserted into the hierarchy of the parent UXML file.

### Properties

[templateId](UIElements.TemplateContainer-templateId.html)|  The local ID of
the template in the parent UXML file (Read Only).  
---|---  
[templateSource](UIElements.TemplateContainer-templateSource.html)|  Stores
the template asset reference, if the generated element is cloned from a
VisualTreeAsset as a Template declaration inside another VisualTreeAsset.  
