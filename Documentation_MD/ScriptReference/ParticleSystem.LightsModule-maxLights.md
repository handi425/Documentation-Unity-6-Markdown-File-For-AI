...
#  [ParticleSystem.LightsModule](ParticleSystem.LightsModule.html).maxLights
...
This value is useful for avoiding bad performance. It is very easy to create a
high number of Lights, which negatively effects performance. Capping the
number of Lights helps to maintain performance.
