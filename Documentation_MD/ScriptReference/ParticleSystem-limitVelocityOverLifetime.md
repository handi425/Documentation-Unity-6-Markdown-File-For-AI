...
#  [ParticleSystem](ParticleSystem.html).limitVelocityOverLifetime
...
public
[ParticleSystem.LimitVelocityOverLifetimeModule](ParticleSystem.LimitVelocityOverLifetimeModule.html)
...
This module reduces particle velocities by either applying drag or simply
reducing velocity over time.  
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            lv.limit = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(10.0f, curve);
        }
    }
