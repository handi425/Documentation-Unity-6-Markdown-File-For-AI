...
Helpers for downloading multimedia files using
[UnityWebRequest](Networking.UnityWebRequest.html).

### Static Methods

[GetAudioClip](Networking.UnityWebRequestMultimedia.GetAudioClip.html)| Create
a UnityWebRequest to download an audio clip via HTTP GET and create an
