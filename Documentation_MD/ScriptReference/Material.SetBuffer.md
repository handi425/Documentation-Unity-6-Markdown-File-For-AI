...
#  [Material](Material.html).SetBuffer
...
---|---  
name | Property name.  
value | The [ComputeBuffer](ComputeBuffer.html) or [GraphicsBuffer](GraphicsBuffer.html) value to set.  
  
### Description

Sets a named buffer value.

Additional resources: [ComputeShader](ComputeShader.html),
[ComputeBuffer](ComputeBuffer.html), [GraphicsBuffer](GraphicsBuffer.html).
