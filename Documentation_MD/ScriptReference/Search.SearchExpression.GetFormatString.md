...
#  [SearchExpression](Search.SearchExpression.html).GetFormatString
...
public static bool
GetFormatString([Search.SearchExpression](Search.SearchExpression.html) expr,
out string formatStr);
...
**bool** Returns true if the SearchExpression was succesfully converted to a
format string.

### Description

Extract a format string from a given expression. This function should be used
to extract a format string from an input parameter of a SearchExpression. For
example: the evaluator print{"this is it: @label"} takes a format string as
its first parameter.
