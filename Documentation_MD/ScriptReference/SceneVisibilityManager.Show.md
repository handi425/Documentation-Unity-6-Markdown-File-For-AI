...
#  [SceneVisibilityManager](SceneVisibilityManager.html).Show
...
public void Show([GameObject](GameObject.html) gameObject, bool
includeDescendants);
...
public void Show([SceneManagement.Scene](SceneManagement.Scene.html) scene);
