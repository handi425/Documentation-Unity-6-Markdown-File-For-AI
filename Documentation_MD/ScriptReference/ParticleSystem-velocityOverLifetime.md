...
#  [ParticleSystem](ParticleSystem.html).velocityOverLifetime
...
public
[ParticleSystem.VelocityOverLifetimeModule](ParticleSystem.VelocityOverLifetimeModule.html)
...
are interfaces and not independent objects.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html) {
        void Start() {
            ...
            vel.enabled = true;
            vel.space = [ParticleSystemSimulationSpace.Local](ParticleSystemSimulationSpace.Local.html);  
      
            [AnimationCurve](AnimationCurve.html) curve = new [AnimationCurve](AnimationCurve.html)();
            curve.AddKey(0.0f, 1.0f);
            curve.AddKey(1.0f, 0.0f);
            vel.x = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(10.0f, curve);
        }
    }
