...
#  [MeshGenerationResult](XR.MeshGenerationResult.html).Position
...
The position associated with the generated mesh relative to the session
origin.

This value will be zero unless the
