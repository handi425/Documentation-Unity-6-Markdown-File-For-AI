...
#  [EditorGUI](EditorGUI.html).HelpBox
...
public static void HelpBox([Rect](Rect.html) position, string message,
[MessageType](MessageType.html) type);

## Declaration

public static void HelpBox([Rect](Rect.html) position,
