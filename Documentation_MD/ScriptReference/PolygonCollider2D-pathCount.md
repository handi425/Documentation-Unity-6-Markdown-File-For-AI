...
#  [PolygonCollider2D](PolygonCollider2D.html).pathCount
...
A _path_ is cyclic sequence of line segments between points that define the
...
Additional resources: [GetPath](PolygonCollider2D.GetPath.html),
