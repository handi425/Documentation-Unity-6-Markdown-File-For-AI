...
#  [Shader](Shader.html).enabledGlobalKeywords
...
This example prints the names of all currently enabled global shader keywords.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        private void Start()
        {
            foreach (var globalKeyword in [Shader.enabledGlobalKeywords](Shader-enabledGlobalKeywords.html))
            {
                [Debug.Log](Debug.Log.html)("Global shader keyword " + globalKeyword.name + " is currently enabled");
            }
        }
    }
...
[IsKeywordEnabled](Shader.IsKeywordEnabled.html), [globalKeywords](Shader-
globalKeywords.html).
