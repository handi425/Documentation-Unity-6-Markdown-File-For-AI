...
[packageName](Callbacks.RunBeforePackageAttribute-packageName.html)| The name
of the package that should be run after this callback.  
---|---  
  
### Constructors

[RunBeforePackageAttribute](Callbacks.RunBeforePackageAttribute-ctor.html)|
Add this attribute to a callback method to mark that this callback must be run
before any callbacks that are part of the specified package.  
---|---  
