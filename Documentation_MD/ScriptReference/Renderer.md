...
disabled to make objects invisible (see [enabled](Renderer-enabled.html)), and
the materials can be accessed and modified through them (see
[material](Renderer-material.html)).  
  
Additional resources: Renderer components for [meshes](../Manual/class-
MeshRenderer.html), [particles](ParticleSystemRenderer.html),
[lines](../Manual/class-LineRenderer.html) and [trails](../Manual/class-
TrailRenderer.html).
