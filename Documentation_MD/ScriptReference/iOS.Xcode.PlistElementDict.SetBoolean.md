...
#  [PlistElementDict](iOS.Xcode.PlistElementDict.html).SetBoolean
...
Convenience method to set a boolean property.
    ...
    public class PlistSetBooleanExample
    {
        [PostProcessBuild]
        public static void SetBooleanExample([BuildTarget](BuildTarget.html) buildTarget, string pathToBuiltProject)
        {
            if (buildTarget == [BuildTarget.iOS](BuildTarget.iOS.html)) 
            {
                ...
                // Use SetBoolean to change the value of "UIRequiresPersistentWiFi" to "true"
                rootDict.SetBoolean("UIRequiresPersistentWiFi", true);  
      
                // Use SetBoolean to create a new Info.plist entry called "BooleanKey" with value set to "true"
                // If a specified key doesn't already exist in the Info.plist, a new entry will be created
                rootDict.SetBoolean("BooleanKey", true);  
