...
Makes a field for editing an [AnimationCurve](AnimationCurve.html). For more
information, refer to [UXML element CurveField](../Manual/UIE-uxml-element-
CurveField.html).

### Static Properties

[contentUssClassName](UIElements.CurveField-contentUssClassName.html)|  USS
class name of content elements in elements of this type.  
---|---  
[inputUssClassName](UIElements.CurveField-inputUssClassName.html)|  USS class
name of input elements in elements of this type.  
[labelUssClassName](UIElements.CurveField-labelUssClassName.html)|  USS class
name of labels in elements of this type.  
[ussClassName](UIElements.CurveField-ussClassName.html)|  USS class name of
elements of this type.  
  
### Properties

[ranges](UIElements.CurveField-ranges.html)|  Optional rectangle that the
curve is restrained within. If the range width or height is < 0 then
CurveField computes an automatic range, which encompasses the whole curve.  
---|---  
[renderMode](UIElements.CurveField-renderMode.html)|  The RenderMode of
CurveField. The default is RenderMode.Default.  
  
### Constructors

[CurveField](UIElements.CurveField-ctor.html)|  Initializes and returns an
instance of CurveField.  
---|---  
