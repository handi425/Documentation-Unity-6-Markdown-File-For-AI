...
keywords](../Manual/shader-variants-and-keywords.html), [[[]wiki:SL-
MultipleProgramVariants|Declaring and using shader keywords in HLSL]].

### Public Methods

[Disable](Rendering.PlatformKeywordSet.Disable.html)| Disable a specific
shader keyword.  
---|---  
[Enable](Rendering.PlatformKeywordSet.Enable.html)| Enable a specific shader
keyword.  
[IsEnabled](Rendering.PlatformKeywordSet.IsEnabled.html)| Check whether a
