...
#
[SceneManagerAPI](SceneManagement.SceneManagerAPI.html).LoadSceneAsyncByNameOrIndex
...
protected [AsyncOperation](AsyncOperation.html)
LoadSceneAsyncByNameOrIndex(string sceneName, int sceneBuildIndex,
[SceneManagement.LoadSceneParameters](SceneManagement.LoadSceneParameters.html)
parameters, bool mustCompleteNextFrame);
