...
#  [RadeonRaysContext](LightTransport.RadeonRaysContext.html).CreateBuffer
...
public [LightTransport.BufferID](LightTransport.BufferID.html)
CreateBuffer(ulong count, ulong stride);
