...
#  [MaterialPropertyBlock](MaterialPropertyBlock.html).HasVector
...
Checks if [MaterialPropertyBlock](MaterialPropertyBlock.html) has the Vector
property with the given name or name ID. This also works with the Vector Array
