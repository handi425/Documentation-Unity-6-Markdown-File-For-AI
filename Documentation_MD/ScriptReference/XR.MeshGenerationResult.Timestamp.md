...
#  [MeshGenerationResult](XR.MeshGenerationResult.html).Timestamp
...
[MeshGenerationResult](XR.MeshGenerationResult.html) may be older than the
most recent transform provided by
[XRMeshSubsystem.GetUpdatedMeshTransforms](XR.XRMeshSubsystem.GetUpdatedMeshTransforms.html).
Compare timestamps to ensure you are using the most recent transform.  
