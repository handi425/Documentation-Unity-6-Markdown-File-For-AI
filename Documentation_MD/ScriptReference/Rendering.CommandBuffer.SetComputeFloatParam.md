...
#  [CommandBuffer](Rendering.CommandBuffer.html).SetComputeFloatParam
...
public void SetComputeFloatParam([ComputeShader](ComputeShader.html)
computeShader, string name, float val);

## Declaration

public void SetComputeFloatParam([ComputeShader](ComputeShader.html)
computeShader, int nameID, float val);
