...
#  [ShaderKeyword](Rendering.ShaderKeyword.html).IsValid
...
**bool** Returns true if the global shader keyword exists. Otherwise, returns
false.
...
public bool IsValid([ComputeShader](ComputeShader.html) shader);
...
public bool IsValid([Shader](Shader.html) shader);
