...
ClearCacheRequest instance when you call the
[Client.ClearCache](PackageManager.Client.ClearCache.html) method to empty the
global package cache. Use this object to determine when the request is
complete and if it succeeded.
