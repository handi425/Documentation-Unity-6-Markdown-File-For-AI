...
Generates an instance of the declaring element when the
[UxmlElementAttribute](UIElements.UxmlElementAttribute.html) is used in a
custom control.
...
[Register](UIElements.UxmlSerializedData.Register.html)|  This is used by the
code generator when a custom control is using the UxmlElementAttribute. You
