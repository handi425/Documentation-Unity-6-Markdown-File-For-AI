...
#  [PBXProject](iOS.Xcode.PBXProject.html).RemoveAssetTag
...
Removes the given asset tag from the list of configured asset tags for all
files on all targets, the list of asset tags configured for initial
installation and the list of known asset tags in the Xcode project.
    ...
    public class Sample_RemoveAssetTag  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Remove 'exampleTag' asset tag for all files on all targets in the Xcode project
