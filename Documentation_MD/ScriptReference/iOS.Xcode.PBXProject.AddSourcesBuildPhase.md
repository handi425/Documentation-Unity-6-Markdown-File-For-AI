...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddSourcesBuildPhase
...
If the sources build phase is already configured for the target, the function
...
build phases configured for the target.
    ...
    public class Sample_AddSourcesBuildPhase  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID you want to add the Sources Build Phase to
            string mainTargetGuid = pbxProject.GetUnityMainTargetGuid();  
      
            // Add the Sources Build Phase to that target
