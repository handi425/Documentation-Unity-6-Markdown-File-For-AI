...
public EditorToolbarToggle([Texture2D](Texture2D.html) icon);

## Declaration

public EditorToolbarToggle([Texture2D](Texture2D.html) onIcon,
[Texture2D](Texture2D.html) offIcon);

## Declaration

public EditorToolbarToggle(string text, [Texture2D](Texture2D.html) onIcon,
[Texture2D](Texture2D.html) offIcon);
