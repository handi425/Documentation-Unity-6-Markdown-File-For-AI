...
#
[ParticleSystem.TextureSheetAnimationModule](ParticleSystem.TextureSheetAnimationModule.html).frameOverTimeMultiplier
...
you only want to change the overall frame over time multiplier.
