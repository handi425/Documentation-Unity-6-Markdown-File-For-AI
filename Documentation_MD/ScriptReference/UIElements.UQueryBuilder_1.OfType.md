...
#  [UQueryBuilder<T0>](UIElements.UQueryBuilder_1.html).OfType
...
**UQueryBuilder <T2>** QueryBuilder configured with the associated selection
rules.

### Description

Selects all elements of the specified Type (eg: Label, Button, ScrollView,
etc).
