...
#  [EditorSettings.NamingScheme](EditorSettings.NamingScheme.html).Dot
...
Adds a dot followed by a number to the name of an instantiated or duplicated
GameObject ("Prefab.1").

When a GameObject is duplicated or instantiated, Unity copies the original
GameObject's name and adds a dot followed by a number to it, for example,
"Prefab.1".  
