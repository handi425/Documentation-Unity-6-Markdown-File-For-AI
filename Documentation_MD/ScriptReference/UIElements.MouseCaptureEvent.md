...
Inherits
from:[UIElements.MouseCaptureEventBase_1](UIElements.MouseCaptureEventBase_1.html)
...
[relatedTarget](UIElements.MouseCaptureEventBase_1-relatedTarget.html)|  In
the case of a MouseCaptureEvent, this property is the IEventHandler that loses
the capture. In the case of a MouseCaptureOutEvent, this property is the
...
event instance.  
[GetPooled](UIElements.MouseCaptureEventBase_1.GetPooled.html)|  Gets an event
