...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddResourcesBuildPhase
...
If the resources build phase is already configured for a target, the function
returns the existing phase. The new phase is placed at the end of the list of
build phases configured for the target.
    ...
    public class Sample_AddResourcesBuildPhase  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the GUID you want to add the Resoure Build Phase to
            string mainTargetGuid = pbxProject.GetUnityMainTargetGuid();  
      
            // Add the Resource Build Phase to that target
            pbxProject.AddResourcesBuildPhase(mainTargetGuid);  
