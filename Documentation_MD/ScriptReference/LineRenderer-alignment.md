...
#  [LineRenderer](LineRenderer.html).alignment
...
public [LineAlignment](LineAlignment.html) alignment;

### Description

Select whether the line will face the camera, or the orientation of the
Transform Component.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            // Set to face its [Transform](Transform.html) [Component](Component.html)
            lr.alignment = [LineAlignment.TransformZ](LineAlignment.TransformZ.html);
        }
    }
