...
[fileName](Build.Content.WriteCommand-fileName.html)| Final file name on disk
of the serialized file.  
---|---  
[internalName](Build.Content.WriteCommand-internalName.html)| Internal name
used by the loading system for a serialized file.  
[serializeObjects](Build.Content.WriteCommand-serializeObjects.html)| List of
objects and their order contained inside a serialized file.  
  
### Constructors

[WriteCommand](Build.Content.WriteCommand-ctor.html)| Default constructor for
an empty WriteCommand.  
---|---  
