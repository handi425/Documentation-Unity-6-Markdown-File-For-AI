...
#  [CommandBuffer](Rendering.CommandBuffer.html).EnableShaderKeyword
...
If a global keyword with the name you pass in does not exist, Unity creates
one with that name when you call this function. To get all the global keywords
that already exist, use [Shader.globalKeywords](Shader-globalKeywords.html).
