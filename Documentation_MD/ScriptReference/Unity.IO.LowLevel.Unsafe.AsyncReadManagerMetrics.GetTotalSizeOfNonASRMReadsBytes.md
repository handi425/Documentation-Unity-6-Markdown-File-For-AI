...
#
[AsyncReadManagerMetrics](Unity.IO.LowLevel.Unsafe.AsyncReadManagerMetrics.html).GetTotalSizeOfNonASRMReadsBytes
...
**ulong** Number of bytes of data read through systems other than the
[AsyncReadManager](Unity.IO.LowLevel.Unsafe.AsyncReadManager.html) since you
started metrics collection or you cleared this data counter by setting
`emptyAfterRead` to `true`.
