...
[angularDrag](AreaEffector2D-angularDrag.html)| The angular drag to apply to
rigid-bodies.  
---|---  
[drag](AreaEffector2D-drag.html)| The linear drag to apply to rigid-bodies.  
[forceAngle](AreaEffector2D-forceAngle.html)| The angle of the force to be
applied.  
[forceMagnitude](AreaEffector2D-forceMagnitude.html)| The magnitude of the
force to be applied.  
[forceTarget](AreaEffector2D-forceTarget.html)| The target for where the
effector applies any force.  
[forceVariation](AreaEffector2D-forceVariation.html)| The variation of the
magnitude of the force to be applied.  
[useGlobalAngle](AreaEffector2D-useGlobalAngle.html)| Should the forceAngle
use global space?  
