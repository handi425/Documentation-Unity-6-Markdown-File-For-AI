...
#
[IndexedCollectionPropertyBag<T0,T1>](Unity.Properties.IndexedCollectionPropertyBag_2.html).TryGetProperty
...
public bool TryGetProperty(ref TList container, int index, out
IProperty<TList> property);
...
**bool** `true` if the IIndexedProperties_1 contains a property for the
