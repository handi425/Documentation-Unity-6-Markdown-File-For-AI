...
#  [ConverterGroup](UIElements.ConverterGroup.html).TrySetValue
...
public bool TrySetValue(ref TContainer container, ref
...
Sets the value of a property at the given path to the given value, using this
converter group or the global ones.
