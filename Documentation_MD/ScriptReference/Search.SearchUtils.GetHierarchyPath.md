...
#  [SearchUtils](Search.SearchUtils.html).GetHierarchyPath
...
public static string GetHierarchyPath([GameObject](GameObject.html)
gameObject, bool includeScene);
...
Get the hierarchy path of a GameObject including the scene name if
includeScene is set to true.
