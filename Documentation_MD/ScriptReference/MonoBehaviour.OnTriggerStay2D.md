...
#  [MonoBehaviour](MonoBehaviour.html).OnTriggerStay2D(Collider2D)
...
[OnTriggerExit2D](MonoBehaviour.OnTriggerExit2D.html).
    ...
    {
        void OnTriggerStay2D([Collider2D](Collider2D.html) other)
        {
