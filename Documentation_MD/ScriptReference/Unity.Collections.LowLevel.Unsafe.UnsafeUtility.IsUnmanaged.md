...
#
[UnsafeUtility](Unity.Collections.LowLevel.Unsafe.UnsafeUtility.html).IsUnmanaged
...
An unmanaged type contains no managed fields, and can be freely copied in
memory.
