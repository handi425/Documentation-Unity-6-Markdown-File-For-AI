...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetResourcesBuildPhaseByTarget
...
Returns the GUID of resources build phase for the given target.
    ...
    public class Sample_GetResourcesBuildPhaseByTarget  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get the "[Resources](Resources.html) Build" build phase GUID 
            string resourcesBuildPhase = pbxProject.GetResourcesBuildPhaseByTarget(targetGuid);  
      
            // Log the "[Resources](Resources.html) Build" phase GUID for debugging
            [Debug.Log](Debug.Log.html)("'[Resources](Resources.html) Build' phase GUID: " + resourcesBuildPhase);
        }
    }
