...
#  [Random](Random.html).insideUnitSphere
...
public static [Vector3](Vector3.html) insideUnitSphere;

### Description

Returns a random point inside or on a sphere with radius 1.0 (Read Only).

Note that the probability space includes the surface of the sphere because
...
random radius.
    ...
    public class Example : [MonoBehaviour](MonoBehaviour.html)
    {
        void Start()
        {
            ...
            transform.position = [Random.insideUnitSphere](Random-insideUnitSphere.html) * 5;
        }
    }
