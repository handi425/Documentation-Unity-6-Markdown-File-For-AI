...
Use this attribute on enum value declarations to change the display name shown
in the Inspector.

Additional resources:
[SerializedProperty.enumDisplayNames](SerializedProperty-
enumDisplayNames.html)

    
    
    using UnityEngine;  
      
    public enum [ModelImporterIndexFormat](ModelImporterIndexFormat.html)
    {
        Auto = 0,
...
[displayName](InspectorNameAttribute-displayName.html)| Name to display in the
Inspector.  
---|---  
  
### Constructors

[InspectorNameAttribute](InspectorNameAttribute-ctor.html)| Specify a display
