...
#  [SearchService](Search.SearchService.html).ShowContextual
...
ShowContextual(params string[] providerIds);
...
Open the search window using a specific context (activating specific filters).
    ...
    [[MenuItem](MenuItem.html)("[Tools](Tools.html)/Search Menus _F1")]
    public static void SearchMenuItems()
    {
        [SearchService.ShowContextual](Search.SearchService.ShowContextual.html)("menu");
    }
