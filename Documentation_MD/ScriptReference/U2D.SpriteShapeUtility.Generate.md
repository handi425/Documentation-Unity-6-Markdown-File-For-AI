...
#  [SpriteShapeUtility](U2D.SpriteShapeUtility.html).Generate
...
public static int[] Generate([Mesh](Mesh.html) mesh,
[U2D.SpriteShapeParameters](U2D.SpriteShapeParameters.html) shapeParams,
ShapeControlPoint[] points, SpriteShapeMetaData[] metaData, AngleRangeInfo[]
angleRange, Sprite[] sprites, Sprite[] corners);
