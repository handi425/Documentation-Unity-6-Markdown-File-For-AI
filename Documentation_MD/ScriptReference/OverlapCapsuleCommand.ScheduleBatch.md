...
#  [OverlapCapsuleCommand](OverlapCapsuleCommand.html).ScheduleBatch
...
ScheduleBatch(NativeArray<OverlapCapsuleCommand> commands,
NativeArray<ColliderHit> results, int minCommandsPerJob, int maxHits,
