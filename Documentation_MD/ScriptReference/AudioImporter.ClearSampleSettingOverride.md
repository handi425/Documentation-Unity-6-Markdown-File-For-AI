...
#  [AudioImporter](AudioImporter.html).ClearSampleSettingOverride
...
public bool
ClearSampleSettingOverride([BuildTargetGroup](BuildTargetGroup.html)
platformGroup);
...
This reverts the given platform override sample override settings, making that
platform use the defaultSampleSettings..
