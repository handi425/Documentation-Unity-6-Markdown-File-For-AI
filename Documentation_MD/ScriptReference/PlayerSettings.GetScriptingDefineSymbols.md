...
#  [PlayerSettings](PlayerSettings.html).GetScriptingDefineSymbols
...
GetScriptingDefineSymbols([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget);
...
public static void
GetScriptingDefineSymbols([Build.NamedBuildTarget](Build.NamedBuildTarget.html)
buildTarget, out string[] defines);
