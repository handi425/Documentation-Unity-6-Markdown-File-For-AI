...
#  [PBXProject](iOS.Xcode.PBXProject.html).GetBuildPropertyForConfig
...
spaces.
    ...
    public class Sample_GetBuildPropertyForConfig  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Get "Architecture" property for "[Debug](Debug.html)" configuration in main target
            ...
            [Debug.Log](Debug.Log.html)("architectures: " + architectures);
        }
    }
