...
#  [ShaderUtil](ShaderUtil.html).GetCustomEditorForRenderPipeline
...
public static string GetCustomEditorForRenderPipeline([Shader](Shader.html)
shader, Type renderPipelineType);

## Declaration

public static string GetCustomEditorForRenderPipeline([Shader](Shader.html)
shader, string renderPipelineType);
