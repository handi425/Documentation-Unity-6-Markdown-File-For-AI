...
#
[TerrainMap](TerrainUtils.TerrainMap.html).CreateFromPlacement(Terrain,System.Predicate<Terrain>,bool)
...
Creates a [TerrainMap](TerrainUtils.TerrainMap.html) from the positions of all
active Terrains.

Creates a [TerrainMap](TerrainUtils.TerrainMap.html) of all the loaded Terrain
objects that pass the filter validation.
