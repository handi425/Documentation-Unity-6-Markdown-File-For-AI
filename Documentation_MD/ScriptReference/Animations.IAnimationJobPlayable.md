...
The interface defining an animation playable that uses
...
[GetJobData](Animations.IAnimationJobPlayable.GetJobData.html)| Gets the job
data contained in the playable.  
---|---  
[SetJobData](Animations.IAnimationJobPlayable.SetJobData.html)| Sets a new job
data in the playable.  
