...
#  [AndroidAssetPackError](Android.AndroidAssetPackError.html).AppNotOwned
...
The device considers the end user to own the application only if they acquired
the application from the Google Play Store. Additional resources:
