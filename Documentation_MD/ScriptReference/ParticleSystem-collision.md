...
#  [ParticleSystem](ParticleSystem.html).collision
...
public [ParticleSystem.CollisionModule](ParticleSystem.CollisionModule.html)
collision;
...
This module allows particles to collide with a predefined list of planes, or
with the 2D and 3D physics worlds.  
