...
#
[Camera](Camera.html).CalculateProjectionMatrixFromPhysicalProperties(Matrix4x4,float,Vector2,Vector2,GateFitParameters)
...
gateFitParameters | Gate fit parameters to use. See [GateFitParameters](Camera.GateFitParameters.html).  
...
Camera.GateFitMode.None . Additional resources:
