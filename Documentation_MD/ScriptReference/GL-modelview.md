...
public static [Matrix4x4](Matrix4x4.html) modelview;

### Description

Gets or sets the modelview matrix.

The getter returns the product of the model and view matrices. The setter
assigns an identity to the model matrix and the provided matrix to the view
matrix.  
