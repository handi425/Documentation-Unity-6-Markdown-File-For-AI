...
#  [Collider](Collider.html).GetGeometry
...
Throws an InvalidOperationException if you request a shape that is not present
in the collider. Additional resources:
[BoxGeometry](LowLevelPhysics.BoxGeometry.html),
