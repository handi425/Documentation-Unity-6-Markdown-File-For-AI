...
[Texture2DArray](XR.XRDisplaySubsystem.TextureLayout.Texture2DArray.html)|
Textures could be configured to a texture2DArray type.  
---|---  
[SingleTexture2D](XR.XRDisplaySubsystem.TextureLayout.SingleTexture2D.html)|
Textures could be configured to a texture2D that represents multiple views.  
[SeparateTexture2Ds](XR.XRDisplaySubsystem.TextureLayout.SeparateTexture2Ds.html)|
