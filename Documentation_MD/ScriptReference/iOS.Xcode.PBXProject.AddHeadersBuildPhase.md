...
#  [PBXProject](iOS.Xcode.PBXProject.html).AddHeadersBuildPhase
...
If the headers build phase is already configured for a target, the function
returns the existing phase.  
...
the target.
    ...
    public class Sample_AddHeadersBuildPhase  
    {
        [PostProcessBuild]
        ...
        {  
            ...
            // Add the Headers Build Phase. Note that if this phase already exists, the function doesn't create a new one and returns GUID to the existing phase
