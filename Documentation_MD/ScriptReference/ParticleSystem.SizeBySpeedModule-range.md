...
#
[ParticleSystem.SizeBySpeedModule](ParticleSystem.SizeBySpeedModule.html).range
...
Set the minimum and maximum speed that this modules applies the size curve
between.

Additional resources:
[ParticleSystem.SizeBySpeedModule.size](ParticleSystem.SizeBySpeedModule-
size.html).
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        ...
        void Start()
        {
            ...
            sizeBySpeed.size = new [ParticleSystem.MinMaxCurve](ParticleSystem.MinMaxCurve.html)(1.0f, curve);
            sizeBySpeed.range = new [Vector2](Vector2.html)(0.9f, 5.0f);  
