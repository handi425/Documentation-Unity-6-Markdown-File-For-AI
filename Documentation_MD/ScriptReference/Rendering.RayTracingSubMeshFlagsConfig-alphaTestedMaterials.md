...
#
[RayTracingSubMeshFlagsConfig](Rendering.RayTracingSubMeshFlagsConfig.html).alphaTestedMaterials
...
alone will allow the GPU to execute _any hit shaders_ where a ray-geometry hit
can be reported based on an alpha test.  
