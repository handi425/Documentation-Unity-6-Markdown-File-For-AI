...
#
[DisposeSentinel](Unity.Collections.LowLevel.Unsafe.DisposeSentinel.html).Dispose
...
safety, ref
[Unity.Collections.LowLevel.Unsafe.DisposeSentinel](Unity.Collections.LowLevel.Unsafe.DisposeSentinel.html)
sentinel);
...
If the `AtomicSafetyHandle` can't be released, which usually happens either
because a job is accessing the data or because the handle has already been
