...
Container for holding asset loading information for a streamed Scene
AssetBundle to be built.
...
[bundleName](Build.Content.SceneBundleInfo-bundleName.html)| Friendly
AssetBundle name.  
---|---  
[bundleScenes](Build.Content.SceneBundleInfo-bundleScenes.html)| List of Scene
loading information for an AssetBundle.  
  
### Constructors

[SceneBundleInfo](Build.Content.SceneBundleInfo-ctor.html)| Default
constructor for an empty SceneBundleInfo.  
---|---  
