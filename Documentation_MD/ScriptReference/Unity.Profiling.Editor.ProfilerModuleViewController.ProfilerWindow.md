...
#
[ProfilerModuleViewController](Unity.Profiling.Editor.ProfilerModuleViewController.html).ProfilerWindow
...
use this property to subscribe to Profiler window events in a view controller,
such as
