...
#  [Collision2D](Collision2D.html).transform
...
Additional resources: [Transform](Transform.html) class.
    ...
    public class ExampleClass : [MonoBehaviour](MonoBehaviour.html)
    {
        void OnCollisionEnter2D([Collision2D](Collision2D.html) collision2D)
        {
            ...
            {
                //Sets this object as the new parent of the [Transform](Transform.html) of the object involved in the collision.
