...
#  [AnimatorController](Animations.AnimatorController.html).layers
...
[AnimatorControllerLayer](Animations.AnimatorControllerLayer.html) are
returned as a copy. The array should be set back into the property when
changed.
