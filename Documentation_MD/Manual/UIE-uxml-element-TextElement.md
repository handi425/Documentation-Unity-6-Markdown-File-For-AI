...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-TextElement.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-TextElement.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-TextElement.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-TextElement.html)
...
The TextElement displays text in a **UI**(User Interface) Allows a user to
interact with your application. Unity currently supports three UI systems.
[More info](UI-system-compare.html)  
See in [Glossary](Glossary.html#UI). If you create a [custom control](UIE-
custom-controls.html) for displaying text, you can inherit it from a
[TextElement](../ScriptReference/UIElements.TextElement.html).

## Create a TextElement

You can create a TextElement with UXML or C#. The following C# example creates
a TextElement with a text value and some styles:
...
**C# class** : [`TextElement`](../ScriptReference/UIElements.TextElement.html)  
