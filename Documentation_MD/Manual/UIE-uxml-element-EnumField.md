...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-EnumField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-EnumField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-EnumField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-EnumField.html)
...
**Note** : To align an EnumField with other fields in an **Inspector** A Unity
...
You can create an EnumField with **UI**(User Interface) Allows a user to
...
The following C# example creates an EnumField with the `ColorOptions`
enumeration and sets the default value to `Red`:
...
**C# class** : [`EnumField`](../ScriptReference/UIElements.EnumField.html)  
...
## Additional resources
  ...
  * [EnumFlagsField](UIE-uxml-element-EnumFlagsField.html)
