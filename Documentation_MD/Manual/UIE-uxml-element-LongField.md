...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-LongField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-LongField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-LongField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-LongField.html)
...
[](UIE-uxml-element-LayerMaskField.html)
...
A LongField lets users input a numerical long integer value into an
application. It accepts and displays text input. You can set placeholder text
to provide hints or instructions to the user on what to enter. You can also
add validation functions to ensure that the entered data meets certain
requirements.

**Note** : To align a LongField with other fields in an **Inspector** A Unity
...
You can create a LongField with **UI**(User Interface) Allows a user to
interact with your application. Unity currently supports three UI systems.
[More info](UI-system-compare.html)  
See in [Glossary](Glossary.html#UI) Builder, UXML, and C#.

To create a LongField with C#, create a new instance of a
[LongField](../ScriptReference/UIElements.LongField.html) object. For example:
...
**C# class** : [`LongField`](../ScriptReference/UIElements.LongField.html)  
