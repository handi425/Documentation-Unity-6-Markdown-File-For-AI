...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-Label.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-Label.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-Label.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-Label.html)
...
A Label is a text element that you can use to display text. You can use a
Label to display a title or a description for a control.

## Create a Label

You can create a Label with **UI**(User Interface) Allows a user to interact
...
example creates a Label with the text “Hello World” and sets the font size,
font style, text alignment, and color:
...
**C# class** : [`Label`](../ScriptReference/UIElements.Label.html)  
