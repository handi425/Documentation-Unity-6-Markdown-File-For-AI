...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-RectIntField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-RectIntField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-RectIntField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-RectIntField.html)
...
The RectIntField lets users enter a [RectInt](../ScriptReference/RectInt.html)
...
You can create a RectIntField with UI Builder, UXML, or C#. The following C#
example creates a RectIntField with a RectInt value:
...
## Additional resources
  ...
  * [RectField](UIE-uxml-element-RectField.html)
