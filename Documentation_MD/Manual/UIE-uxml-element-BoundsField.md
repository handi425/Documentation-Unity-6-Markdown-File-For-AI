...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-BoundsField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-BoundsField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-BoundsField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-BoundsField.html)
...
[](UIE-uxml-element-VisualElement.html)

VisualElement

[](UIE-uxml-element-BoundsIntField.html)

BoundsIntField

# BoundsField

The BoundsField lets users enter a [Bounds](../ScriptReference/Bounds.html)
...
You can create a BoundsField with UI Builder, UXML, or C#. The following C#
example creates a BoundsField with a default Bounds value:
...
**C# class** : [`BoundsField`](../ScriptReference/UIElements.BoundsField.html)  
...
## Additional resources
  ...
  * [BoundsIntField](UIE-uxml-element-BoundsIntField.html)
