...
![The Animation Window in Record
...
In the screenshot below you can see the Animation window in record mode. The
...
You can click anywhere on the **Animation window time line** to move the
