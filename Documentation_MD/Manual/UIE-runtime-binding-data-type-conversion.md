...
There are two categories of type converters: global converters and per-binding
converters.
...
To register an individual converter, use the
...
The following example applies the converter group `Inverters` to a binding
instance in C#:
