...
Language : English
  ...
  * [English](/Manual/urp/simple-lit-shader.html)
  * [中文](/cn/current/Manual/urp/simple-lit-shader.html)
  * [日本語](/ja/current/Manual/urp/simple-lit-shader.html)
  * [한국어](/kr/current/Manual/urp/simple-lit-shader.html)
...
In **Source** , you can select a Texture in your Project to act as a source
for the smoothness. By default, the source is the Alpha channel for this
Texture.  
...
like glass. Values in between produce semi-glossy looks. For example, 0.5
produces a plastic-like glossiness.  
