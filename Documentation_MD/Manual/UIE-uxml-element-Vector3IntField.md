...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-Vector3IntField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-Vector3IntField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-Vector3IntField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-Vector3IntField.html)
...
[](UIE-uxml-element-Vector3Field.html)
...
A Vector3IntField lets users enter a
[Vector3Int](../ScriptReference/Vector3Int.html) value.

**Note** : To align a Vector3IntField with other fields in an **Inspector** A
...
You can create a Vector3IntField with **UI**(User Interface) Allows a user to
interact with your application. Unity currently supports three UI systems.
[More info](UI-system-compare.html)  
See in [Glossary](Glossary.html#UI) Builder, UXML, and C#. The following C#
example creates a Vector3IntField with the default value `(15, 12, 14)`:
