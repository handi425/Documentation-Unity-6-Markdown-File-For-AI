...
The [GameObject class](../ScriptReference/GameObject.html) class provides a
...
For example, in a cooking game with one chef character, and multiple stoves in
...
![The Primitive shapes available in Unitys GameObject
