...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-Box.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-Box.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-Box.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-Box.html)
...
The Box element is a [VisualElement](UIE-uxml-element-VisualElement.html) with
the following styling properties:
...
You can create a Box with UXML or C#. The following C# example creates a Box
with a label and a text field:
...
**C# class** : [`Box`](../ScriptReference/UIElements.Box.html)  
