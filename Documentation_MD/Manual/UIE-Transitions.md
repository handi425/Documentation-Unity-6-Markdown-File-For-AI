...
You can use the controls in the [UI Builder](UIBuilder.html), a [USS
...
You can apply transitions to most USS properties. However, the animatability
...
The [`IStyle.transitionDelay`](../ScriptReference/UIElements.IStyle-
