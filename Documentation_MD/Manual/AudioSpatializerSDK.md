...
For an example in the code for the Audio Spatializer plugin, see line 215 in
...
The boolean property `AudioSource.spatializer` is linked to the **Spatialize**
