...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-EnumFlagsField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-EnumFlagsField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-EnumFlagsField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-EnumFlagsField.html)
...
An EnumFlagsField lets users select multiple values from an enumeration that
are marked with the Flags attribute.

**Note** : To align an EnumFlagsField with other fields in an **Inspector** A
...
The following C# example creates an EnumFlagsField with the `MyEnum`
enumeration and selects the first and second values:
...
## Additional resources
  ...
  * [EnumField](UIE-uxml-element-EnumField.html)
