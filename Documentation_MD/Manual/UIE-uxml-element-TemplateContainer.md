...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-TemplateContainer.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-TemplateContainer.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-TemplateContainer.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-TemplateContainer.html)
...
[](UIE-uxml-element-TextField.html)
...
The TemplateContainer is the root element of a UXML file and acts as the
parent of all other elements in the file.

A TemplateContainer instance is automatically generated for the following
scenarios:
  ...
  * When you work with [UXML templates](UIE-reuse-uxml-files.html), a TemplateContainer is generated to represent the template instance and inserted into the hierarchy of the parent UXML file.
