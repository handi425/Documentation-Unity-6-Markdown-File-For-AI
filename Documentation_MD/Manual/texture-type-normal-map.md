...
Language : English
  ...
  * [English](/Manual/texture-type-normal-map.html)
  * [中文](/cn/current/Manual/texture-type-normal-map.html)
  * [日本語](/ja/current/Manual/texture-type-normal-map.html)
  * [한국어](/kr/current/Manual/texture-type-normal-map.html)
...
See in [Glossary](Glossary.html#Normalmap)** texture type formats the texture
asset so it’s suitable for real-time normal mapping. With this texture type,
you can also set the [Texture Shape](class-TextureImporter.html#textureshape).
...
**Bumpiness** | Controls the amount of bumpiness. A low bumpiness value means that even sharp contrast in the heightmap is translated to gentle angles and bumps. A high value creates exaggerated bumps and very high-contrast lighting responses to the bumps.  
  
This property is visible only when Create from Grayscale is set to true.  
