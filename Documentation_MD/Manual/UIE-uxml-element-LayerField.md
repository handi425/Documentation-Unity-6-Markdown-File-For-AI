...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-LayerField.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-LayerField.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-LayerField.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-LayerField.html)
...
A LayerField allows the users to select a layer from a list of available
...
**Note** : To align a LayerField with other fields in an **Inspector** A Unity
...
You can create a LayerField with **UI**(User Interface) Allows a user to
interact with your application. Unity currently supports three UI systems.
[More info](UI-system-compare.html)  
See in [Glossary](Glossary.html#UI) Builder, UXML, and C#. The following C#
example creates a LayerField with the default value:
...
**C# class** : [`LayerField`](../ScriptReference/UIElements.LayerField.html)  
