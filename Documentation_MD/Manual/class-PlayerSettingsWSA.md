...
**Note:** By default, the **Streaming Install** option is disabled, which
...
![Capabilities settings for UWP](../uploads/Main/PlayerSetWSAPubCaps.png) Capabilities settings for UWP **Property** | **Description**  
---|---  
