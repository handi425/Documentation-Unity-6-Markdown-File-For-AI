...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-IMGUIContainer.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-IMGUIContainer.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-IMGUIContainer.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-IMGUIContainer.html)
...
The IMGUIContainer element renders [IMGUI](GUIScriptingGuide.html) code in a
...
See in [Glossary](Glossary.html#UI). You can use it to render complex UIs that
aren’t possible with the existing UI Toolkit elements.
...
**C# class** :
[`IMGUIContainer`](../ScriptReference/UIElements.IMGUIContainer.html)  
