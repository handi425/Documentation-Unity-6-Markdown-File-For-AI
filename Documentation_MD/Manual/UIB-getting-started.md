...
**Tip** : You can also double-click a control to add it to the **Hierarchy**
panel.
...
![Background container with the empty element
...
If you want to continue to work on the [Create a list view runtime UI](UIE-
