...
Language : English
  ...
  * [English](/Manual/UIE-uxml-element-BindableElement.html)
  * [中文](/cn/current/Manual/UIE-uxml-element-BindableElement.html)
  * [日本語](/ja/current/Manual/UIE-uxml-element-BindableElement.html)
  * [한국어](/kr/current/Manual/UIE-uxml-element-BindableElement.html)
...
BindableElement is the base class for all elements that you can bind to a data
source. It provides the following properties:
...
You can create a BindableElement with UXML or C#. The following C# example
creates a BindableElement:
